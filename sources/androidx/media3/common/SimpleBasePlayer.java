...
public abstract class SimpleBasePlayer extends BasePlayer {
    ...
    protected static final class State {
        ...
        private State(Builder builder) {
            ...
            if (builder.contentPositionMs != null) {
                if (builder.currentAdGroupIndex == -1 && builder.playWhenReady && builder.playbackState == 3 && builder.playbackSuppressionReason == 0 && builder.contentPositionMs.longValue() != -9223372036854775807L) {
    ...
    protected static final class MediaItemData {
        ...
        public Timeline.Period getPeriod(int i, int i2, Timeline.Period period) {
            if (this.periods.isEmpty()) {
                Object obj = this.uid;
                long j = this.positionInFirstPeriodUs + this.durationUs;
                period.set(obj, obj, i, j, 0, AdPlaybackState.NONE, this.isPlaceholder);
            } else {
    ...
    protected SimpleBasePlayer(Looper looper, Clock clock) {
        ...
        this.listeners = new ListenerSet<>(looper, clock, new SimpleBasePlayer$$ExternalSyntheticLambda46(this));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$new$0$androidx-media3-common-SimpleBasePlayer  reason: not valid java name */
    public /* synthetic */ void m64lambda$new$0$androidxmedia3commonSimpleBasePlayer(Player.Listener listener, FlagSet flagSet) {
    ...
    public final void setPlayWhenReady(boolean z) {
        ...
        if (shouldHandleCommand(1)) {
            updateStateForPendingOperation(handleSetPlayWhenReady(z), new SimpleBasePlayer$$ExternalSyntheticLambda39(state2, z));
        }
    }
    ...
    private void setMediaItemsInternal(List<MediaItem> list, int i, long j) {
        ...
        if (shouldHandleCommand(20) || (list.size() == 1 && shouldHandleCommand(31))) {
            updateStateForPendingOperation(handleSetMediaItems(list, i, j), new SimpleBasePlayer$$ExternalSyntheticLambda61(this, list, state2, i, j));
        }
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$setMediaItemsInternal$2$androidx-media3-common-SimpleBasePlayer  reason: not valid java name */
    public /* synthetic */ State m67lambda$setMediaItemsInternal$2$androidxmedia3commonSimpleBasePlayer(List list, State state2, int i, long j) {
    ...
    public final void addMediaItems(int i, List<MediaItem> list) {
        ...
        if (shouldHandleCommand(20) && !list.isEmpty()) {
            ...
            updateStateForPendingOperation(handleAddMediaItems(min, list), new SimpleBasePlayer$$ExternalSyntheticLambda54(this, state2, list, min));
        }
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$addMediaItems$3$androidx-media3-common-SimpleBasePlayer  reason: not valid java name */
    public /* synthetic */ State m62lambda$addMediaItems$3$androidxmedia3commonSimpleBasePlayer(State state2, List list, int i) {
        ...
        return getStateWithNewPlaylistAndPosition(state2, arrayList, state2.currentMediaItemIndex, state2.contentPositionMsSupplier.get());
    }
    ...
    public /* synthetic */ State m63lambda$moveMediaItems$4$androidxmedia3commonSimpleBasePlayer(State state2, int i, int i2, int i3) {
        ArrayList arrayList = new ArrayList(state2.playlist);
    ...
    public /* synthetic */ State m66lambda$replaceMediaItems$5$androidxmedia3commonSimpleBasePlayer(State state2, List list, int i, int i2) {
        State state3;
        ArrayList arrayList = new ArrayList(state2.playlist);
        ...
        if (!state2.playlist.isEmpty()) {
            state3 = getStateWithNewPlaylist(state2, arrayList, this.period);
        } else {
            state3 = getStateWithNewPlaylistAndPosition(state2, arrayList, state2.currentMediaItemIndex, state2.contentPositionMsSupplier.get());
        }
        if (i2 >= i) {
            return state3;
        }
        Util.removeRange(arrayList, i2, i);
        return getStateWithNewPlaylist(state3, arrayList, this.period);
    }
    ...
    public final void removeMediaItems(int i, int i2) {
        ...
        if (shouldHandleCommand(20) && size != 0 && i < size && i != (min = Math.min(i2, size))) {
            updateStateForPendingOperation(handleRemoveMediaItems(i, min), new SimpleBasePlayer$$ExternalSyntheticLambda56(this, state2, i, min));
        }
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$removeMediaItems$6$androidx-media3-common-SimpleBasePlayer  reason: not valid java name */
    public /* synthetic */ State m65lambda$removeMediaItems$6$androidxmedia3commonSimpleBasePlayer(State state2, int i, int i2) {
        ArrayList arrayList = new ArrayList(state2.playlist);
    ...
    public final void prepare() {
        ...
        if (shouldHandleCommand(2)) {
            updateStateForPendingOperation(handlePrepare(), new SimpleBasePlayer$$ExternalSyntheticLambda52(state2));
        }
    }
    ...
    public final void setRepeatMode(int i) {
        ...
        if (shouldHandleCommand(15)) {
            updateStateForPendingOperation(handleSetRepeatMode(i), new SimpleBasePlayer$$ExternalSyntheticLambda41(state2, i));
        }
    }
    ...
    public final void setShuffleModeEnabled(boolean z) {
        ...
        if (shouldHandleCommand(14)) {
            updateStateForPendingOperation(handleSetShuffleModeEnabled(z), new SimpleBasePlayer$$ExternalSyntheticLambda58(state2, z));
        }
    }
    ...
    public final void seekTo(int i, long j, int i2, boolean z) {
        ...
        if (shouldHandleCommand(i2) && !isPlayingAd()) {
            if (state2.playlist.isEmpty() || i < state2.playlist.size()) {
                updateStateForPendingOperation(handleSeek(i, j, i2), new SimpleBasePlayer$$ExternalSyntheticLambda11(state2, i, j), true, z);
            }
        }
    }
    ...
    public final void setPlaybackParameters(PlaybackParameters playbackParameters) {
        ...
        if (shouldHandleCommand(13)) {
            updateStateForPendingOperation(handleSetPlaybackParameters(playbackParameters), new SimpleBasePlayer$$ExternalSyntheticLambda63(state2, playbackParameters));
        }
    }
    ...
    public final void stop() {
        ...
        if (shouldHandleCommand(3)) {
            updateStateForPendingOperation(handleStop(), new SimpleBasePlayer$$ExternalSyntheticLambda22(state2));
        }
    }
    ...
    public final void release() {
        ...
        if (shouldHandleCommand(32)) {
            updateStateForPendingOperation(handleRelease(), new SimpleBasePlayer$$ExternalSyntheticLambda53(state2));
            this.released = true;
    ...
    public final void setTrackSelectionParameters(TrackSelectionParameters trackSelectionParameters) {
        ...
        if (shouldHandleCommand(29)) {
            updateStateForPendingOperation(handleSetTrackSelectionParameters(trackSelectionParameters), new SimpleBasePlayer$$ExternalSyntheticLambda59(state2, trackSelectionParameters));
        }
    }
    ...
    public final void setPlaylistMetadata(MediaMetadata mediaMetadata) {
        ...
        if (shouldHandleCommand(19)) {
            updateStateForPendingOperation(handleSetPlaylistMetadata(mediaMetadata), new SimpleBasePlayer$$ExternalSyntheticLambda3(state2, mediaMetadata));
        }
    }
    ...
    public final void setVolume(float f) {
        ...
        if (shouldHandleCommand(24)) {
            updateStateForPendingOperation(handleSetVolume(f), new SimpleBasePlayer$$ExternalSyntheticLambda47(state2, f));
        }
    }
    ...
    public final void setVideoSurface(Surface surface) {
        ...
        if (shouldHandleCommand(27)) {
            if (surface == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surface), new SimpleBasePlayer$$ExternalSyntheticLambda62(state2));
            }
        }
    }
    ...
    public final void setVideoSurfaceHolder(SurfaceHolder surfaceHolder) {
        ...
        if (shouldHandleCommand(27)) {
            if (surfaceHolder == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surfaceHolder), new SimpleBasePlayer$$ExternalSyntheticLambda2(state2, surfaceHolder));
            }
        }
    }
    ...
    public final void setVideoSurfaceView(SurfaceView surfaceView) {
        ...
        if (shouldHandleCommand(27)) {
            if (surfaceView == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surfaceView), new SimpleBasePlayer$$ExternalSyntheticLambda57(state2, surfaceView));
            }
        }
    }
    ...
    public final void setVideoTextureView(TextureView textureView) {
        ...
        if (shouldHandleCommand(27)) {
            ...
            updateStateForPendingOperation(handleSetVideoOutput(textureView), new SimpleBasePlayer$$ExternalSyntheticLambda38(state2, size));
        }
    }
    ...
    private void clearVideoOutput(Object obj) {
        ...
        State state2 = this.state;
        if (shouldHandleCommand(27)) {
            updateStateForPendingOperation(handleClearVideoOutput(obj), new SimpleBasePlayer$$ExternalSyntheticLambda51(state2));
        }
    }
    ...
    public final void setDeviceVolume(int i, int i2) {
        ...
        if (shouldHandleCommand(33)) {
            updateStateForPendingOperation(handleSetDeviceVolume(i, i2), new SimpleBasePlayer$$ExternalSyntheticLambda60(state2, i));
        }
    }
    ...
    public final void decreaseDeviceVolume() {
        ...
        State state2 = this.state;
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleDecreaseDeviceVolume(1), new SimpleBasePlayer$$ExternalSyntheticLambda48(state2));
        }
    }
    ...
    public final void setDeviceMuted(boolean z) {
        ...
        State state2 = this.state;
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleSetDeviceMuted(z, 1), new SimpleBasePlayer$$ExternalSyntheticLambda40(state2, z));
        }
    }
    ...
    public final void setDeviceMuted(boolean z, int i) {
        ...
        State state2 = this.state;
        if (shouldHandleCommand(34)) {
            updateStateForPendingOperation(handleSetDeviceMuted(z, i), new SimpleBasePlayer$$ExternalSyntheticLambda49(state2, z));
        }
    }
    ...
    public ListenableFuture<?> handleReplaceMediaItems(int i, int i2, List<MediaItem> list) {
        return Util.transformFutureAsync(handleAddMediaItems(i2, list), new SimpleBasePlayer$$ExternalSyntheticLambda42(handleRemoveMediaItems(i, i2)));
    }
    ...
    private void updateStateAndInformListeners(State state2, boolean z, boolean z2) {
        ...
        boolean z5 = !state4.timeline.equals(state3.timeline);
        int mediaItemTransitionReason = getMediaItemTransitionReason(state4, state3, positionDiscontinuityReason, z2, this.window);
        if (z5) {
            this.listeners.queueEvent(0, new SimpleBasePlayer$$ExternalSyntheticLambda4(state3, getTimelineChangeReason(state4.playlist, state3.playlist)));
        }
        if (positionDiscontinuityReason != -1) {
            this.listeners.queueEvent(11, new SimpleBasePlayer$$ExternalSyntheticLambda16(positionDiscontinuityReason, getPositionInfo(state4, false, this.window, this.period), getPositionInfo(state3, state3.hasPositionDiscontinuity, this.window, this.period)));
        }
        if (mediaItemTransitionReason != -1) {
            ...
            this.listeners.queueEvent(1, new SimpleBasePlayer$$ExternalSyntheticLambda28(mediaItem, mediaItemTransitionReason));
        }
        if (!Util.areEqual(state4.playerError, state3.playerError)) {
            this.listeners.queueEvent(10, new SimpleBasePlayer$$ExternalSyntheticLambda30(state3));
            if (state3.playerError != null) {
                this.listeners.queueEvent(10, new SimpleBasePlayer$$ExternalSyntheticLambda31(state3));
            }
        }
        if (!state4.trackSelectionParameters.equals(state3.trackSelectionParameters)) {
            this.listeners.queueEvent(19, new SimpleBasePlayer$$ExternalSyntheticLambda32(state3));
        }
        if (!currentTracksInternal.equals(currentTracksInternal2)) {
            this.listeners.queueEvent(2, new SimpleBasePlayer$$ExternalSyntheticLambda34(currentTracksInternal2));
        }
        if (!mediaMetadataInternal.equals(mediaMetadataInternal2)) {
            this.listeners.queueEvent(14, new SimpleBasePlayer$$ExternalSyntheticLambda35(mediaMetadataInternal2));
        }
        if (state4.isLoading != state3.isLoading) {
            this.listeners.queueEvent(3, new SimpleBasePlayer$$ExternalSyntheticLambda36(state3));
        }
        if (z3 || z4) {
            this.listeners.queueEvent(-1, new SimpleBasePlayer$$ExternalSyntheticLambda37(state3));
        }
        if (z4) {
            this.listeners.queueEvent(4, new SimpleBasePlayer$$ExternalSyntheticLambda5(state3));
        }
        if (z3 || state4.playWhenReadyChangeReason != state3.playWhenReadyChangeReason) {
            this.listeners.queueEvent(5, new SimpleBasePlayer$$ExternalSyntheticLambda6(state3));
        }
        if (state4.playbackSuppressionReason != state3.playbackSuppressionReason) {
            this.listeners.queueEvent(6, new SimpleBasePlayer$$ExternalSyntheticLambda7(state3));
        }
        if (isPlaying(state4) != isPlaying(state2)) {
            this.listeners.queueEvent(7, new SimpleBasePlayer$$ExternalSyntheticLambda8(state3));
        }
        if (!state4.playbackParameters.equals(state3.playbackParameters)) {
            this.listeners.queueEvent(12, new SimpleBasePlayer$$ExternalSyntheticLambda9(state3));
        }
        if (state4.repeatMode != state3.repeatMode) {
            this.listeners.queueEvent(8, new SimpleBasePlayer$$ExternalSyntheticLambda10(state3));
        }
        if (state4.shuffleModeEnabled != state3.shuffleModeEnabled) {
            this.listeners.queueEvent(9, new SimpleBasePlayer$$ExternalSyntheticLambda12(state3));
        }
        if (state4.seekBackIncrementMs != state3.seekBackIncrementMs) {
            this.listeners.queueEvent(16, new SimpleBasePlayer$$ExternalSyntheticLambda13(state3));
        }
        if (state4.seekForwardIncrementMs != state3.seekForwardIncrementMs) {
            this.listeners.queueEvent(17, new SimpleBasePlayer$$ExternalSyntheticLambda14(state3));
        }
        if (state4.maxSeekToPreviousPositionMs != state3.maxSeekToPreviousPositionMs) {
            this.listeners.queueEvent(18, new SimpleBasePlayer$$ExternalSyntheticLambda15(state3));
        }
        if (!state4.audioAttributes.equals(state3.audioAttributes)) {
            this.listeners.queueEvent(20, new SimpleBasePlayer$$ExternalSyntheticLambda17(state3));
        }
        if (!state4.videoSize.equals(state3.videoSize)) {
            this.listeners.queueEvent(25, new SimpleBasePlayer$$ExternalSyntheticLambda18(state3));
        }
        if (!state4.deviceInfo.equals(state3.deviceInfo)) {
            this.listeners.queueEvent(29, new SimpleBasePlayer$$ExternalSyntheticLambda19(state3));
        }
        if (!state4.playlistMetadata.equals(state3.playlistMetadata)) {
            this.listeners.queueEvent(15, new SimpleBasePlayer$$ExternalSyntheticLambda20(state3));
        }
        ...
        if (!state4.surfaceSize.equals(state3.surfaceSize)) {
            this.listeners.queueEvent(24, new SimpleBasePlayer$$ExternalSyntheticLambda23(state3));
        }
        if (state4.volume != state3.volume) {
            this.listeners.queueEvent(22, new SimpleBasePlayer$$ExternalSyntheticLambda24(state3));
        }
        if (!(state4.deviceVolume == state3.deviceVolume && state4.isDeviceMuted == state3.isDeviceMuted)) {
            this.listeners.queueEvent(30, new SimpleBasePlayer$$ExternalSyntheticLambda25(state3));
        }
        if (!state4.currentCues.equals(state3.currentCues)) {
            this.listeners.queueEvent(27, new SimpleBasePlayer$$ExternalSyntheticLambda26(state3));
        }
        if (!state4.timedMetadata.equals(state3.timedMetadata) && state3.timedMetadata.presentationTimeUs != -9223372036854775807L) {
            this.listeners.queueEvent(28, new SimpleBasePlayer$$ExternalSyntheticLambda27(state3));
        }
        if (!state4.availableCommands.equals(state3.availableCommands)) {
            this.listeners.queueEvent(13, new SimpleBasePlayer$$ExternalSyntheticLambda29(state3));
        }
    ...
    static /* synthetic */ void lambda$updateStateAndInformListeners$39(State state2, Player.Listener listener) {
        listener.onLoadingChanged(state2.isLoading);
        listener.onIsLoadingChanged(state2.isLoading);
    }

    static /* synthetic */ void lambda$updateStateAndInformListeners$58(State state2, Player.Listener listener) {
    ...
    private void updateStateForPendingOperation(ListenableFuture<?> listenableFuture, Supplier<State> supplier, boolean z, boolean z2) {
        if (!listenableFuture.isDone() || !this.pendingOperations.isEmpty()) {
            ...
            listenableFuture.addListener(new SimpleBasePlayer$$ExternalSyntheticLambda43(this, listenableFuture), new SimpleBasePlayer$$ExternalSyntheticLambda45(this));
            return;
        }
    ...
    public /* synthetic */ void m68lambda$updateStateForPendingOperation$61$androidxmedia3commonSimpleBasePlayer(ListenableFuture listenableFuture) {
