    ...
    public long open(DataSpec dataSpec) throws ContentDataSourceException {
        ...
        try {
            ...
            if ("content".equals(normalizeScheme.getScheme())) {
                ...
                assetFileDescriptor2 = this.resolver.openTypedAssetFileDescriptor(normalizeScheme, "*/*", bundle);
            } else {
                assetFileDescriptor2 = this.resolver.openAssetFileDescriptor(normalizeScheme, CampaignEx.JSON_KEY_AD_R);
            }
