...
public abstract class SimpleDecoder<I extends DecoderInputBuffer, O extends DecoderOutputBuffer, E extends DecoderException> implements Decoder<I, O, E> {
    ...
    private boolean decode() throws java.lang.InterruptedException {
        ...
        L_0x0047:
            ...
            r3.addFlag(r0)
        L_0x0052:
            androidx.media3.decoder.DecoderException r0 = r6.decode(r1, r3, r4)     // Catch:{ RuntimeException -> 0x005d, OutOfMemoryError -> 0x0057 }
            goto L_0x0062
        L_0x0057:
            r0 = move-exception
            androidx.media3.decoder.DecoderException r0 = r6.createUnexpectedDecodeException(r0)
            goto L_0x0062
        L_0x005d:
            r0 = move-exception
            androidx.media3.decoder.DecoderException r0 = r6.createUnexpectedDecodeException(r0)
