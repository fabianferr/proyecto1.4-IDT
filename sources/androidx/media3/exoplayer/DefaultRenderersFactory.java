...
public class DefaultRenderersFactory implements RenderersFactory {
    ...
    public void buildVideoRenderers(android.content.Context r15, int r16, androidx.media3.exoplayer.mediacodec.MediaCodecSelector r17, boolean r18, android.os.Handler r19, androidx.media3.exoplayer.video.VideoRendererEventListener r20, long r21, java.util.ArrayList<androidx.media3.exoplayer.Renderer> r23) {
        ...
        L_0x007d:
            ...
            androidx.media3.exoplayer.Renderer r0 = (androidx.media3.exoplayer.Renderer) r0     // Catch:{ ClassNotFoundException -> 0x00c3, Exception -> 0x00ba }
            r11.add(r8, r0)     // Catch:{ ClassNotFoundException -> 0x00c3, Exception -> 0x00ba }
            java.lang.String r0 = "Loaded Libgav1VideoRenderer."
            androidx.media3.common.util.Log.i(r12, r0)     // Catch:{ ClassNotFoundException -> 0x00c3, Exception -> 0x00ba }
            goto L_0x00c3
        L_0x00ba:
            r0 = move-exception
            java.lang.RuntimeException r1 = new java.lang.RuntimeException
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void buildAudioRenderers(android.content.Context r13, int r14, androidx.media3.exoplayer.mediacodec.MediaCodecSelector r15, boolean r16, androidx.media3.exoplayer.audio.AudioSink r17, android.os.Handler r18, androidx.media3.exoplayer.audio.AudioRendererEventListener r19, java.util.ArrayList<androidx.media3.exoplayer.Renderer> r20) {
        /*
            r12 = this;
            r0 = r14
            r9 = r20
            java.lang.String r10 = "DefaultRenderersFactory"
            androidx.media3.exoplayer.audio.MediaCodecAudioRenderer r11 = new androidx.media3.exoplayer.audio.MediaCodecAudioRenderer
            androidx.media3.exoplayer.mediacodec.MediaCodecAdapter$Factory r3 = r12.getCodecAdapterFactory()
            r1 = r11
            r2 = r13
            r4 = r15
            r5 = r16
        ...
        L_0x0028:
            ...
            androidx.media3.exoplayer.Renderer r3 = (androidx.media3.exoplayer.Renderer) r3     // Catch:{ ClassNotFoundException -> 0x0053, Exception -> 0x004a }
            int r4 = r1 + 1
            r9.add(r1, r3)     // Catch:{ ClassNotFoundException -> 0x0048, Exception -> 0x004a }
            java.lang.String r1 = "Loaded MidiRenderer."
            androidx.media3.common.util.Log.i(r10, r1)     // Catch:{ ClassNotFoundException -> 0x0048, Exception -> 0x004a }
            goto L_0x0054
        L_0x0048:
            r1 = r4
            goto L_0x0053
        ...
        L_0x0054:
            ...
            androidx.media3.exoplayer.Renderer r5 = (androidx.media3.exoplayer.Renderer) r5     // Catch:{ ClassNotFoundException -> 0x0092, Exception -> 0x0089 }
            int r6 = r4 + 1
            r9.add(r4, r5)     // Catch:{ ClassNotFoundException -> 0x0087, Exception -> 0x0089 }
            java.lang.String r4 = "Loaded LibopusAudioRenderer."
            androidx.media3.common.util.Log.i(r10, r4)     // Catch:{ ClassNotFoundException -> 0x0087, Exception -> 0x0089 }
            goto L_0x0093
        L_0x0087:
            r4 = r6
            goto L_0x0092
        ...
        L_0x0093:
            ...
            androidx.media3.exoplayer.Renderer r4 = (androidx.media3.exoplayer.Renderer) r4     // Catch:{ ClassNotFoundException -> 0x00cf, Exception -> 0x00c6 }
            int r5 = r6 + 1
            r9.add(r6, r4)     // Catch:{ ClassNotFoundException -> 0x00c4, Exception -> 0x00c6 }
            java.lang.String r4 = "Loaded LibflacAudioRenderer."
            androidx.media3.common.util.Log.i(r10, r4)     // Catch:{ ClassNotFoundException -> 0x00c4, Exception -> 0x00c6 }
            goto L_0x00d0
        L_0x00c4:
            r6 = r5
            goto L_0x00cf
        ...
        L_0x00d0:
            ...
            androidx.media3.exoplayer.Renderer r0 = (androidx.media3.exoplayer.Renderer) r0     // Catch:{ ClassNotFoundException -> 0x0108, Exception -> 0x00ff }
            r9.add(r5, r0)     // Catch:{ ClassNotFoundException -> 0x0108, Exception -> 0x00ff }
            java.lang.String r0 = "Loaded FfmpegAudioRenderer."
            androidx.media3.common.util.Log.i(r10, r0)     // Catch:{ ClassNotFoundException -> 0x0108, Exception -> 0x00ff }
            goto L_0x0108
        L_0x00ff:
            r0 = move-exception
            java.lang.RuntimeException r1 = new java.lang.RuntimeException
    ...
    public AudioSink buildAudioSink(Context context2, boolean z, boolean z2, boolean z3) {
        return new DefaultAudioSink.Builder(context2).setEnableFloatOutput(z).setEnableAudioTrackPlaybackParams(z2).setOffloadMode(z3 ? 1 : 0).build();
    }
