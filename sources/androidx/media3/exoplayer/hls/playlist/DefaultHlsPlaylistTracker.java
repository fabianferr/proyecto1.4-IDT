...
public final class DefaultHlsPlaylistTracker implements HlsPlaylistTracker, Loader.Callback<ParsingLoadable<HlsPlaylist>> {
    ...
    private final class MediaPlaylistBundle implements Loader.Callback<ParsingLoadable<HlsPlaylist>> {
        ...
        public /* synthetic */ void m126lambda$loadPlaylistInternal$0$androidxmedia3exoplayerhlsplaylistDefaultHlsPlaylistTracker$MediaPlaylistBundle(Uri uri) {
        ...
        public void processLoadedPlaylist(HlsMediaPlaylist hlsMediaPlaylist, LoadEventInfo loadEventInfo) {
            ...
            if (access$1400 != hlsMediaPlaylist2) {
                ...
                if (hlsMediaPlaylist.mediaSequence + ((long) hlsMediaPlaylist.segments.size()) < this.playlistSnapshot.mediaSequence) {
                    ...
                    double usToMs = (double) Util.usToMs(this.playlistSnapshot.targetDurationUs);
                    double access$1600 = DefaultHlsPlaylistTracker.this.playlistStuckTargetDurationCoefficient;
                    Double.isNaN(usToMs);
                    if (((double) (elapsedRealtime - this.lastSnapshotChangeMs)) > usToMs * access$1600) {
