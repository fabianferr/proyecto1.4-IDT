...
final class AdTagLoader implements Player.Listener {
    ...
    public AdTagLoader(Context context, ImaUtil.Configuration configuration2, ImaUtil.ImaFactory imaFactory2, List<String> list, DataSpec dataSpec, Object obj, ViewGroup viewGroup) {
        ...
        this.updateAdProgressRunnable = new AdTagLoader$$ExternalSyntheticLambda0(this);
        ...
        this.adLoadTimeoutRunnable = new AdTagLoader$$ExternalSyntheticLambda1(this);
        if (viewGroup != null) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:11:0x0054, code lost:
        if (r2 >= r6.eventListeners.size()) goto L_0x00af;
     */
    ...
    private boolean isWaitingForCurrentAdToLoad() {
        ...
        if (adGroup.count == -1 || adGroup.count <= currentAdIndexInAdGroup || adGroup.states[currentAdIndexInAdGroup] == 0) {
            return true;
        }
        return false;
    }
    ...
    private static boolean hasMidrollAdGroups(AdPlaybackState adPlaybackState2) {
        ...
        if (i == 1) {
            ...
            return true;
        } else if (i == 2 && adPlaybackState2.getAdGroup(0).timeUs == 0 && adPlaybackState2.getAdGroup(1).timeUs == Long.MIN_VALUE) {
            return false;
        } else {
            return true;
        }
        ...
        public VideoProgressUpdate getContentProgress() {
            ...
            if (AdTagLoader.this.waitingForPreloadElapsedRealtimeMs != -9223372036854775807L) {
                if (SystemClock.elapsedRealtime() - AdTagLoader.this.waitingForPreloadElapsedRealtimeMs >= AdTagLoader.THRESHOLD_AD_PRELOAD_MS) {
                    long unused = AdTagLoader.this.waitingForPreloadElapsedRealtimeMs = -9223372036854775807L;
