...
final class ProgressiveMediaPeriod implements MediaPeriod, ExtractorOutput, Loader.Callback<ExtractingLoadable>, Loader.ReleaseCallback, SampleQueue.UpstreamFormatChangedListener {
    ...
    public /* synthetic */ void m1571lambda$new$0$androidxmedia3exoplayersourceProgressiveMediaPeriod() {
        if (!this.released) {
    ...
    public /* synthetic */ void m1572lambda$onLengthKnown$2$androidxmedia3exoplayersourceProgressiveMediaPeriod() {
    ...
    public void m1573lambda$seekMap$1$androidxmedia3exoplayersourceProgressiveMediaPeriod(SeekMap seekMap2) {
        ...
        int i = 1;
        boolean z = !this.isLengthKnown && seekMap2.getDurationUs() == -9223372036854775807L;
        this.isLive = z;
        if (z) {
            i = 7;
        }
