...
public class SampleQueue implements TrackOutput {
    ...
    private synchronized int peekSampleMetadata(androidx.media3.exoplayer.FormatHolder r6, androidx.media3.decoder.DecoderInputBuffer r7, boolean r8, boolean r9, androidx.media3.exoplayer.source.SampleQueue.SampleExtrasHolder r10) {
        /*
            ...
            monitor-enter(r5)
            r0 = 0
            r7.waitingForKeys = r0     // Catch:{ all -> 0x009c }
            boolean r0 = r5.hasNextSample()     // Catch:{ all -> 0x009c }
            r1 = -5
            r2 = -3
            r3 = -4
            if (r0 != 0) goto L_0x0031
            if (r9 != 0) goto L_0x002b
            boolean r9 = r5.isLastSampleQueued     // Catch:{ all -> 0x009c }
            if (r9 == 0) goto L_0x0014
            goto L_0x002b
        L_0x0014:
            androidx.media3.common.Format r7 = r5.upstreamFormat     // Catch:{ all -> 0x009c }
            if (r7 == 0) goto L_0x0029
            if (r8 != 0) goto L_0x001e
            androidx.media3.common.Format r8 = r5.downstreamFormat     // Catch:{ all -> 0x009c }
            if (r7 == r8) goto L_0x0029
        L_0x001e:
            java.lang.Object r7 = androidx.media3.common.util.Assertions.checkNotNull(r7)     // Catch:{ all -> 0x009c }
            androidx.media3.common.Format r7 = (androidx.media3.common.Format) r7     // Catch:{ all -> 0x009c }
            r5.onFormatResult(r7, r6)     // Catch:{ all -> 0x009c }
            monitor-exit(r5)
            return r1
        L_0x0029:
            monitor-exit(r5)
        ...
        L_0x002b:
            r6 = 4
            r7.setFlags(r6)     // Catch:{ all -> 0x009c }
            monitor-exit(r5)
            return r3
        L_0x0031:
            androidx.media3.exoplayer.source.SpannedData<androidx.media3.exoplayer.source.SampleQueue$SharedSampleMetadata> r0 = r5.sharedSampleMetadata     // Catch:{ all -> 0x009c }
            int r4 = r5.getReadIndex()     // Catch:{ all -> 0x009c }
            java.lang.Object r0 = r0.get(r4)     // Catch:{ all -> 0x009c }
            androidx.media3.exoplayer.source.SampleQueue$SharedSampleMetadata r0 = (androidx.media3.exoplayer.source.SampleQueue.SharedSampleMetadata) r0     // Catch:{ all -> 0x009c }
            androidx.media3.common.Format r0 = r0.format     // Catch:{ all -> 0x009c }
            if (r8 != 0) goto L_0x0097
            androidx.media3.common.Format r8 = r5.downstreamFormat     // Catch:{ all -> 0x009c }
            if (r0 == r8) goto L_0x0046
            goto L_0x0097
        L_0x0046:
            int r6 = r5.readPosition     // Catch:{ all -> 0x009c }
            int r6 = r5.getRelativeIndex(r6)     // Catch:{ all -> 0x009c }
            boolean r8 = r5.mayReadSample(r6)     // Catch:{ all -> 0x009c }
            r0 = 1
            ...
            return r2
        L_0x0057:
            int[] r8 = r5.flags     // Catch:{ all -> 0x009c }
            r8 = r8[r6]     // Catch:{ all -> 0x009c }
            r7.setFlags(r8)     // Catch:{ all -> 0x009c }
            int r8 = r5.readPosition     // Catch:{ all -> 0x009c }
            int r1 = r5.length     // Catch:{ all -> 0x009c }
            int r1 = r1 - r0
            if (r8 != r1) goto L_0x0070
            if (r9 != 0) goto L_0x006b
            boolean r8 = r5.isLastSampleQueued     // Catch:{ all -> 0x009c }
            if (r8 == 0) goto L_0x0070
        L_0x006b:
            r8 = 536870912(0x20000000, float:1.0842022E-19)
            r7.addFlag(r8)     // Catch:{ all -> 0x009c }
        L_0x0070:
            long[] r8 = r5.timesUs     // Catch:{ all -> 0x009c }
            r0 = r8[r6]     // Catch:{ all -> 0x009c }
            r7.timeUs = r0     // Catch:{ all -> 0x009c }
            long r8 = r7.timeUs     // Catch:{ all -> 0x009c }
            long r0 = r5.startTimeUs     // Catch:{ all -> 0x009c }
            int r2 = (r8 > r0 ? 1 : (r8 == r0 ? 0 : -1))
            if (r2 >= 0) goto L_0x0083
            r8 = -2147483648(0xffffffff80000000, float:-0.0)
            r7.addFlag(r8)     // Catch:{ all -> 0x009c }
        L_0x0083:
            int[] r7 = r5.sizes     // Catch:{ all -> 0x009c }
            r7 = r7[r6]     // Catch:{ all -> 0x009c }
            r10.size = r7     // Catch:{ all -> 0x009c }
            long[] r7 = r5.offsets     // Catch:{ all -> 0x009c }
            r8 = r7[r6]     // Catch:{ all -> 0x009c }
            r10.offset = r8     // Catch:{ all -> 0x009c }
            androidx.media3.extractor.TrackOutput$CryptoData[] r7 = r5.cryptoDatas     // Catch:{ all -> 0x009c }
            r6 = r7[r6]     // Catch:{ all -> 0x009c }
            r10.cryptoData = r6     // Catch:{ all -> 0x009c }
            monitor-exit(r5)
            return r3
        L_0x0097:
            r5.onFormatResult(r0, r6)     // Catch:{ all -> 0x009c }
            monitor-exit(r5)
            return r1
        L_0x009c:
            r6 = move-exception
