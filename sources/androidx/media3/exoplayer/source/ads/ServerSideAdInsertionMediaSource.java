...
public final class ServerSideAdInsertionMediaSource extends BaseMediaSource implements MediaSource.MediaSourceCaller, MediaSourceEventListener, DrmSessionEventListener {
    ...
    public void setAdPlaybackStates(ImmutableMap<Object, AdPlaybackState> immutableMap, Timeline timeline) {
        ...
        synchronized (this) {
            ...
            if (handler == null) {
                this.adPlaybackStates = immutableMap2;
            } else {
                handler.post(new ServerSideAdInsertionMediaSource$$ExternalSyntheticLambda0(this, immutableMap2, timeline));
            }
        }
    }
    ...
    public /* synthetic */ void m1579lambda$setAdPlaybackStates$0$androidxmedia3exoplayersourceadsServerSideAdInsertionMediaSource(ImmutableMap immutableMap, Timeline timeline) {
