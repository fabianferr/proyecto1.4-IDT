...
public final class CmcdHeadersFactory {
    ...
    public CmcdHeadersFactory(CmcdConfiguration cmcdConfiguration2, ExoTrackSelection exoTrackSelection, long j, String str, boolean z) {
    ...
    public ImmutableMap<String, String> createHttpRequestHeaders() {
        ...
        if (this.cmcdConfiguration.isMeasuredThroughputLoggingAllowed() && this.trackSelection.getLatestBitrateEstimate() != Long.MIN_VALUE) {
            customData3.setMeasuredThroughputInKbps(Util.ceilDivide(this.trackSelection.getLatestBitrateEstimate(), 1000));
        }
