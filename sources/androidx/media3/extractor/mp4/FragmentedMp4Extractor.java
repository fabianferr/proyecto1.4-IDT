...
public class FragmentedMp4Extractor implements Extractor {
    ...
    private void onEmsgLeafAtomRead(androidx.media3.common.util.ParsableByteArray r28) {
        ...
        L_0x000a:
            ...
            r1.setPosition(r2)
            int r2 = r28.readInt()
            int r2 = androidx.media3.extractor.mp4.Atom.parseFullAtomVersion(r2)
            r3 = 1
    ...
    private static androidx.media3.extractor.mp4.FragmentedMp4Extractor.TrackBundle parseTfhd(androidx.media3.common.util.ParsableByteArray r4, android.util.SparseArray<androidx.media3.extractor.mp4.FragmentedMp4Extractor.TrackBundle> r5, boolean r6) {
        /*
            ...
            r4.setPosition(r0)
            int r0 = r4.readInt()
            int r0 = androidx.media3.extractor.mp4.Atom.parseFullAtomFlags(r0)
            int r1 = r4.readInt()
    ...
    private static boolean isEdtsListDurationForEntireMediaTimeline(Track track) {
        ...
        if (track.editListDurations[0] != 0 && Util.scaleLargeTimestamp(track.editListDurations[0] + track.editListMediaTimes[0], 1000000, track.movieTimescale) < track.durationUs) {
            return false;
        }
        return true;
    }
