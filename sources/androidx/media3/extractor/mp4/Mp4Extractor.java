...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    private boolean readAtomPayload(androidx.media3.extractor.ExtractorInput r10, androidx.media3.extractor.PositionHolder r11) throws java.io.IOException {
        /*
            ...
            goto L_0x004f
        L_0x0029:
            java.util.ArrayDeque<androidx.media3.extractor.mp4.Atom$ContainerAtom> r10 = r9.containerAtoms
            ...
            int r0 = r9.atomType
            r11.<init>(r0, r4)
            r10.add((androidx.media3.extractor.mp4.Atom.LeafAtom) r11)
            goto L_0x004f
        L_0x0044:
    ...
    private void processMoovAtom(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        Metadata metadata7 = AtomParsers.parseMvhd(((Atom.LeafAtom) Assertions.checkNotNull(containerAtom2.getLeafAtomOfType(1836476516))).data).metadata;
        Metadata metadata8 = parseMdtaFromMeta;
        List<TrackSampleTable> parseTraks = AtomParsers.parseTraks(containerAtom, gaplessInfoHolder, -9223372036854775807L, (DrmInitData) null, (this.flags & 1) != 0, z, new Mp4Extractor$$ExternalSyntheticLambda1());
    ...
    private static final class Mp4Track {
        ...
        public Mp4Track(Track track2, TrackSampleTable trackSampleTable, TrackOutput trackOutput2) {
            ...
            this.trueHdSampleRechunker = "audio/true-hd".equals(track2.format.sampleMimeType) ? new TrueHdSampleRechunker() : null;
        }
    }
}
