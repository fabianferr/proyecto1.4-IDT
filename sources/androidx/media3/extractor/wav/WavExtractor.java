    ...
    private static final class PassthroughOutputWriter implements OutputWriter {
        ...
        public boolean sampleData(ExtractorInput extractorInput, long j) throws IOException {
            ...
            while (j2 > 0 && (i = this.pendingOutputBytes) < (i2 = this.targetSampleSizeBytes)) {
                int sampleData = this.trackOutput.sampleData((DataReader) extractorInput, (int) Math.min((long) (i2 - i), j2), true);
                if (sampleData == -1) {
                    j2 = 0;
                } else {
            ...
            if (i4 > 0) {
                ...
                this.trackOutput.sampleMetadata(this.startTimeUs + Util.scaleLargeTimestamp(this.outputFrameCount, 1000000, (long) this.wavFormat.frameRateHz), 1, i5, i6, (TrackOutput.CryptoData) null);
    ...
    private static final class ImaAdPcmOutputWriter implements OutputWriter {
        ...
        public ImaAdPcmOutputWriter(ExtractorOutput extractorOutput2, TrackOutput trackOutput2, WavFormat wavFormat2) throws ParserException {
            ...
            if (readLittleEndianUnsignedShort == i2) {
                ...
                this.format = new Format.Builder().setSampleMimeType("audio/raw").setAverageBitrate(i3).setPeakBitrate(i3).setMaxInputSize(numOutputFramesToBytes(max, i)).setChannelCount(wavFormat2.numChannels).setSampleRate(wavFormat2.frameRateHz).setPcmEncoding(2).build();
                return;
            }
