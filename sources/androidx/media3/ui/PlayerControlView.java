...
public class PlayerControlView extends FrameLayout {
    ...
    public PlayerControlView(Context context, AttributeSet attributeSet, int i, AttributeSet attributeSet2) {
        ...
        initializeFullScreenButton(imageView2, new PlayerControlView$$ExternalSyntheticLambda1(this));
        ImageView imageView3 = (ImageView) findViewById(R.id.exo_minimal_fullscreen);
        this.minimalFullScreenButton = imageView3;
        initializeFullScreenButton(imageView3, new PlayerControlView$$ExternalSyntheticLambda1(this));
        ...
        this.buttonAlphaDisabled = ((float) resources2.getInteger(R.integer.exo_media_button_opacity_percentage_disabled)) / 100.0f;
        ...
        playerControlViewLayoutManager.setAnimationEnabled(z10);
        ...
        this.subtitleOnButtonDrawable = Util.getDrawable(context2, resources2, R.drawable.exo_styled_controls_subtitle_on);
        this.subtitleOffButtonDrawable = Util.getDrawable(context2, resources2, R.drawable.exo_styled_controls_subtitle_off);
        ...
        this.fullScreenExitDrawable = Util.getDrawable(context2, resources2, R.drawable.exo_styled_controls_fullscreen_exit);
        this.fullScreenEnterDrawable = Util.getDrawable(context2, resources2, R.drawable.exo_styled_controls_fullscreen_enter);
        this.repeatOffButtonDrawable = Util.getDrawable(context2, resources2, R.drawable.exo_styled_controls_repeat_off);
        this.repeatOneButtonDrawable = Util.getDrawable(context2, resources2, R.drawable.exo_styled_controls_repeat_one);
        this.repeatAllButtonDrawable = Util.getDrawable(context2, resources2, R.drawable.exo_styled_controls_repeat_all);
        this.shuffleOnButtonDrawable = Util.getDrawable(context2, resources2, R.drawable.exo_styled_controls_shuffle_on);
        this.shuffleOffButtonDrawable = Util.getDrawable(context2, resources2, R.drawable.exo_styled_controls_shuffle_off);
        ...
        playerControlViewLayoutManager.setShowButton(findViewById9, z5);
        ...
        playerControlViewLayoutManager.setShowButton(view4, z3);
        playerControlViewLayoutManager.setShowButton(imageView8, z21);
        playerControlViewLayoutManager.setShowButton(imageView7, z20);
        playerControlViewLayoutManager.setShowButton(view3, z9);
        playerControlViewLayoutManager.setShowButton(imageView6, this.repeatToggleModes != 0);
        addOnLayoutChangeListener(new PlayerControlView$$ExternalSyntheticLambda2(this));
    }
    ...
    private void updateFastForwardButton() {
        Player player2 = this.player;
        int seekForwardIncrement = (int) ((player2 != null ? player2.getSeekForwardIncrement() : 15000) / 1000);
    ...
    public boolean dispatchMediaKeyEvent(KeyEvent keyEvent) {
        ...
        if (keyCode == 90) {
            ...
            if (keyCode == 79 || keyCode == 85) {
                Util.handlePlayPauseButtonAction(player2);
                return true;
            } else if (keyCode != 87) {
                if (keyCode != 88) {
                    if (keyCode == 126) {
    ...
    private static boolean canShowMultiWindowTimeBar(androidx.media3.common.Player r9, androidx.media3.common.Timeline.Window r10) {
        /*
            r0 = 17
            ...
            return r1
        L_0x000a:
            androidx.media3.common.Timeline r9 = r9.getCurrentTimeline()
        ...
        L_0x001b:
            ...
            androidx.media3.common.Timeline$Window r4 = r9.getWindow(r3, r10)
        ...
        L_0x0031:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.media3.ui.PlayerControlView.canShowMultiWindowTimeBar(androidx.media3.common.Player, androidx.media3.common.Timeline$Window):boolean");
    }
    ...
    private final class SettingViewHolder extends RecyclerView.ViewHolder {
        ...
        public /* synthetic */ void m1603lambda$new$0$androidxmedia3uiPlayerControlView$SettingViewHolder(View view) {
    ...
    private final class PlaybackSpeedAdapter extends RecyclerView.Adapter<SubSettingViewHolder> {
        ...
        public /* synthetic */ void m1602lambda$onBindViewHolder$0$androidxmedia3uiPlayerControlView$PlaybackSpeedAdapter(int i, View view) {
            if (i != this.selectedIndex) {
    ...
    private final class TextTrackSelectionAdapter extends TrackSelectionAdapter {
        ...
        public void init(List<TrackInformation> list) {
            ...
            if (PlayerControlView.this.subtitleButton != null) {
                ImageView access$3400 = PlayerControlView.this.subtitleButton;
                PlayerControlView playerControlView = PlayerControlView.this;
                access$3400.setImageDrawable(z ? playerControlView.subtitleOnButtonDrawable : playerControlView.subtitleOffButtonDrawable);
        ...
        public /* synthetic */ void m1604lambda$onBindViewHolderAtZeroPosition$0$androidxmedia3uiPlayerControlView$TextTrackSelectionAdapter(View view) {
    ...
    private final class AudioTrackSelectionAdapter extends TrackSelectionAdapter {
        ...
        public /* synthetic */ void m1601lambda$onBindViewHolderAtZeroPosition$0$androidxmedia3uiPlayerControlView$AudioTrackSelectionAdapter(View view) {
            if (PlayerControlView.this.player != null && PlayerControlView.this.player.isCommandAvailable(29)) {
    ...
    private abstract class TrackSelectionAdapter extends RecyclerView.Adapter<SubSettingViewHolder> {
        ...
        public /* synthetic */ void m1605lambda$onBindViewHolder$0$androidxmedia3uiPlayerControlView$TrackSelectionAdapter(Player player, TrackGroup trackGroup, TrackInformation trackInformation, View view) {
