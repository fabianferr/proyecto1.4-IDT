...
public class MediaRouteButton extends View {
    ...
    private boolean showOutputSwitcherForAndroidSAndAbove() {
        Context context = getContext();
        Intent putExtra = new Intent().setAction("com.android.systemui.action.LAUNCH_MEDIA_OUTPUT_DIALOG").setPackage("com.android.systemui").putExtra(CampaignEx.JSON_KEY_PACKAGE_NAME, context.getPackageName()).putExtra("key_media_session_token", this.mRouter.getMediaSessionToken());
