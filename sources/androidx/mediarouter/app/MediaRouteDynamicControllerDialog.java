...
public class MediaRouteDynamicControllerDialog extends AppCompatDialog {
    ...
    private final class RecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public void mayUpdateGroupVolume(MediaRouter.RouteInfo routeInfo, boolean z) {
            ...
            int i2 = 0;
            if (!MediaRouteDynamicControllerDialog.this.mEnableGroupVolumeUX || max < 2) {
                z2 = false;
            }
    ...
    private class FetchArtTask extends AsyncTask<Void, Void, Bitmap> {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:24:0x0050 A[Catch:{ IOException -> 0x00a3 }] */
        ...
        public android.graphics.Bitmap doInBackground(java.lang.Void... r9) {
            ...
            L_0x000d:
                ...
                r5.<init>(r9)     // Catch:{ IOException -> 0x00a3 }
            ...
            L_0x00a9:
                ...
                r6.<init>(r9)     // Catch:{ all -> 0x00c2 }
                android.net.Uri r9 = r8.mIconUri     // Catch:{ all -> 0x00c2 }
                r6.append(r9)     // Catch:{ all -> 0x00c2 }
                java.lang.String r9 = r6.toString()     // Catch:{ all -> 0x00c2 }
                android.util.Log.w(r3, r9, r5)     // Catch:{ all -> 0x00c2 }
                if (r0 == 0) goto L_0x00ca
