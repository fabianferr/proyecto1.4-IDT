...
public final class DBUtil {
    ...
    public static final void foreignKeyCheck(androidx.sqlite.db.SupportSQLiteDatabase r2, java.lang.String r3) {
        /*
            ...
            r3 = r2
            android.database.Cursor r3 = (android.database.Cursor) r3     // Catch:{ all -> 0x003e }
            int r0 = r3.getCount()     // Catch:{ all -> 0x003e }
            if (r0 > 0) goto L_0x0034
            kotlin.Unit r3 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x003e }
            r3 = 0
            kotlin.io.CloseableKt.closeFinally(r2, r3)
            return
        L_0x0034:
            java.lang.String r3 = processForeignKeyCheckFailure(r3)     // Catch:{ all -> 0x003e }
            android.database.sqlite.SQLiteConstraintException r0 = new android.database.sqlite.SQLiteConstraintException     // Catch:{ all -> 0x003e }
