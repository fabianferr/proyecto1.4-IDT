...
public final class FrameworkSQLiteOpenHelper implements SupportSQLiteOpenHelper {
    ...
    private static final class OpenHelper extends SQLiteOpenHelper {
        ...
        private final android.database.sqlite.SQLiteDatabase innerGetDatabase(boolean r5) {
            ...
            L_0x002e:
                android.database.sqlite.SQLiteDatabase r5 = r4.getWritableOrReadableDatabase(r5)     // Catch:{ all -> 0x0033 }
                return r5
            L_0x0033:
                super.close()
                r1 = 500(0x1f4, double:2.47E-321)
                java.lang.Thread.sleep(r1)     // Catch:{ InterruptedException -> 0x003b }
            L_0x003b:
                android.database.sqlite.SQLiteDatabase r5 = r4.getWritableOrReadableDatabase(r5)     // Catch:{ all -> 0x0040 }
                return r5
            L_0x0040:
                r1 = move-exception
                super.close()
            ...
            L_0x0077:
                ...
                android.database.sqlite.SQLiteDatabase r5 = r4.getWritableOrReadableDatabase(r5)     // Catch:{ CallbackException -> 0x0081 }
                return r5
            L_0x0081:
                r5 = move-exception
