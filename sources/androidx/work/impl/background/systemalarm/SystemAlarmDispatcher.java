                ...
                public void run() {
                    ...
                    if (SystemAlarmDispatcher.this.mCurrentIntent != null) {
                        ...
                        try {
                            ...
                            logger2.debug(str2, "Acquiring operation wake lock (" + action + ") " + newWakeLock);
                            newWakeLock.acquire();
                            ...
                            logger3.debug(str3, "Releasing operation wake lock (" + action + ") " + newWakeLock);
                            newWakeLock.release();
                            ...
                            logger4.debug(str4, "Releasing operation wake lock (" + action + ") " + newWakeLock);
                            newWakeLock.release();
