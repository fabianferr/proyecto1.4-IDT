...
public final class WorkSpec {
    ...
    public static final Function<List<WorkInfoPojo>, List<WorkInfo>> WORK_INFO_MAPPER = new WorkSpec$$ExternalSyntheticLambda1();
    ...
    public int hashCode() {
        ...
        return ((((((hashCode2 + (z ? 1 : 0)) * 31) + this.outOfQuotaPolicy.hashCode()) * 31) + this.periodCount) * 31) + this.generation;
    }
