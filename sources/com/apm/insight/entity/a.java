...
public class a {
    ...
    public static void a(JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        String str = "1M - 64M";
        String str2 = optLong <= 1024 ? "0 - 1K" : optLong <= 65536 ? "1K - 64K" : optLong <= PlaybackStateCompat.ACTION_SET_SHUFFLE_MODE_ENABLED ? "64K - 512K" : optLong <= PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED ? "512K - 1M" : optLong <= 67108864 ? str : "64M - ";
        String str3 = optLong3 <= 1024 ? "0 - 1K" : optLong3 <= 65536 ? "1K - 64K" : optLong3 <= PlaybackStateCompat.ACTION_SET_SHUFFLE_MODE_ENABLED ? "64K - 512K" : optLong3 <= PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED ? "512K - 1M" : optLong3 <= 67108864 ? str : "64M - ";
        if (optLong2 <= 1024) {
            str = "0 - 1K";
        ...
        a(jSONObject3, ShareConstants.WEB_DIALOG_PARAM_FILTERS, "inner_free", str2);
        a(jSONObject3, ShareConstants.WEB_DIALOG_PARAM_FILTERS, "inner_free_real", str3);
        a(jSONObject3, ShareConstants.WEB_DIALOG_PARAM_FILTERS, "sdcard_free", str);
    }
    ...
    public a a(String str, String str2) {
        ...
        a(opt instanceof JSONArray ? ((JSONArray) opt).optJSONObject(0) : h(), ShareConstants.WEB_DIALOG_PARAM_FILTERS, str, str2);
        return this;
    }
    ...
    public a c(Map<? extends String, ? extends String> map) {
        if (map != null) {
            JSONObject e = e(ShareConstants.WEB_DIALOG_PARAM_FILTERS);
            for (Map.Entry next : map.entrySet()) {
                try {
            ...
            a(ShareConstants.WEB_DIALOG_PARAM_FILTERS, (Object) e);
        }
        return this;
    }
