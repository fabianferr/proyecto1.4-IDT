...
public class k {
    ...
    public static void a(boolean r2, org.json.JSONArray r3) {
        /*
            ...
            android.content.Context r0 = com.apm.insight.i.g()     // Catch:{ IOException -> 0x0013 }
        ...
        L_0x0013:
            java.io.File r2 = g()     // Catch:{ all -> 0x001c }
    ...
    static boolean a(boolean z) {
        ...
        try {
            ...
            if (map == null) {
                f = new HashMap();
                return true;
            } else if (map.size() < b.c()) {
                return true;
            } else {
                for (String containsKey : b.d()) {
                    if (!f.containsKey(containsKey)) {
                        return true;
                    }
                }
