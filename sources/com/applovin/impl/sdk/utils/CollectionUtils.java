...
public class CollectionUtils {
    ...
    public static <K, V> Map<K, V> map(int i) {
        List<AppLovinSdk> a = AppLovinSdk.a();
        AppLovinSdk appLovinSdk = a.size() > 0 ? a.get(0) : null;
        return (!g.c() || appLovinSdk == null || !((Boolean) appLovinSdk.coreSdk.a(b.ao)).booleanValue()) ? i == -1 ? new HashMap() : new HashMap(i) : i == -1 ? new ArrayMap() : new ArrayMap(i);
    }
