            ...
            AppLovinSdkUtils.runOnUiThread(new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify ad event listener about fullscreen opened event", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify ad event listener about display failed event", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify native ad event listener about ad click", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify native ad event listener about ad failing to load", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(z, new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify ad event listener about ad failing to display", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(z, new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify ad event listener about user being rewarded", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(z, new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify ad event listener about ad being loaded", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(z, new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify ad event listener about ad failing to load", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(z, new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify request listener about ad request starting", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(z, new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify ad event listener about ad revenue being paid", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(z, new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify Ad Review creative id generated", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(z, new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify ad event listener about native ad being clicked", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(z, new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify ad event listener about native ad being loaded", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(z, new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify ad event listener about native ad failing to load", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify ad event listener about ad being clicked", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify ad event listener about ad being displayed", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify ad reward listener about reward validation request failing", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify ad reward listener about successful reward validation request", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify ad event listener about ad playback began", th);
                        }
                    }
                }
            });
    ...
    public static void a(AppLovinAdVideoPlaybackListener appLovinAdVideoPlaybackListener, AppLovinAd appLovinAd, double d, boolean z) {
        if (appLovinAd != null && appLovinAdVideoPlaybackListener != null) {
            ...
            AppLovinSdkUtils.runOnUiThread(new Runnable() {
                public void run() {
                    try {
                        AppLovinAdVideoPlaybackListener.this.videoPlaybackEnded(j.b(appLovinAd2), d2, z2);
                    } catch (Throwable th) {
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify ad event listener about ad playback ended", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify AppLovinPostbackListener about postback URL (" + str + ") executed", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify AppLovinPostbackListener about postback URL (" + str + ") failing to execute with error code (" + i + "):", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify ad event listener about fullscreen closed event", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify ad event listener about ad being hidden", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify ad reward listener about exceeding quota", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify ad event listener about application leave event", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify ad reward listener about reward validation request being rejected", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(z, new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify ad event listener about rewarded video starting", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(z, new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify ad event listener about rewarded video completing", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(z, new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify ad event listener about ad being expanded", th);
                        }
                    }
                }
            });
            ...
            AppLovinSdkUtils.runOnUiThread(z, new Runnable() {
                public void run() {
                    try {
                        ...
                        if (u.a()) {
                            u.c("ListenerCallbackInvoker", "Unable to notify ad event listener about ad being collapsed", th);
                        }
                    }
                }
            });
