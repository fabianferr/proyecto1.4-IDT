...
public class UriLoader<Data> implements ModelLoader<Uri, Data> {
    private static final Set<String> SCHEMES = Collections.unmodifiableSet(new HashSet(Arrays.asList(new String[]{ShareInternalUtility.STAGING_PARAM, "android.resource", "content"})));
