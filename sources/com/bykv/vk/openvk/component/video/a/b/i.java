...
public class i {
    ...
    static final class a {
            ...
            if (indexOf != -1) {
                ...
                for (String split : cVar.b.substring(indexOf + 1).split("&")) {
                    ...
                    if (split2.length == 2) {
                        ...
                        } else if (f.a.equals(split2[0]) && com.bykv.vk.openvk.component.video.a.c.a.b(split2[1]) == 1) {
                            i3 = 1;
                        }
                    }
                }
        ...
        public String toString() {
            return "Extra{flag=" + this.a + ", rawKey='" + this.b + "', key='" + this.c + "', from=" + this.d + ", to=" + this.e + ", urls=" + this.g + AbstractJsonLexerKt.END_OBJ;
        }
    }
    ...
    public String toString() {
        return "Request{requestLine=" + this.a + ", headers=" + this.b + ", extra=" + this.c + AbstractJsonLexerKt.END_OBJ;
    }
