...
public class PressButtonInteractView extends FrameLayout {
    ...
    public PressButtonInteractView(Context context) {
        ...
        post(new Runnable() {
            public void run() {
                ...
                layoutParams.topMargin = (int) ((((float) PressButtonInteractView.this.c.getMeasuredHeight()) / 2.0f) - e.a(PressButtonInteractView.this.getContext(), 5.0f));
                layoutParams.leftMargin = (int) ((((float) PressButtonInteractView.this.c.getMeasuredWidth()) / 2.0f) - e.a(PressButtonInteractView.this.getContext(), 5.0f));
                layoutParams.bottomMargin = (int) ((((float) (-PressButtonInteractView.this.c.getMeasuredHeight())) / 2.0f) + e.a(PressButtonInteractView.this.getContext(), 5.0f));
                layoutParams.rightMargin = (int) ((((float) (-PressButtonInteractView.this.c.getMeasuredWidth())) / 2.0f) + e.a(PressButtonInteractView.this.getContext(), 5.0f));
    ...
    private void c() {
        ...
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams((int) e.a(this.a, 40.0f), (int) e.a(this.a, 40.0f));
        layoutParams.gravity = 8388627;
        addView(this.c, layoutParams);
        this.b = new ImageView(this.a);
        FrameLayout.LayoutParams layoutParams2 = new FrameLayout.LayoutParams((int) e.a(this.a, 62.0f), (int) e.a(this.a, 62.0f));
