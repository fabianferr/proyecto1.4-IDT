...
public class PAGAppOpenOneLayout extends PAGAppOpenBaseLayout {
    public PAGAppOpenOneLayout(Context context) {
        ...
        RelativeLayout.LayoutParams layoutParams3 = new RelativeLayout.LayoutParams(ad.b(context, 31.0f), ad.b(context, 14.0f));
        ...
        pAGRelativeLayout.addView(a);
        pAGRelativeLayout.addView(this.i);
        int b = ad.b(context, 2.0f);
        int b2 = ad.b(context, 20.0f);
        int b3 = ad.b(context, 22.0f);
        int b4 = ad.b(context, 40.0f);
