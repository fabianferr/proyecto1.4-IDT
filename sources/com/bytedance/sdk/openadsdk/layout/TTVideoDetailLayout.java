...
public class TTVideoDetailLayout extends PAGRelativeLayout {
    ...
    private void a(Context context) {
        ...
        PAGImageView pAGImageView = new PAGImageView(context2);
        ...
        PAGProgressBar pAGProgressBar = new PAGProgressBar(context2);
        pAGProgressBar.setId(i.aI);
        int b = ad.b(context2, 60.0f);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(b, b);
        layoutParams.addRule(13);
        pAGProgressBar.setLayoutParams(layoutParams);
        pAGProgressBar.setIndeterminateDrawable(s.c(context2, "tt_video_loading_progress_bar"));
        ...
        PAGImageView pAGImageView2 = new PAGImageView(context2);
        pAGImageView2.setId(i.aL);
        pAGImageView2.setLayoutParams(new LinearLayout.LayoutParams(-2, -2));
        pAGImageView2.setImageDrawable(s.c(context2, "tt_refreshing_video_textpage"));
        ...
        pAGTextView.setText(s.b(context2, "tt_video_retry_des_txt"));
        pAGTextView.setTextColor(Color.parseColor("#999999"));
        pAGLinearLayout.addView(pAGTextView);
        PAGImageView pAGImageView3 = new PAGImageView(context2);
        ...
        pAGImageView3.setImageDrawable(s.c(context2, "tt_play_movebar_textpage"));
        pAGImageView3.setVisibility(8);
        addView(pAGImageView3);
        PAGImageView pAGImageView4 = new PAGImageView(context2);
        pAGImageView4.setId(i.aN);
        int b2 = ad.b(context2, 30.0f);
        RelativeLayout.LayoutParams layoutParams4 = new RelativeLayout.LayoutParams(b2, b2);
        layoutParams4.addRule(21);
        layoutParams4.addRule(11);
        int b3 = ad.b(context2, 7.0f);
        ...
        pAGImageView4.setBackground(s.c(context2, "tt_detail_video_btn_bg"));
        pAGImageView4.setScaleType(ImageView.ScaleType.CENTER);
        pAGImageView4.setImageDrawable(s.c(context2, "tt_close_move_detail"));
        ...
        pAGTextView2.setBackground(s.c(context2, "tt_video_black_desc_gradient"));
        pAGTextView2.setEllipsize(TextUtils.TruncateAt.END);
        pAGTextView2.setMaxLines(2);
        int b4 = ad.b(context2, 15.0f);
        pAGTextView2.setPadding(b4, ad.b(context2, 14.0f), b4, 0);
        ...
        pAGRelativeLayout2.setBackground(s.c(context2, "tt_video_black_desc_gradient"));
        pAGRelativeLayout2.setGravity(16);
        pAGRelativeLayout2.setVisibility(8);
        addView(pAGRelativeLayout2);
        PAGImageView pAGImageView5 = new PAGImageView(context2);
        pAGImageView5.setId(i.aQ);
        RelativeLayout.LayoutParams layoutParams7 = new RelativeLayout.LayoutParams(-2, -1);
        layoutParams7.addRule(15);
        int b5 = ad.b(context2, 12.0f);
        ...
        pAGImageView5.setImageDrawable(s.c(context2, "tt_leftbackbutton_titlebar_photo_preview"));
        ...
        PAGTextView pAGTextView4 = new PAGTextView(context2);
        ...
        RelativeLayout.LayoutParams layoutParams11 = new RelativeLayout.LayoutParams(-2, ad.b(context2, 40.0f));
        ...
        PAGTextView pAGTextView5 = new PAGTextView(context2);
        ...
        pAGTextView5.setText(s.b(context2, "tt_00_00"));
        ...
        seekBar.setId(i.aW);
        LinearLayout.LayoutParams layoutParams13 = new LinearLayout.LayoutParams(0, ad.b(context2, 5.0f));
        layoutParams13.gravity = 16;
        seekBar.setLayoutParams(layoutParams13);
        seekBar.setMax(100);
        seekBar.setPadding(0, 0, 0, 0);
        seekBar.setProgressDrawable(s.c(context2, "tt_seek_progress"));
        seekBar.setThumb(s.c(context2, "tt_seek_thumb"));
        seekBar.setThumbOffset(0);
        pAGLinearLayout3.addView(seekBar);
        PAGTextView pAGTextView6 = new PAGTextView(context2);
        ...
        pAGImageView6.setImageDrawable(s.c(context2, "tt_enlarge_video"));
        pAGLinearLayout3.addView(pAGImageView6);
        TTVideoAdCoverLayout tTVideoAdCoverLayout = new TTVideoAdCoverLayout(context2);
        ...
        PAGTextView pAGTextView7 = new PAGTextView(context2);
        ...
        pAGTextView7.setMinHeight(ad.b(context2, 44.0f));
        pAGTextView7.setCompoundDrawablesWithIntrinsicBounds(s.c(context2, "tt_shadow_btn_back"), (Drawable) null, (Drawable) null, (Drawable) null);
