...
public final class AppEventsManager$start$1 implements FetchedAppSettingsManager.FetchedAppSettingsCallback {
    ...
    public static final void m1850onSuccess$lambda0(boolean z) {
        if (z) {
    ...
    public static final void m1851onSuccess$lambda1(boolean z) {
        if (z) {
    ...
    public static final void m1852onSuccess$lambda2(boolean z) {
        if (z) {
    ...
    public static final void m1853onSuccess$lambda3(boolean z) {
        if (z) {
    ...
    public static final void m1854onSuccess$lambda4(boolean z) {
        if (z) {
