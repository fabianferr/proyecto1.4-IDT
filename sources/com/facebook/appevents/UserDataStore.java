...
public final class UserDataStore {
    ...
    public static final void m1858writeDataIntoCache$lambda0(String str, String str2) {
        Class<UserDataStore> cls = UserDataStore.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
    ...
    public static final void m1857setUserDataAndHash$lambda1(Bundle bundle) {
        Class<UserDataStore> cls = UserDataStore.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                if (!initialized.get()) {
    ...
    public static final void m1856clear$lambda2() {
        Class<UserDataStore> cls = UserDataStore.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                if (!initialized.get()) {
        ...
        try {
            ...
            if (obj != null) {
                ...
                if (Intrinsics.areEqual((Object) EMAIL, (Object) str)) {
                    ...
                    if (!Intrinsics.areEqual((Object) f.a, (Object) str3)) {
