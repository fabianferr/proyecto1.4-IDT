...
public final class ViewHierarchy {
    ...
    public static final void updateBasicInfoOfView(View view, JSONObject jSONObject) {
        ...
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                ...
                jSONObject.put("dimension", viewHierarchy.getDimensionOfView(view));
    ...
    /* JADX WARNING: Removed duplicated region for block: B:17:0x002f A[ADDED_TO_REGION] */
    ...
    public static final void setOnClickListener(android.view.View r5, android.view.View.OnClickListener r6) {
        ...
        L_0x0009:
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r5, r1)     // Catch:{ all -> 0x0050 }
            r1 = 0
            ...
            java.lang.Class r3 = java.lang.Class.forName(r3)     // Catch:{ ClassNotFoundException | NoSuchFieldException -> 0x0028 }
            java.lang.String r4 = "mOnClickListener"
            java.lang.reflect.Field r3 = r3.getDeclaredField(r4)     // Catch:{ ClassNotFoundException | NoSuchFieldException -> 0x0028 }
            goto L_0x002d
        L_0x0028:
            goto L_0x002c
        L_0x002a:
        ...
        L_0x0032:
            r4 = 1
            r2.setAccessible(r4)     // Catch:{ Exception -> 0x004f }
            r3.setAccessible(r4)     // Catch:{ Exception -> 0x004f }
            r2.setAccessible(r4)     // Catch:{ IllegalAccessException -> 0x0041 }
            java.lang.Object r1 = r2.get(r5)     // Catch:{ IllegalAccessException -> 0x0041 }
            goto L_0x0042
        L_0x0041:
        L_0x0042:
            if (r1 != 0) goto L_0x0048
            r5.setOnClickListener(r6)     // Catch:{ Exception -> 0x004f }
            return
        L_0x0048:
            r3.set(r1, r6)     // Catch:{ Exception -> 0x004f }
            goto L_0x004f
        L_0x004c:
            r5.setOnClickListener(r6)     // Catch:{ Exception -> 0x004f }
        L_0x004f:
