...
public final class SessionLogger {
    private static final long[] INACTIVE_SECONDS_QUANTA = {300000, PeriodicWorkRequest.MIN_PERIODIC_INTERVAL_MILLIS, 1800000, CCS.a, 21600000, 43200000, 86400000, 172800000, 259200000, 604800000, 1209600000, 1814400000, 2419200000L, 5184000000L, 7776000000L, 10368000000L, 12960000000L, 15552000000L, 31536000000L};
        ...
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                ...
                if (sessionInfo != null) {
                    ...
                    Double.isNaN(d);
                    Double.isNaN(d2);
                    internalAppEventsLogger.logEvent(AppEventsConstants.EVENT_NAME_DEACTIVATED_APP, d / d2, bundle);
                }
            } catch (Throwable th) {
                CrashShieldHandler.handleThrowable(th, cls);
            }
