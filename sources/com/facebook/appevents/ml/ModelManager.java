...
public final class ModelManager {
    ...
    public static final void m1890enable$lambda0() {
        /*
        ...
        L_0x002e:
            ...
            r5.<init>(r4)     // Catch:{ Exception -> 0x0084, all -> 0x0080 }
            goto L_0x0039
        L_0x0034:
            org.json.JSONObject r5 = new org.json.JSONObject     // Catch:{ Exception -> 0x0084, all -> 0x0080 }
        ...
        L_0x0084:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.appevents.ml.ModelManager.m1890enable$lambda0():void");
    }
    ...
    /* JADX WARNING: Can't wrap try/catch for region: R(3:16|17|22) */
    ...
    private final org.json.JSONObject parseRawJsonObject(org.json.JSONObject r13) {
        ...
        L_0x0012:
            ...
            int r7 = r13.length()     // Catch:{ JSONException -> 0x0064 }
            if (r7 <= 0) goto L_0x0069
            r8 = 0
        L_0x0024:
            int r9 = r8 + 1
            org.json.JSONObject r8 = r13.getJSONObject(r8)     // Catch:{ JSONException -> 0x0064 }
            org.json.JSONObject r10 = new org.json.JSONObject     // Catch:{ JSONException -> 0x0064 }
            r10.<init>()     // Catch:{ JSONException -> 0x0064 }
            java.lang.String r11 = r8.getString(r2)     // Catch:{ JSONException -> 0x0064 }
            r10.put(r2, r11)     // Catch:{ JSONException -> 0x0064 }
            java.lang.String r11 = r8.getString(r4)     // Catch:{ JSONException -> 0x0064 }
            r10.put(r4, r11)     // Catch:{ JSONException -> 0x0064 }
            org.json.JSONArray r11 = r8.getJSONArray(r1)     // Catch:{ JSONException -> 0x0064 }
            r10.put(r1, r11)     // Catch:{ JSONException -> 0x0064 }
            java.lang.String r11 = r8.getString(r0)     // Catch:{ JSONException -> 0x0064 }
            r10.put(r0, r11)     // Catch:{ JSONException -> 0x0064 }
            boolean r11 = r8.has(r3)     // Catch:{ JSONException -> 0x0064 }
            if (r11 == 0) goto L_0x0058
            java.lang.String r11 = r8.getString(r3)     // Catch:{ JSONException -> 0x0064 }
            r10.put(r3, r11)     // Catch:{ JSONException -> 0x0064 }
        L_0x0058:
            java.lang.String r8 = r8.getString(r4)     // Catch:{ JSONException -> 0x0064 }
            r5.put(r8, r10)     // Catch:{ JSONException -> 0x0064 }
    ...
    public static final void m1891enableMTML$lambda1() {
        Class<ModelManager> cls = ModelManager.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
    ...
    public static final void m1892enableMTML$lambda2() {
        Class<ModelManager> cls = ModelManager.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
    ...
    private static final class TaskHandler {
        ...
        public static final class Companion {
            ...
            public static final void m1894execute$lambda1(List list, File file) {
                Intrinsics.checkNotNullParameter(list, "$slaves");
            ...
            public static final void m1895execute$lambda1$lambda0(TaskHandler taskHandler, Model model, File file) {
