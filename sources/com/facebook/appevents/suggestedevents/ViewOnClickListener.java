...
public final class ViewOnClickListener implements View.OnClickListener {
    ...
    public static final void m1900predictAndProcess$lambda0(JSONObject jSONObject, String str, ViewOnClickListener viewOnClickListener, String str2) {
        Class<ViewOnClickListener> cls = ViewOnClickListener.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
    ...
    public static final class Companion {
        ...
        public static final void m1901queryHistoryAndProcess$lambda0(String str, String str2) {
