...
public final /* synthetic */ class Task$Companion$$ExternalSyntheticLambda5 implements Runnable {
    ...
    public /* synthetic */ Task$Companion$$ExternalSyntheticLambda5(CancellationToken cancellationToken, TaskCompletionSource taskCompletionSource, Continuation continuation, Task task) {
    ...
    public final void run() {
        Task.Companion.m1911completeAfterTask$lambda7(this.f$0, this.f$1, this.f$2, this.f$3);
    }
}
