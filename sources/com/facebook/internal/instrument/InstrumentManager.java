...
public final class InstrumentManager {
    ...
    public static final void m1952start$lambda0(boolean z) {
        if (z) {
    ...
    public static final void m1953start$lambda1(boolean z) {
        if (z) {
    ...
    public static final void m1954start$lambda2(boolean z) {
        if (z) {
