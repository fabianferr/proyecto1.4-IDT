...
public final class OidcSecurityUtil {
    ...
    public static final String getRawKeyFromEndPoint(String str) {
        ...
        URL url = new URL(ProxyConfig.MATCH_HTTPS, Intrinsics.stringPlus("www.", FacebookSdk.getFacebookDomain()), OPENID_KEYS_PATH);
    ...
    public static final void m1969getRawKeyFromEndPoint$lambda1(URL url, Ref.ObjectRef objectRef, String str, ReentrantLock reentrantLock, Condition condition) {
        Lock lock;
        Lock lock2;
