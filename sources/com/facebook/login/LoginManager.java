...
public class LoginManager {
    ...
    public static final boolean m240registerCallback$lambda0(LoginManager loginManager, FacebookCallback facebookCallback, int i, Intent intent) {
    ...
    public static final boolean m242startLogin$lambda1(LoginManager loginManager, int i, Intent intent) {
        Intrinsics.checkNotNullParameter(loginManager, "this$0");
    ...
    private final void retrieveLoginStatusImpl(Context context, LoginStatusCallback loginStatusCallback, long j) {
        ...
        loginStatusClient.setCompletedListener(new LoginManager$$ExternalSyntheticLambda1(uuid, loginLogger, loginStatusCallback, applicationId));
    ...
    public static final void m241retrieveLoginStatusImpl$lambda2(String str, LoginLogger loginLogger, LoginStatusCallback loginStatusCallback, String str2, Bundle bundle) {
        String str3 = str;
        ...
        if (bundle2 != null) {
            ...
            String userIDFromSignedRequest = !Utility.isNullOrEmpty(string4) ? LoginMethodHandler.Companion.getUserIDFromSignedRequest(string4) : null;
            if (string3 != null) {
                boolean z = false;
                if ((string3.length() > 0) && stringArrayList != null) {
                    Collection collection = stringArrayList;
                    if ((!collection.isEmpty()) && userIDFromSignedRequest != null) {
                        if (userIDFromSignedRequest.length() > 0) {
                            z = true;
                        }
                        if (z) {
    ...
    private static final class AndroidxActivityResultRegistryOwnerStartActivityDelegate implements StartActivityDelegate {
        ...
        public static final void m1977startActivityForResult$lambda0(AndroidxActivityResultRegistryOwnerStartActivityDelegate androidxActivityResultRegistryOwnerStartActivityDelegate, LoginManager$AndroidxActivityResultRegistryOwnerStartActivityDelegate$startActivityForResult$LauncherHolder loginManager$AndroidxActivityResultRegistryOwnerStartActivityDelegate$startActivityForResult$LauncherHolder, Pair pair) {
