...
final class zzaeb implements zzaib {
    ...
    private zzaeb(zzaea zzaea) {
        byte[] bArr = zzafa.zzd;
        this.zza = zzaea;
        zzaea.zza = this;
    }

    public static zzaeb zza(zzaea zzaea) {
        zzaeb zzaeb = zzaea.zza;
        return zzaeb != null ? zzaeb : new zzaeb(zzaea);
    }
    ...
    public final void zzd(int i, zzadr zzadr) throws IOException {
        this.zza.zze(i, zzadr);
    }
    ...
    public final void zzq(int i, Object obj, zzags zzags) throws IOException {
        zzaea zzaea = this.zza;
        zzaea.zzo(i, 3);
        zzags.zzj((zzafz) obj, zzaea.zza);
        zzaea.zzo(i, 4);
    }
    ...
    public final void zzv(int i, Object obj, zzags zzags) throws IOException {
        zzafz zzafz = (zzafz) obj;
        zzadx zzadx = (zzadx) this.zza;
        zzadx.zzq((i << 3) | 2);
        zzadx.zzq(((zzadb) zzafz).zzat(zzags));
        zzags.zzj(zzafz, zzadx.zza);
    }
    ...
    public final void zzB(int i, List list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            while (i2 < list.size()) {
                ...
                zzaea.zzq((intValue2 >> 31) ^ (intValue2 + intValue2));
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            zzaea zzaea2 = this.zza;
            int intValue3 = ((Integer) list.get(i2)).intValue();
            zzaea2.zzp(i, (intValue3 >> 31) ^ (intValue3 + intValue3));
            i2++;
        }
    }
    ...
    public final void zzD(int i, List list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            while (i2 < list.size()) {
                ...
                zzaea.zzs((longValue2 >> 63) ^ (longValue2 + longValue2));
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            ...
            zzaea2.zzr(i, (longValue3 >> 63) ^ (longValue3 + longValue3));
            i2++;
        }
    }
