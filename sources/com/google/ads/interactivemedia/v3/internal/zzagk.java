...
interface zzagk {
    ...
    @Deprecated
    void zzC(List list, zzags zzags, zzaef zzaef) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzags zzags, zzaef zzaef) throws IOException;
    ...
    void zzt(Object obj, zzags zzags, zzaef zzaef) throws IOException;

    void zzu(Object obj, zzags zzags, zzaef zzaef) throws IOException;
