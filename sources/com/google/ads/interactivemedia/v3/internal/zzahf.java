...
class zzahf extends AbstractMap {
    ...
    /* synthetic */ zzahf(int i, zzahe zzahe) {
        this.zza = i;
    }
    ...
    public final Set entrySet() {
        if (this.zze == null) {
            this.zze = new zzahd(this, (zzahc) null);
        }
        return this.zze;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        int zzb2 = zzb();
        if (zzb2 != zzahf.zzb()) {
            return entrySet().equals(zzahf.entrySet());
        }
        for (int i = 0; i < zzb2; i++) {
            if (!zzg(i).equals(zzahf.zzg(i))) {
                return false;
            }
        }
        if (zzb2 != size) {
            return this.zzc.equals(zzahf.zzc);
        }
        return true;
    }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzagz zzagz = (zzagz) this.zzb.remove(i2 - 1);
            zzm().put(zzagz.zza(), zzagz.getValue());
        }
