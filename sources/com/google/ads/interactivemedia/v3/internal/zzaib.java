...
interface zzaib {
    ...
    void zzd(int i, zzadr zzadr) throws IOException;
    ...
    @Deprecated
    void zzq(int i, Object obj, zzags zzags) throws IOException;
    ...
    void zzv(int i, Object obj, zzags zzags) throws IOException;
