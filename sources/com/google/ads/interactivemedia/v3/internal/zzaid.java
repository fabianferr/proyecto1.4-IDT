                ...
                if (obj instanceof long[]) {
                    ...
                    if (this.zza == 0 && jArr != jArr2) {
                        ...
                        if (length != length2) {
                            ...
                            while (i2 < jArr.length && this.zza == 0) {
                                this.zza = (jArr[i2] > jArr2[i2] ? 1 : (jArr[i2] == jArr2[i2] ? 0 : -1));
                                i2++;
                            }
                        }
                    }
                    ...
                    if (this.zza == 0 && iArr != iArr2) {
                        ...
                        if (length3 != length4) {
                            ...
                            for (int i3 = 0; i3 < iArr.length && this.zza == 0; i3++) {
                                int i4 = iArr[i3];
                                int i5 = iArr2[i3];
                                this.zza = i4 == i5 ? 0 : i4 < i5 ? -1 : 1;
                            }
                        }
                    }
