...
public final class zzcn {
    ...
    public static JSONObject zza(int i, int i2, int i3, int i4) {
        ...
        try {
            ...
            jSONObject.put(ViewHierarchyConstants.DIMENSION_WIDTH_KEY, (double) (((float) i3) / zza));
            jSONObject.put(ViewHierarchyConstants.DIMENSION_HEIGHT_KEY, (double) (((float) i4) / zza));
