...
public final class zzsh extends AbstractMap implements Serializable, zzrt {
    ...
    private final void zzr(int i) {
        ...
        if (this.zze.length < i) {
            int zza3 = zzsi.zza(i, 1.0d);
            this.zze = zzy(zza3);
            this.zzf = zzy(zza3);
            for (int i2 = 0; i2 < this.zzc; i2++) {
                int zzo2 = zzo(zzsi.zzc(this.zza[i2]));
                int[] iArr = this.zzg;
                int[] iArr2 = this.zze;
                iArr[i2] = iArr2[zzo2];
                iArr2[zzo2] = i2;
                int zzo3 = zzo(zzsi.zzc(this.zzb[i2]));
                int[] iArr3 = this.zzh;
                int[] iArr4 = this.zzf;
                iArr3[i2] = iArr4[zzo3];
                iArr4[zzo3] = i2;
