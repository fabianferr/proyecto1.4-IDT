...
public interface Player {
    ...
    public interface EventListener {
        ...
        public final /* synthetic */ class CC {
            public static void $default$onAvailableCommandsChanged(EventListener _this, Commands commands) {
            }
            ...
            public static void $default$onMaxSeekToPreviousPositionChanged(EventListener _this, int i) {
            }

            public static void $default$onMediaItemTransition(EventListener _this, MediaItem mediaItem, int i) {
            }

            public static void $default$onMediaMetadataChanged(EventListener _this, MediaMetadata mediaMetadata) {
            }
            ...
            public static void $default$onPlayerError(EventListener _this, PlaybackException playbackException) {
            }

            public static void $default$onPlayerErrorChanged(EventListener _this, PlaybackException playbackException) {
            }
            ...
            public static void $default$onPlaylistMetadataChanged(EventListener _this, MediaMetadata mediaMetadata) {
            }
            ...
            public static void $default$onPositionDiscontinuity(EventListener _this, PositionInfo positionInfo, PositionInfo positionInfo2, int i) {
            }

            public static void $default$onRepeatModeChanged(EventListener _this, int i) {
            }

            public static void $default$onSeekBackIncrementChanged(EventListener _this, long j) {
            }

            public static void $default$onSeekForwardIncrementChanged(EventListener _this, long j) {
            }
    ...
    public interface Listener extends VideoListener, AudioListener, TextOutput, MetadataOutput, DeviceListener, EventListener {
        ...
        public final /* synthetic */ class CC {
            ...
            public static void $default$onTracksChanged(Listener _this, TrackGroupArray trackGroupArray, TrackSelectionArray trackSelectionArray) {
            }
