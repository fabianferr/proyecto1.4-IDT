...
public final class PlaybackStatsListener implements AnalyticsListener, PlaybackSessionManager.Listener {
    ...
    private Pair<AnalyticsListener.EventTime, Boolean> findBestEventTime(AnalyticsListener.Events events, String str) {
        ...
        if (!z && eventTime.mediaPeriodId != null && eventTime.mediaPeriodId.isAd()) {
            ...
            long usToMs = C.usToMs(positionInWindowUs);
            Timeline timeline2 = eventTime.timeline;
            int i3 = eventTime.currentWindowIndex;
            MediaSource.MediaPeriodId mediaPeriodId2 = eventTime.currentMediaPeriodId;
            MediaSource.MediaPeriodId mediaPeriodId3 = mediaPeriodId2;
            AnalyticsListener.EventTime eventTime3 = new AnalyticsListener.EventTime(j, timeline, i2, mediaPeriodId, usToMs, timeline2, i3, mediaPeriodId3, eventTime.currentPlaybackPositionMs, eventTime.totalBufferedDurationMs);
