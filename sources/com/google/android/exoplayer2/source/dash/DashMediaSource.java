...
public final class DashMediaSource extends BaseMediaSource {
    ...
    public static final class Factory implements MediaSourceFactory {
        ...
        public Factory setDrmSessionManager(DrmSessionManager drmSessionManager) {
            if (drmSessionManager == null) {
                ...
                setDrmSessionManagerProvider((DrmSessionManagerProvider) new DashMediaSource$Factory$$ExternalSyntheticLambda0(drmSessionManager));
            }
            return this;
        }
    ...
    public /* synthetic */ void m2072lambda$new$0$comgoogleandroidexoplayer2sourcedashDashMediaSource() {
    ...
    public void onManifestLoadCompleted(com.google.android.exoplayer2.upstream.ParsingLoadable<com.google.android.exoplayer2.source.dash.manifest.DashManifest> r19, long r20, long r22) {
        ...
        L_0x0070:
            ...
            r13 = 73
            r12.<init>(r13)
            java.lang.String r13 = "Loaded stale dynamic manifest: "
            r12.append(r13)
            r12.append(r8)
            java.lang.String r8 = ", "
            r12.append(r8)
    ...
    private void processManifest(boolean z) {
        ...
        if (this.manifest.dynamic) {
            ...
            long min = Math.min(5000000, j3 / 2);
    ...
    private void updateMediaItemLiveConfiguration(long j, long j2) {
        ...
        if (j4 > j3) {
            j4 = Util.constrainValue(C.usToMs(j - Math.min(5000000, j2 / 2)), j5, j3);
        }
        long j6 = j4;
        ...
        if (this.mediaItem.liveConfiguration.maxPlaybackSpeed != -3.4028235E38f) {
            f3 = this.mediaItem.liveConfiguration.maxPlaybackSpeed;
        } else if (this.manifest.serviceDescription != null) {
            f3 = this.manifest.serviceDescription.maxPlaybackSpeed;
        } else {
            f2 = -3.4028235E38f;
