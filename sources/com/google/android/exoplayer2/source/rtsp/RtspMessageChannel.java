...
import androidx.media3.exoplayer.rtsp.RtspMessageChannel$Sender$$ExternalSyntheticLambda1;
...
final class RtspMessageChannel implements Closeable {
    ...
    private final class Sender implements Closeable {
        ...
        public /* synthetic */ void m2078lambda$send$0$comgoogleandroidexoplayer2sourcertspRtspMessageChannel$Sender(byte[] bArr, List list) {
            try {
