...
final class StyledPlayerControlViewLayoutManager {
    ...
    public StyledPlayerControlViewLayoutManager(final StyledPlayerControlView styledPlayerControlView2) {
        ...
        this.controlsBackground = styledPlayerControlView2.findViewById(R.id.exo_controls_background);
        this.centerControls = (ViewGroup) styledPlayerControlView2.findViewById(R.id.exo_center_controls);
        this.minimalControls = (ViewGroup) styledPlayerControlView2.findViewById(R.id.exo_minimal_controls);
        ViewGroup viewGroup = (ViewGroup) styledPlayerControlView2.findViewById(R.id.exo_bottom_bar);
        this.bottomBar = viewGroup;
        this.timeView = (ViewGroup) styledPlayerControlView2.findViewById(R.id.exo_time);
        View findViewById = styledPlayerControlView2.findViewById(R.id.exo_progress);
        this.timeBar = findViewById;
        this.basicControls = (ViewGroup) styledPlayerControlView2.findViewById(R.id.exo_basic_controls);
        this.extraControls = (ViewGroup) styledPlayerControlView2.findViewById(R.id.exo_extra_controls);
        this.extraControlsScrollView = (ViewGroup) styledPlayerControlView2.findViewById(R.id.exo_extra_controls_scroll_view);
        View findViewById2 = styledPlayerControlView2.findViewById(R.id.exo_overflow_show);
        this.overflowShowButton = findViewById2;
        View findViewById3 = styledPlayerControlView2.findViewById(R.id.exo_overflow_hide);
    ...
    public /* synthetic */ void m2090lambda$new$0$comgoogleandroidexoplayer2uiStyledPlayerControlViewLayoutManager(ValueAnimator valueAnimator) {
    ...
    public /* synthetic */ void m2091lambda$new$1$comgoogleandroidexoplayer2uiStyledPlayerControlViewLayoutManager(ValueAnimator valueAnimator) {
        float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        View view = this.controlsBackground;
        if (view != null) {
            view.setAlpha(floatValue);
    ...
    public /* synthetic */ void m2092lambda$new$2$comgoogleandroidexoplayer2uiStyledPlayerControlViewLayoutManager(ValueAnimator valueAnimator) {
    ...
    public /* synthetic */ void m2093lambda$new$3$comgoogleandroidexoplayer2uiStyledPlayerControlViewLayoutManager(ValueAnimator valueAnimator) {
        animateOverflow(((Float) valueAnimator.getAnimatedValue()).floatValue());
    }
