...
public final class zzbx {
        ...
        while (it.hasNext()) {
            ...
            if (view2 != null) {
                ...
                try {
                    ...
                    try {
                        jSONObject5.put(ViewHierarchyConstants.DIMENSION_WIDTH_KEY, zzaw.zzb().zzb(context2, view2.getMeasuredWidth()));
                        jSONObject5.put(ViewHierarchyConstants.DIMENSION_HEIGHT_KEY, zzaw.zzb().zzb(context2, view2.getMeasuredHeight()));
    ...
    private static JSONObject zzk(Context context, Rect rect) throws JSONException {
        JSONObject jSONObject = new JSONObject();
        jSONObject.put(ViewHierarchyConstants.DIMENSION_WIDTH_KEY, zzaw.zzb().zzb(context, rect.right - rect.left));
        jSONObject.put(ViewHierarchyConstants.DIMENSION_HEIGHT_KEY, zzaw.zzb().zzb(context, rect.bottom - rect.top));
