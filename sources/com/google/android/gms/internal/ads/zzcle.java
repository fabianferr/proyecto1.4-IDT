...
public final class zzcle extends zzclb {
     ...
     */
    /* JADX WARNING: Code restructure failed: missing block: B:162:0x03eb, code lost:
        com.google.android.gms.ads.internal.util.zze.zzk("Preload failed for URL \"" + r9 + "\"", r0);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:167:0x040d, code lost:
    ...
    public final boolean zzq(java.lang.String r30) {
        ...
        L_0x00c7:
            ...
            monitor-enter(r1)
            boolean r2 = r1.contains(r14)     // Catch:{ all -> 0x042c }
            if (r2 == 0) goto L_0x0101
            java.lang.StringBuilder r0 = new java.lang.StringBuilder     // Catch:{ all -> 0x042c }
            r0.<init>()     // Catch:{ all -> 0x042c }
            java.lang.String r2 = "Stream cache already in progress at "
            r0.append(r2)     // Catch:{ all -> 0x042c }
            r0.append(r9)     // Catch:{ all -> 0x042c }
            java.lang.String r0 = r0.toString()     // Catch:{ all -> 0x042c }
            com.google.android.gms.ads.internal.util.zze.zzj(r0)     // Catch:{ all -> 0x042c }
            java.lang.String r0 = r12.getAbsolutePath()     // Catch:{ all -> 0x042c }
            java.lang.String r2 = "inProgress"
            r8.zzc(r9, r0, r2, r11)     // Catch:{ all -> 0x042c }
            monitor-exit(r1)     // Catch:{ all -> 0x042c }
            return r10
        L_0x0101:
            r1.add(r14)     // Catch:{ all -> 0x042c }
            monitor-exit(r1)     // Catch:{ all -> 0x042c }
