...
class zzun extends AbstractMap {
    ...
    /* synthetic */ zzun(int i, zzum zzum) {
        this.zza = i;
    }
    ...
    private final int zzk(Comparable comparable) {
        ...
        while (i <= size) {
            int i2 = (i + size) / 2;
            int compareTo2 = comparable.compareTo(((zzuh) this.zzb.get(i2)).zza());
            if (compareTo2 < 0) {
                size = i2 - 1;
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzuh zzuh = (zzuh) this.zzb.remove(i2 - 1);
