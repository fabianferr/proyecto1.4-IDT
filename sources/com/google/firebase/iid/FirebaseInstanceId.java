    ...
    private class zza {
        ...
        public final synchronized boolean isEnabled() {
            /*
                r1 = this;
                monitor-enter(r1)
                java.lang.Boolean r0 = r1.zzbc     // Catch:{ all -> 0x0021 }
                if (r0 == 0) goto L_0x000b
                boolean r0 = r0.booleanValue()     // Catch:{ all -> 0x0021 }
                monitor-exit(r1)
                return r0
            L_0x000b:
                boolean r0 = r1.zzaz     // Catch:{ all -> 0x0021 }
                if (r0 == 0) goto L_0x001e
                com.google.firebase.iid.FirebaseInstanceId r0 = com.google.firebase.iid.FirebaseInstanceId.this     // Catch:{ all -> 0x0021 }
                com.google.firebase.FirebaseApp r0 = r0.zzam     // Catch:{ all -> 0x0021 }
                boolean r0 = r0.isDataCollectionDefaultEnabled()     // Catch:{ all -> 0x0021 }
                if (r0 == 0) goto L_0x001e
                monitor-exit(r1)
                r0 = 1
                return r0
