...
public class TreeWalker implements a.C0088a {
    ...
    private a f = new a();
    /* access modifiers changed from: private */
    public b g = new b(new com.iab.omid.library.mmadbridge.walking.async.c());
    private long h;
    ...
    private void a(View view, com.iab.omid.library.mmadbridge.processor.a aVar, JSONObject jSONObject, c cVar, boolean z) {
    ...
    public void f() {
        ...
        if (this.f.c().size() > 0) {
            ...
            if (this.c) {
                for (com.iab.omid.library.mmadbridge.adsession.a a5 : com.iab.omid.library.mmadbridge.internal.c.c().a()) {
                    a5.a(this.d);
                }
            }
        } else {
