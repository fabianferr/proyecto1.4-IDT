...
public class TreeWalker implements a.C0091a {
    ...
    private a f = new a();
    /* access modifiers changed from: private */
    public b g = new b(new com.iab.omid.library.vungle.walking.async.c());
    private long h;
    ...
    private void a(View view, com.iab.omid.library.vungle.processor.a aVar, JSONObject jSONObject, c cVar, boolean z) {
    ...
    private boolean b(View view, JSONObject jSONObject) {
        ...
        com.iab.omid.library.vungle.utils.c.a(jSONObject, d2);
    ...
    public void f() {
        ...
        if (this.f.b().size() > 0) {
            ...
            while (it.hasNext()) {
                ...
                com.iab.omid.library.vungle.utils.c.b(a3);
        ...
        if (this.f.c().size() > 0) {
            ...
            com.iab.omid.library.vungle.utils.c.b(a4);
            this.g.b(a4, this.f.c(), b2);
            if (this.c) {
                for (com.iab.omid.library.vungle.adsession.a a5 : com.iab.omid.library.vungle.internal.c.c().a()) {
                    a5.a(this.d);
                }
            }
        } else {
