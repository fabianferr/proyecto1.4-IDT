...
public final class p6 extends TelephonyCallback implements TelephonyCallback.CellInfoListener, TelephonyCallback.CellLocationListener, TelephonyCallback.ServiceStateListener, TelephonyCallback.SignalStrengthsListener, TelephonyCallback.DisplayInfoListener, v2 {
    ...
    public static final class a extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public a(p6 p6Var, List<CellInfo> list, Continuation<? super a> continuation) {
    ...
    public static final class b extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public b(p6 p6Var, CellLocation cellLocation, Continuation<? super b> continuation) {
            super(2, continuation);
            this.b = p6Var;
            this.c = cellLocation;
        }
    ...
    public static final class c extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public c(p6 p6Var, TelephonyDisplayInfo telephonyDisplayInfo, Continuation<? super c> continuation) {
            super(2, continuation);
            this.a = p6Var;
    ...
    public static final class d extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public d(p6 p6Var, ServiceState serviceState, Continuation<? super d> continuation) {
            super(2, continuation);
            this.b = p6Var;
            this.c = serviceState;
        }
    ...
    @DebugMetadata(c = "com.m2catalyst.m2sdk.data_collection.network.TelephonyCallbackMin31$onSignalStrengthsChanged$1", f = "M2PhoneStateListener.kt", i = {}, l = {142}, m = "invokeSuspend", n = {}, s = {})
    /* compiled from: M2PhoneStateListener.kt */
    public static final class e extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public e(p6 p6Var, SignalStrength signalStrength, Continuation<? super e> continuation) {
            super(2, continuation);
            this.b = p6Var;
    ...
    public p6(q3 q3Var, int i, Context context) {
