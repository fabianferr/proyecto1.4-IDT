...
public class a {
    ...
    public final void a(Context context, final String str) {
        if (context != null) {
            String b2 = com.mbridge.msdk.foundation.a.a.a.a().b("MraidJSController");
            if (TextUtils.isEmpty(b2) || !b2.equals(str)) {
                try {
                    new com.mbridge.msdk.c.a.a(context).get(0, str, (d) null, new com.mbridge.msdk.foundation.same.net.c.a() {
                        public final void b(String str) {
                        }

                        public final void a(String str) {
                            if (!TextUtils.isEmpty(str)) {
                                String unused = a.this.c = str;
                                new Thread(new Runnable(str) {
                                    public final void run() {
                                        try {
                                            ...
                                            y.a(r3.getBytes(), file);
                                        } catch (Exception e) {
                                            aa.a("MraidJSController", e.getMessage());
                                        }
                                    }
                                }).start();
                    ...
                    aa.d("MraidJSController", e.getMessage());
                }
            }
        }
    }
    ...
    public final String b() {
        try {
            ...
            if (b2 != null && !TextUtils.isEmpty(b2.az())) {
                a(b.d().g(), b2.az());
            }
            return a;
