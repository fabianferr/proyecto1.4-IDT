...
public class MBExtFeedBackView extends FeedBackButton implements InterBase {
    ...
    public MBExtFeedBackView(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            aa.d("MBExtFeedBackView", e.getMessage());
        }
    }
    ...
    public void setAttributeSet(AttributeSet attributeSet) {
        ...
        for (int i5 = 0; i5 < attributeCount; i5++) {
            com.mbridge.msdk.dycreator.a.c cVar = c2.get(attributeSet.getAttributeName(i5));
            if (cVar != null) {
                ...
                switch (AnonymousClass1.a[cVar.ordinal()]) {
                    ...
                    case 18:
                        ...
                        break;
                    case 19:
                        int b2 = b.a().b(attributeSet.getAttributeValue(i5));
