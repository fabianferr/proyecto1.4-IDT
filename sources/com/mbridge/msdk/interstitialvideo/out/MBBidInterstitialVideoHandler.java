...
public class MBBidInterstitialVideoHandler {
    ...
    private void a(String str, String str2) {
        ...
        try {
            ...
            aa.b("MBBidRewardVideoHandler", th.getMessage(), th);
        }
    }
    ...
    public void loadFromBid(String str) {
        ...
        try {
            ...
            r.a(str, "2000123", this.b, str3, "hb_Interstitial_load", 287);
    ...
    public void setRewardVideoListener(InterstitialVideoListener interstitialVideoListener) {
        a aVar = this.a;
        if (aVar != null) {
            aVar.a((InterVideoOutListener) new com.mbridge.msdk.interstitialvideo.a.a(interstitialVideoListener, this.b, true));
        }
    }
