...
public final class d {
    ...
    private static class a extends BroadcastReceiver {
        ...
        public final void onReceive(Context context, Intent intent) {
            d dVar;
            b b;
            if (SystemMediaRouteProvider.LegacyImpl.VolumeChangeReceiver.VOLUME_CHANGED_ACTION.equals(intent.getAction()) && intent.getIntExtra(SystemMediaRouteProvider.LegacyImpl.VolumeChangeReceiver.EXTRA_VOLUME_STREAM_TYPE, -1) == 3 && (dVar = (d) this.a.get()) != null && (b = dVar.b()) != null) {
                double a2 = dVar.a();
                if (a2 >= 0.0d) {
                    b.a(a2);
                }
