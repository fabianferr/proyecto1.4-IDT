...
public class MBBidNewInterstitialHandler implements BaseExtraInterfaceForHandler {
    ...
    private void a(String str, String str2) {
        ...
        try {
            ...
            aa.b("MBBidNewInterstitialHandler", th.getMessage(), th);
        }
    }
    ...
    public void loadFromBid(String str) {
        ...
        try {
            ...
            r.a(str, "2000123", this.b, str3, "hb_new_Interstitial_load", 287);
        } catch (Exception unused) {
        }
        r.a().a(this.b, "niv", true);
        a aVar = this.a;
        if (aVar != null) {
    ...
    public boolean isBidReady() {
        ...
        if (aVar != null) {
            ...
            if (d) {
                r.a().d(this.b, "niv", true);
            } else {
                r.a().e(this.b, "niv", true);
            }
            return d;
        }
        r.a().e(this.b, "niv", true);
    ...
    public void showFromBid() {
        try {
            ...
            m.a().b("2000128", "hb_new_interstitial_show", this.b, "287", hashMap);
        } catch (Exception unused) {
        }
        r.a().f(this.b, "niv", true);
        a aVar = this.a;
        if (aVar != null) {
    ...
    public void setRewardVideoListener(NewInterstitialListener newInterstitialListener) {
        a aVar = this.a;
        if (aVar != null) {
            aVar.a((InterVideoOutListener) new com.mbridge.msdk.newinterstitial.a.a(newInterstitialListener, this.b, true));
        }
    }
