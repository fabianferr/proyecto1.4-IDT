...
public class MBNewInterstitialHandler implements BaseExtraInterfaceForHandler {
    ...
    public void load() {
        ...
        try {
            ...
            r.a("2000123", this.b, md5, "new_Interstitial_load", 287);
        } catch (Exception unused) {
        }
        r.a().a(this.b, "niv", false);
        a aVar = this.a;
        if (aVar != null) {
    ...
    public boolean isReady() {
        ...
        if (aVar != null) {
            ...
            if (d) {
                r.a().d(this.b, "niv", false);
            } else {
                r.a().e(this.b, "niv", false);
            }
            return d;
        }
        r.a().e(this.b, "niv", false);
    ...
    public void show() {
        try {
            ...
            m.a().b("2000128", "new_interstitial_show", this.b, "287", hashMap);
        } catch (Exception unused) {
        }
        r.a().f(this.b, "niv", false);
        a aVar = this.a;
        if (aVar != null) {
    ...
    public void setRewardVideoListener(NewInterstitialListener newInterstitialListener) {
        a aVar = this.a;
        if (aVar != null) {
            aVar.a((InterVideoOutListener) new com.mbridge.msdk.newinterstitial.a.a(newInterstitialListener, this.b, false));
        }
    }
