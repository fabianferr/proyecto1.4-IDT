    ...
    public TrackSelection[] selectAllTracks(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, int[] iArr2, Parameters parameters) throws ExoPlaybackException {
        ...
        while (true) {
            ...
            if (2 == mappedTrackInfo2.getRendererType(i)) {
                if (!z) {
                    TrackSelection selectVideoTrack = selectVideoTrack(mappedTrackInfo2.getTrackGroups(i), iArr[i], iArr2[i], parameters, this.adaptiveTrackSelectionFactory);
            ...
            if (rendererType != 1) {
                if (rendererType != 2) {
                    if (rendererType != 3) {
                        ...
                        TrackSelection selectTextTrack = selectTextTrack(mappedTrackInfo2.getTrackGroups(i2), iArr[i2], parameters2);
                        trackSelectionArr[i2] = selectTextTrack;
                        z5 = selectTextTrack != null;
                    }
                }
            } else if (!z4) {
                TrackSelection selectAudioTrack = selectAudioTrack(mappedTrackInfo2.getTrackGroups(i2), iArr[i2], iArr2[i2], parameters, z2 ? null : this.adaptiveTrackSelectionFactory);
                trackSelectionArr[i2] = selectAudioTrack;
                z4 = selectAudioTrack != null;
            }
        }
        ...
        for (int i3 = 0; i3 < trackGroupArray2.length; i3++) {
            ...
            for (int i4 = 0; i4 < trackGroup2.length; i4++) {
                if (isSupported(iArr2[i4], parameters2.exceedRendererCapabilitiesIfNecessary)) {
                    ...
                    int i5 = format.selectionFlags & (parameters2.disabledTextTrackSelectionFlags ^ -1);
                    int i6 = 1;
                    boolean z = (i5 & 1) != 0;
                    boolean z2 = (i5 & 2) != 0;
