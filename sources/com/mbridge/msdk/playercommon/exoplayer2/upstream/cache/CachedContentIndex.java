...
class CachedContentIndex {
    ...
    private boolean readFile() {
        /*
            ...
            r0 = 0
            r1 = 0
            java.io.BufferedInputStream r2 = new java.io.BufferedInputStream     // Catch:{ IOException -> 0x00a0, all -> 0x0099 }
            com.mbridge.msdk.playercommon.exoplayer2.util.AtomicFile r3 = r9.atomicFile     // Catch:{ IOException -> 0x00a0, all -> 0x0099 }
            java.io.InputStream r3 = r3.openRead()     // Catch:{ IOException -> 0x00a0, all -> 0x0099 }
            r2.<init>(r3)     // Catch:{ IOException -> 0x00a0, all -> 0x0099 }
            java.io.DataInputStream r3 = new java.io.DataInputStream     // Catch:{ IOException -> 0x00a0, all -> 0x0099 }
            r3.<init>(r2)     // Catch:{ IOException -> 0x00a0, all -> 0x0099 }
