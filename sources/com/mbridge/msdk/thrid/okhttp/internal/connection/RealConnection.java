...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    public void connect(int r17, int r18, int r19, int r20, boolean r21, com.mbridge.msdk.thrid.okhttp.Call r22, com.mbridge.msdk.thrid.okhttp.EventListener r23) {
        ...
        L_0x0083:
            ...
            r12 = r11
        L_0x0085:
            com.mbridge.msdk.thrid.okhttp.Route r0 = r7.route     // Catch:{ IOException -> 0x00f6 }
        ...
        L_0x00ad:
            ...
            com.mbridge.msdk.thrid.okhttp.Route r0 = r7.route     // Catch:{ IOException -> 0x00f2 }
            java.net.InetSocketAddress r0 = r0.socketAddress()     // Catch:{ IOException -> 0x00f2 }
            com.mbridge.msdk.thrid.okhttp.Route r1 = r7.route     // Catch:{ IOException -> 0x00f2 }
            java.net.Proxy r1 = r1.proxy()     // Catch:{ IOException -> 0x00f2 }
            com.mbridge.msdk.thrid.okhttp.Protocol r2 = r7.protocol     // Catch:{ IOException -> 0x00f2 }
        ...
        L_0x00dd:
            ...
            monitor-enter(r1)
            com.mbridge.msdk.thrid.okhttp.internal.http2.Http2Connection r0 = r7.http2Connection     // Catch:{ all -> 0x00ee }
    ...
    private void connectTls(com.mbridge.msdk.thrid.okhttp.internal.connection.ConnectionSpecSelector r8) throws java.io.IOException {
        /*
            ...
            com.mbridge.msdk.thrid.okhttp.HttpUrl r4 = r0.url()     // Catch:{ AssertionError -> 0x012a }
            java.lang.String r4 = r4.host()     // Catch:{ AssertionError -> 0x012a }
            com.mbridge.msdk.thrid.okhttp.HttpUrl r5 = r0.url()     // Catch:{ AssertionError -> 0x012a }
            ...
            com.mbridge.msdk.thrid.okhttp.ConnectionSpec r8 = r8.configureSecureSocket(r1)     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            boolean r3 = r8.supportsTlsExtensions()     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            if (r3 == 0) goto L_0x0041
            com.mbridge.msdk.thrid.okhttp.internal.platform.Platform r3 = com.mbridge.msdk.thrid.okhttp.internal.platform.Platform.get()     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            com.mbridge.msdk.thrid.okhttp.HttpUrl r4 = r0.url()     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
        ...
        L_0x0041:
            ...
            com.mbridge.msdk.thrid.okhttp.Handshake r4 = com.mbridge.msdk.thrid.okhttp.Handshake.get(r3)     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            javax.net.ssl.HostnameVerifier r5 = r0.hostnameVerifier()     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            com.mbridge.msdk.thrid.okhttp.HttpUrl r6 = r0.url()     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            ...
            com.mbridge.msdk.thrid.okhttp.HttpUrl r0 = r0.url()     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            ...
            r4.append(r0)     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            java.lang.String r0 = com.mbridge.msdk.thrid.okhttp.CertificatePinner.pin(r8)     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            r4.append(r0)     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            java.lang.String r0 = "\n    DN: "
            r4.append(r0)     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            ...
            java.lang.String r0 = "\n    subjectAltNames: "
            r4.append(r0)     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            java.util.List r8 = com.mbridge.msdk.thrid.okhttp.internal.tls.OkHostnameVerifier.allSubjectAltNames(r8)     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
        ...
        L_0x00d2:
            com.mbridge.msdk.thrid.okhttp.CertificatePinner r3 = r0.certificatePinner()     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            com.mbridge.msdk.thrid.okhttp.HttpUrl r0 = r0.url()     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            java.lang.String r0 = r0.host()     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            ...
            com.mbridge.msdk.thrid.okhttp.internal.platform.Platform r8 = com.mbridge.msdk.thrid.okhttp.internal.platform.Platform.get()     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
        ...
        L_0x00f3:
            ...
            com.mbridge.msdk.thrid.okio.Source r8 = com.mbridge.msdk.thrid.okio.Okio.source((java.net.Socket) r1)     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            com.mbridge.msdk.thrid.okio.BufferedSource r8 = com.mbridge.msdk.thrid.okio.Okio.buffer((com.mbridge.msdk.thrid.okio.Source) r8)     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            r7.source = r8     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            java.net.Socket r8 = r7.socket     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            com.mbridge.msdk.thrid.okio.Sink r8 = com.mbridge.msdk.thrid.okio.Okio.sink((java.net.Socket) r8)     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            com.mbridge.msdk.thrid.okio.BufferedSink r8 = com.mbridge.msdk.thrid.okio.Okio.buffer((com.mbridge.msdk.thrid.okio.Sink) r8)     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            r7.sink = r8     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            r7.handshake = r4     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            if (r2 == 0) goto L_0x0114
            com.mbridge.msdk.thrid.okhttp.Protocol r8 = com.mbridge.msdk.thrid.okhttp.Protocol.get(r2)     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            goto L_0x0116
        L_0x0114:
            com.mbridge.msdk.thrid.okhttp.Protocol r8 = com.mbridge.msdk.thrid.okhttp.Protocol.HTTP_1_1     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
        L_0x0116:
        ...
        L_0x012a:
            r8 = move-exception
        L_0x012b:
            boolean r0 = com.mbridge.msdk.thrid.okhttp.internal.Util.isAndroidGetsocknameError(r8)     // Catch:{ all -> 0x0128 }
