...
public class g {
    ...
    public static View a(Context context, SplashConfig splashConfig) {
        ...
        Point point = new Point(i0.a(context2, 1, (float) IronSourceConstants.REWARDED_VIDEO_DAILY_CAPPED), i0.a(context2, 1, (float) 28));
        if (splashConfig.getOrientation() == SplashConfig.Orientation.PORTRAIT) {
            i4 = i0.a(context2, 1, (float) 5);
            i3 = i0.a(context2, 1, (float) 8);
            i2 = i0.a(context2, 1, (float) 75);
            i = i0.a(context2, 1, (float) 130);
        } else {
            i4 = i0.a(context2, 1, (float) 5);
            i3 = i0.a(context2, 1, (float) 8);
            i2 = i0.a(context2, 1, (float) 40);
            i = i0.a(context2, 1, (float) 100);
        }
