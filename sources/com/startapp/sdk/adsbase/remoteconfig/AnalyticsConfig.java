...
public class AnalyticsConfig implements Serializable {
    ...
    private List<String> admHeaders = Collections.singletonList(HttpHeaders.SERVER_TIMING);
    ...
    public boolean equals(Object obj) {
        ...
        if (this.dns == analyticsConfig.dns && this.retryNum == analyticsConfig.retryNum && this.retryTime == analyticsConfig.retryTime && Float.compare(this.succeededSmartRedirectInfoProbability, analyticsConfig.succeededSmartRedirectInfoProbability) == 0 && this.sendHopsOnFirstSucceededSmartRedirect == analyticsConfig.sendHopsOnFirstSucceededSmartRedirect && this.sendViewabilityInfo == analyticsConfig.sendViewabilityInfo && Double.compare(this.admPrb, analyticsConfig.admPrb) == 0 && this.fuIef == analyticsConfig.fuIef && k9.a(this.hostSecured, analyticsConfig.hostSecured) && k9.a(this.hostPeriodic, analyticsConfig.hostPeriodic) && k9.a(this.noNetworkTimeout, analyticsConfig.noNetworkTimeout) && k9.a(this.categories, analyticsConfig.categories) && k9.a(this.adCallbacks, analyticsConfig.adCallbacks) && k9.a(this.admHeaders, analyticsConfig.admHeaders) && k9.a(this.scheduledImpressionInfoEvents, analyticsConfig.scheduledImpressionInfoEvents)) {
            return true;
        }
        return false;
    }
