...
public class SensorsConfig implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.timeoutInSec != sensorsConfig.timeoutInSec || this.enabled != sensorsConfig.enabled || this.refreshInterval != sensorsConfig.refreshInterval || !k9.a(this.ambientTemperatureSensor, sensorsConfig.ambientTemperatureSensor) || !k9.a(this.gravitySensor, sensorsConfig.gravitySensor) || !k9.a(this.lightSensor, sensorsConfig.lightSensor) || !k9.a(this.linearAccelerationSensor, sensorsConfig.linearAccelerationSensor) || !k9.a(this.magneticFieldSensor, sensorsConfig.magneticFieldSensor) || !k9.a(this.pressureSensor, sensorsConfig.pressureSensor) || !k9.a(this.relativeHumiditySensor, sensorsConfig.relativeHumiditySensor) || !k9.a(this.rotationVectorSensor, sensorsConfig.rotationVectorSensor) || !k9.a(this.gyroscopeUncalibratedSensor, sensorsConfig.gyroscopeUncalibratedSensor)) {
            return false;
        }
        return true;
    }
