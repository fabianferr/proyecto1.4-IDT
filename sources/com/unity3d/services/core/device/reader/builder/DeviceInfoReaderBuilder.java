...
public class DeviceInfoReaderBuilder {
    ...
    private JsonFlattenerRules getTsiRequestStorageRules() {
        return new JsonFlattenerRules(Arrays.asList(new String[]{ShareConstants.WEB_DIALOG_PARAM_PRIVACY, "gdpr", "framework", "adapter", "mediation", "unity", "pipl", "configuration", "user", JsonStorageKeyNames.UNIFIED_CONFIG_KEY}), Collections.singletonList("value"), Arrays.asList(new String[]{"ts", "exclude", "pii", "nonBehavioral", "nonbehavioral"}));
    }
}
