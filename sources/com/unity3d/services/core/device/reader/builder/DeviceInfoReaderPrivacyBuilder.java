...
public class DeviceInfoReaderPrivacyBuilder extends DeviceInfoReaderBuilder {
    ...
    private JsonFlattenerRules getPrivacyRequestStorageRules() {
        return new JsonFlattenerRules(Arrays.asList(new String[]{ShareConstants.WEB_DIALOG_PARAM_PRIVACY, "gdpr", "unity", "pipl"}), Collections.singletonList("value"), Arrays.asList(new String[]{"ts", "exclude", "mode"}));
    }
}
