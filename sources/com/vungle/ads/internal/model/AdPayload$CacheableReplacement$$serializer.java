...
public final class AdPayload$CacheableReplacement$$serializer implements GeneratedSerializer<AdPayload.CacheableReplacement> {
    ...
    public AdPayload.CacheableReplacement deserialize(Decoder decoder) {
        ...
        return new AdPayload.CacheableReplacement(i, (String) obj2, (String) obj, (SerializationConstructorMarker) null);
    }

    public void serialize(Encoder encoder, AdPayload.CacheableReplacement cacheableReplacement) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(cacheableReplacement, "value");
        SerialDescriptor descriptor2 = getDescriptor();
