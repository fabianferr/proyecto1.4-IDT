...
public final class AdPayload$PlacementAdUnit$$serializer implements GeneratedSerializer<AdPayload.PlacementAdUnit> {
    ...
    public AdPayload.PlacementAdUnit deserialize(Decoder decoder) {
        ...
        if (beginStructure.decodeSequentially()) {
            ...
            obj = beginStructure.decodeNullableSerializableElement(descriptor2, 1, AdPayload$AdUnit$$serializer.INSTANCE, null);
            i = 3;
        } else {
            obj2 = null;
            Object obj3 = null;
        ...
        return new AdPayload.PlacementAdUnit(i, (String) obj2, (AdPayload.AdUnit) obj, (SerializationConstructorMarker) null);
    }

    public void serialize(Encoder encoder, AdPayload.PlacementAdUnit placementAdUnit) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(placementAdUnit, "value");
        SerialDescriptor descriptor2 = getDescriptor();
