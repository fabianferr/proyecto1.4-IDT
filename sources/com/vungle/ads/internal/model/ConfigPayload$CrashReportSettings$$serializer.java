...
public final class ConfigPayload$CrashReportSettings$$serializer implements GeneratedSerializer<ConfigPayload.CrashReportSettings> {
    ...
    public void serialize(Encoder encoder, ConfigPayload.CrashReportSettings crashReportSettings) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(crashReportSettings, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder beginStructure = encoder.beginStructure(descriptor2);
        ConfigPayload.CrashReportSettings.write$Self(crashReportSettings, beginStructure, descriptor2);
        beginStructure.endStructure(descriptor2);
    }
