...
public final class DeviceNode$VungleExt$$serializer implements GeneratedSerializer<DeviceNode.VungleExt> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{BuiltinSerializersKt.getNullable(DeviceNode$AndroidAmazonExt$$serializer.INSTANCE), BuiltinSerializersKt.getNullable(DeviceNode$AndroidAmazonExt$$serializer.INSTANCE)};
    }
    ...
    public DeviceNode.VungleExt deserialize(Decoder decoder) {
        ...
        if (beginStructure.decodeSequentially()) {
            obj2 = beginStructure.decodeNullableSerializableElement(descriptor2, 0, DeviceNode$AndroidAmazonExt$$serializer.INSTANCE, null);
            obj = beginStructure.decodeNullableSerializableElement(descriptor2, 1, DeviceNode$AndroidAmazonExt$$serializer.INSTANCE, null);
            i = 3;
        } else {
            obj2 = null;
            Object obj3 = null;
            ...
            while (z) {
                ...
                if (decodeElementIndex == -1) {
                    ...
                    obj2 = beginStructure.decodeNullableSerializableElement(descriptor2, 0, DeviceNode$AndroidAmazonExt$$serializer.INSTANCE, obj2);
                    i2 |= 1;
                } else if (decodeElementIndex == 1) {
                    obj3 = beginStructure.decodeNullableSerializableElement(descriptor2, 1, DeviceNode$AndroidAmazonExt$$serializer.INSTANCE, obj3);
                    i2 |= 2;
                } else {
    ...
    public void serialize(Encoder encoder, DeviceNode.VungleExt vungleExt) {
        ...
        Intrinsics.checkNotNullParameter(vungleExt, "value");
        SerialDescriptor descriptor2 = getDescriptor();
