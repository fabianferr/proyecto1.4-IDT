...
public class BundleTypeAdapterFactory implements TypeAdapterFactory {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0060:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.wortise.ads.gson.BundleTypeAdapterFactory.a.<clinit>():void");
        }
    }
    ...
    public <T> TypeAdapter<T> create(final Gson gson, TypeToken<T> typeToken) {
        ...
        return new TypeAdapter<Bundle>() {
            private List b(JsonReader jsonReader) throws IOException {
            ...
            private List<Pair<String, Object>> d(JsonReader jsonReader) throws IOException {
                ArrayList arrayList = new ArrayList();
            ...
            private Bundle a(List<Pair<String, Object>> list) throws IOException {
                ...
                for (Pair next : list) {
                    ...
                    if (obj instanceof String) {
                        ...
                        bundle.putParcelable(str, a((List<Pair<String, Object>>) (List) obj));
                    } else {
