...
public final class UMathKt {
    ...
    private static final int m2768minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m2750minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI  reason: not valid java name */
    private static final long m2769mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m2758minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU  reason: not valid java name */
    private static final int m2766maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m2738maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI  reason: not valid java name */
    private static final long m2767maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m2746maxOfeb3DHEI(j, j2);
    }
}
