...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    private final void closeQueue() {
        if (!DebugKt.getASSERTIONS_ENABLED() || isCompleted()) {
            while (true) {
                Object obj = this._queue;
                if (obj == null) {
                    if (UByte$$ExternalSyntheticBackport0.m(_queue$FU, (Object) this, (Object) null, (Object) EventLoop_commonKt.CLOSED_EMPTY)) {
                        return;
                    }
                    ...
                    if (obj != null) {
                        ...
                        if (UByte$$ExternalSyntheticBackport0.m(_queue$FU, (Object) this, obj, (Object) lockFreeTaskQueueCore)) {
                            return;
                        }
                    } else {
    ...
    private final int scheduleImpl(long j, DelayedTask delayedTask) {
        ...
        if (delayedTaskQueue == null) {
            ...
            UByte$$ExternalSyntheticBackport0.m(_delayed$FU, (Object) this, (Object) null, (Object) new DelayedTaskQueue(j));
    ...
    private final boolean enqueueImpl(Runnable runnable) {
        while (true) {
            ...
            if (obj == null) {
                if (UByte$$ExternalSyntheticBackport0.m(_queue$FU, (Object) this, (Object) null, (Object) runnable)) {
                    return true;
                }
            } else if (obj instanceof LockFreeTaskQueueCore) {
                if (obj != null) {
                    ...
                    if (addLast == 1) {
                        UByte$$ExternalSyntheticBackport0.m(_queue$FU, (Object) this, obj, (Object) lockFreeTaskQueueCore.next());
                    } else if (addLast == 2) {
                        return false;
                    }
                } else {
                ...
                if (obj != null) {
                    ...
                    if (UByte$$ExternalSyntheticBackport0.m(_queue$FU, (Object) this, obj, (Object) lockFreeTaskQueueCore2)) {
                        return true;
                    }
                } else {
                    throw new NullPointerException("null cannot be cast to non-null type java.lang.Runnable{ kotlinx.coroutines.RunnableKt.Runnable }");
    ...
    private final Runnable dequeue() {
        while (true) {
            ...
            if (obj instanceof LockFreeTaskQueueCore) {
                ...
                if (UByte$$ExternalSyntheticBackport0.m(_queue$FU, (Object) this, obj, (Object) null)) {
                    if (obj != null) {
                        return (Runnable) obj;
                    }
                    throw new NullPointerException("null cannot be cast to non-null type java.lang.Runnable{ kotlinx.coroutines.RunnableKt.Runnable }");
