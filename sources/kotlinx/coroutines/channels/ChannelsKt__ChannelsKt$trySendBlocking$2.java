...
final class ChannelsKt__ChannelsKt$trySendBlocking$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (Result.m2351isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m2912successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m2910closedJP2dKIU(Result.m2347exceptionOrNullimpl(obj2));
        }
        return ChannelResult.m2897boximpl(obj3);
    }
}
