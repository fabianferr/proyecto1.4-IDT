...
final class StateFlowSlot extends AbstractSharedFlowSlot<StateFlowImpl<?>> {
        ...
        while (true) {
            ...
            if (obj != null && obj != StateFlowKt.PENDING) {
                if (obj == StateFlowKt.NONE) {
                    if (UByte$$ExternalSyntheticBackport0.m(_state$FU, (Object) this, obj, (Object) StateFlowKt.PENDING)) {
                        return;
                    }
                } else if (UByte$$ExternalSyntheticBackport0.m(_state$FU, (Object) this, obj, (Object) StateFlowKt.NONE)) {
                    Result.Companion companion = Result.Companion;
                    ((CancellableContinuationImpl) obj).resumeWith(Result.m2344constructorimpl(Unit.INSTANCE));
                    return;
                }
            } else {
                return;
    ...
    public final Object awaitPending(Continuation<? super Unit> continuation) {
        ...
        if (!DebugKt.getASSERTIONS_ENABLED() || (!(this._state instanceof CancellableContinuationImpl))) {
            if (!UByte$$ExternalSyntheticBackport0.m(_state$FU, (Object) this, (Object) StateFlowKt.NONE, (Object) cancellableContinuation)) {
