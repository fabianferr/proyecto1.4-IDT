...
public final class WorkQueue {
    ...
    public final long tryStealBlockingFrom(WorkQueue workQueue) {
        ...
        for (int i2 = workQueue.consumerIndex; i2 != i; i2++) {
            ...
            if (task != null) {
                if ((task.taskContext.getTaskMode() == 1) && UByte$$ExternalSyntheticBackport0.m((AtomicReferenceArray) atomicReferenceArray, i3, (Object) task, (Object) null)) {
    ...
    private final long tryStealLastScheduled(WorkQueue workQueue, boolean z) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m(lastScheduledTask$FU, (Object) workQueue, (Object) task, (Object) null));
        add$default(this, task, false, 2, (Object) null);
        return -1;
    }
