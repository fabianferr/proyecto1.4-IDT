...
public final class SelectBuilderImpl<R> extends LockFreeLinkedListHead implements SelectBuilder<R>, SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
        ...
        if (!DebugKt.getASSERTIONS_ENABLED() || isSelected()) {
            while (true) {
                ...
                if (obj == SelectKt.UNDECIDED) {
                    if (UByte$$ExternalSyntheticBackport0.m(_result$FU, (Object) this, SelectKt.UNDECIDED, (Object) function0.invoke())) {
                        return;
                    }
                } else if (obj != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    throw new IllegalStateException("Already resumed");
                } else if (UByte$$ExternalSyntheticBackport0.m(_result$FU, (Object) this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.RESUMED)) {
                    function02.invoke();
                    return;
                }
            }
    ...
    public final Object getResult() {
        ...
        Object obj = this._result;
        if (obj == SelectKt.UNDECIDED) {
            if (UByte$$ExternalSyntheticBackport0.m(_result$FU, (Object) this, SelectKt.UNDECIDED, IntrinsicsKt.getCOROUTINE_SUSPENDED())) {
    ...
    public final void handleBuilderException(Throwable th) {
        if (trySelect()) {
            ...
            resumeWith(Result.m2344constructorimpl(ResultKt.createFailure(th)));
    ...
    private static final class PairSelectOp extends OpDescriptor {
        ...
        public Object perform(Object obj) {
            if (obj != null) {
                ...
                UByte$$ExternalSyntheticBackport0.m(SelectBuilderImpl._state$FU, (Object) selectBuilderImpl, (Object) this, decide == null ? this.otherOp.desc : SelectKt.getNOT_SELECTED());
                return decide;
            }
    ...
    private static final class AtomicSelectOp extends AtomicOp<Object> {
        ...
        private final Object prepareSelectOp() {
            ...
            while (true) {
                ...
                if (obj instanceof OpDescriptor) {
                    ...
                    if (UByte$$ExternalSyntheticBackport0.m(SelectBuilderImpl._state$FU, (Object) this.impl, SelectKt.getNOT_SELECTED(), (Object) this)) {
                        return null;
                    }
                }
            }
        ...
        private final void undoPrepare() {
            UByte$$ExternalSyntheticBackport0.m(SelectBuilderImpl._state$FU, (Object) this.impl, (Object) this, SelectKt.getNOT_SELECTED());
        }

        private final void completeSelect(Object obj) {
            boolean z = obj == null;
            if (UByte$$ExternalSyntheticBackport0.m(SelectBuilderImpl._state$FU, (Object) this.impl, (Object) this, z ? null : SelectKt.getNOT_SELECTED()) && z) {
        ...
        if (!DebugKt.getASSERTIONS_ENABLED() || isSelected()) {
            while (true) {
                ...
                if (obj2 == SelectKt.UNDECIDED) {
                    if (UByte$$ExternalSyntheticBackport0.m(_result$FU, (Object) this, SelectKt.UNDECIDED, CompletionStateKt.toState$default(obj, (Function1) null, 1, (Object) null))) {
                        return;
                    }
                    ...
                    if (Result.m2350isFailureimpl(obj)) {
                        Continuation<R> continuation = this.uCont;
                        Throwable r4 = Result.m2347exceptionOrNullimpl(obj);
                        Intrinsics.checkNotNull(r4);
                        Result.Companion companion = Result.Companion;
                        if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                            r4 = StackTraceRecoveryKt.recoverFromStackFrame(r4, (CoroutineStackFrame) continuation);
                        }
                        continuation.resumeWith(Result.m2344constructorimpl(ResultKt.createFailure(r4)));
                        return;
                    }
        ...
        if (!DebugKt.getASSERTIONS_ENABLED() || isSelected()) {
            while (true) {
                ...
                if (obj == SelectKt.UNDECIDED) {
                    ...
                    Result.Companion companion = Result.Companion;
                    intercepted.resumeWith(Result.m2344constructorimpl(ResultKt.createFailure(th)));
                    return;
                }
            }
        } else {
    ...
    public Object trySelectOther(LockFreeLinkedListNode.PrepareOp prepareOp) {
        while (true) {
            ...
            if (obj == SelectKt.getNOT_SELECTED()) {
                if (prepareOp == null) {
                    if (UByte$$ExternalSyntheticBackport0.m(_state$FU, (Object) this, SelectKt.getNOT_SELECTED(), (Object) null)) {
                        break;
                    }
                } else {
                    PairSelectOp pairSelectOp = new PairSelectOp(prepareOp);
                    if (UByte$$ExternalSyntheticBackport0.m(_state$FU, (Object) this, SelectKt.getNOT_SELECTED(), (Object) pairSelectOp)) {
