...
final class SemaphoreImpl implements Semaphore {
    ...
    public final boolean addAcquireToQueue(CancellableContinuation<? super Unit> cancellableContinuation) {
        ...
        do {
            ...
            while (true) {
                if (segment.getId() >= access$getSEGMENT_SIZE$p && !segment.getRemoved()) {
                    obj = SegmentOrClosed.m2935constructorimpl(segment);
                    break;
                }
                Object access$getNextOrClosed = segment.getNextOrClosed();
                if (access$getNextOrClosed == ConcurrentLinkedListKt.CLOSED) {
                    obj = SegmentOrClosed.m2935constructorimpl(ConcurrentLinkedListKt.CLOSED);
                    break;
                }
            ...
            z = true;
            if (SegmentOrClosed.m2940isClosedimpl(obj)) {
                break;
            }
            Segment r8 = SegmentOrClosed.m2938getSegmentimpl(obj);
            while (true) {
                ...
                if (segment3.getId() >= r8.getId()) {
                    ...
                    continue;
                    break;
                } else if (UByte$$ExternalSyntheticBackport0.m(tail$FU, (Object) this, (Object) segment3, (Object) r8)) {
        ...
        SemaphoreSegment semaphoreSegment2 = (SemaphoreSegment) SegmentOrClosed.m2938getSegmentimpl(obj);
        int access$getSEGMENT_SIZE$p2 = (int) (andIncrement % ((long) SemaphoreKt.SEGMENT_SIZE));
        if (UByte$$ExternalSyntheticBackport0.m(semaphoreSegment2.acquirers, access$getSEGMENT_SIZE$p2, (Object) null, (Object) cancellableContinuation2)) {
        ...
        if (UByte$$ExternalSyntheticBackport0.m(semaphoreSegment2.acquirers, access$getSEGMENT_SIZE$p2, (Object) SemaphoreKt.PERMIT, (Object) SemaphoreKt.TAKEN)) {
    ...
    private final boolean tryResumeNextFromQueue() {
        ...
        L_0x0014:
            ...
            goto L_0x0028
        L_0x0023:
            java.lang.Object r5 = kotlinx.coroutines.internal.SegmentOrClosed.m2935constructorimpl(r5)
            goto L_0x003d
        L_0x0028:
            r6 = r5
            ...
            java.lang.Object r5 = kotlinx.coroutines.internal.SegmentOrClosed.m2935constructorimpl(r5)
        L_0x003d:
            boolean r6 = kotlinx.coroutines.internal.SegmentOrClosed.m2940isClosedimpl(r5)
            r7 = 0
            r8 = 1
            if (r6 != 0) goto L_0x0082
            kotlinx.coroutines.internal.Segment r6 = kotlinx.coroutines.internal.SegmentOrClosed.m2938getSegmentimpl(r5)
        L_0x0049:
        ...
        L_0x0063:
            ...
            boolean r10 = kotlin.UByte$$ExternalSyntheticBackport0.m((java.util.concurrent.atomic.AtomicReferenceFieldUpdater) r10, (java.lang.Object) r15, (java.lang.Object) r9, (java.lang.Object) r6)
        ...
        L_0x0078:
            ...
            goto L_0x0049
        L_0x0082:
            kotlinx.coroutines.internal.Segment r0 = kotlinx.coroutines.internal.SegmentOrClosed.m2938getSegmentimpl(r5)
            kotlinx.coroutines.sync.SemaphoreSegment r0 = (kotlinx.coroutines.sync.SemaphoreSegment) r0
            r0.cleanPrev()
            long r5 = r0.getId()
        ...
        L_0x00bd:
            ...
            boolean r0 = kotlin.UByte$$ExternalSyntheticBackport0.m((java.util.concurrent.atomic.AtomicReferenceArray) r0, (int) r2, (java.lang.Object) r1, (java.lang.Object) r3)
            r0 = r0 ^ r8
            return r0
        L_0x00cd:
