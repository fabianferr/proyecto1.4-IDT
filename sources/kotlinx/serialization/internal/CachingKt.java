...
public final class CachingKt {
    ...
    static {
        ...
        try {
            ...
            z = Result.m2344constructorimpl(Class.forName("java.lang.ClassValue"));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            z = Result.m2344constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m2351isSuccessimpl(z)) {
            Result.Companion companion3 = Result.Companion;
            Class cls = (Class) z;
            z = true;
        }
        Object r0 = Result.m2344constructorimpl(z);
        if (Result.m2350isFailureimpl(r0)) {
            r0 = false;
        }
