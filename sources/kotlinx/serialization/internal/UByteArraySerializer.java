...
public final class UByteArraySerializer extends PrimitiveArraySerializer<UByte, UByteArray, UByteArrayBuilder> implements KSerializer<UByteArray> {
    ...
    public /* bridge */ /* synthetic */ int collectionSize(Object obj) {
        return m2957collectionSizeGBYM_sE(((UByteArray) obj).m2429unboximpl());
    }

    public /* bridge */ /* synthetic */ Object empty() {
        return UByteArray.m2413boximpl(m2958emptyTcUX1vc());
    }

    public /* bridge */ /* synthetic */ Object toBuilder(Object obj) {
        return m2959toBuilderGBYM_sE(((UByteArray) obj).m2429unboximpl());
    }

    public /* bridge */ /* synthetic */ void writeContent(CompositeEncoder compositeEncoder, Object obj, int i) {
        m2960writeContentCoi6ktg(compositeEncoder, ((UByteArray) obj).m2429unboximpl(), i);
    }
    ...
    public int m2957collectionSizeGBYM_sE(byte[] bArr) {
        Intrinsics.checkNotNullParameter(bArr, "$this$collectionSize");
        return UByteArray.m2421getSizeimpl(bArr);
    }

    /* access modifiers changed from: protected */
    /* renamed from: toBuilder-GBYM_sE  reason: not valid java name */
    public UByteArrayBuilder m2959toBuilderGBYM_sE(byte[] bArr) {
    ...
    public byte[] m2958emptyTcUX1vc() {
        return UByteArray.m2414constructorimpl(0);
    }
    ...
    public void readElement(CompositeDecoder compositeDecoder, int i, UByteArrayBuilder uByteArrayBuilder, boolean z) {
        ...
        uByteArrayBuilder.m2955append7apg3OU$kotlinx_serialization_core(UByte.m2362constructorimpl(compositeDecoder.decodeInlineElement(getDescriptor(), i).decodeByte()));
    }

    /* access modifiers changed from: protected */
    /* renamed from: writeContent-Coi6ktg  reason: not valid java name */
    public void m2960writeContentCoi6ktg(CompositeEncoder compositeEncoder, byte[] bArr, int i) {
        Intrinsics.checkNotNullParameter(compositeEncoder, "encoder");
        Intrinsics.checkNotNullParameter(bArr, "content");
        for (int i2 = 0; i2 < i; i2++) {
            compositeEncoder.encodeInlineElement(getDescriptor(), i2).encodeByte(UByteArray.m2420getw2LRezQ(bArr, i2));
        }
    }
}
