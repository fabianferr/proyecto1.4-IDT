...
public final class JsonStreamsKt {
    ...
    public static final <T> T decodeByReader(Json json, DeserializationStrategy<T> deserializationStrategy, SerialReader serialReader) {
        Intrinsics.checkNotNullParameter(json, "<this>");
    ...
    public static final <T> Sequence<T> decodeToSequenceByReader(Json json, SerialReader serialReader, DeserializationStrategy<T> deserializationStrategy, DecodeSequenceMode decodeSequenceMode) {
        Intrinsics.checkNotNullParameter(json, "<this>");
        Intrinsics.checkNotNullParameter(serialReader, "reader");
        Intrinsics.checkNotNullParameter(deserializationStrategy, "deserializer");
        Intrinsics.checkNotNullParameter(decodeSequenceMode, "format");
        return SequencesKt.constrainOnce(new JsonStreamsKt$decodeToSequenceByReader$$inlined$Sequence$1(JsonIteratorKt.JsonIterator(decodeSequenceMode, json, new ReaderJsonLexer(serialReader, (char[]) null, 2, (DefaultConstructorMarker) null), deserializationStrategy)));
    }
