...
public final class Cache implements Closeable, Flushable {
    ...
    public final File m1264deprecated_directory() {
        return this.cache.getDirectory();
    }
    ...
    private static final class Entry {
        ...
        private final boolean isHttps() {
            return Intrinsics.areEqual((Object) this.url.scheme(), (Object) ProxyConfig.MATCH_HTTPS);
        }
        ...
        public Entry(okio.Source r10) throws java.io.IOException {
            /*
                ...
                r1 = r0
                okio.Source r1 = (okio.Source) r1     // Catch:{ all -> 0x0126 }
                okio.BufferedSource r10 = okio.Okio.buffer((okio.Source) r10)     // Catch:{ all -> 0x0126 }
                java.lang.String r1 = r10.readUtf8LineStrict()     // Catch:{ all -> 0x0126 }
                okhttp3.HttpUrl$Companion r2 = okhttp3.HttpUrl.Companion     // Catch:{ all -> 0x0126 }
                okhttp3.HttpUrl r2 = r2.parse(r1)     // Catch:{ all -> 0x0126 }
                if (r2 == 0) goto L_0x0109
                r9.url = r2     // Catch:{ all -> 0x0126 }
                java.lang.String r1 = r10.readUtf8LineStrict()     // Catch:{ all -> 0x0126 }
                r9.requestMethod = r1     // Catch:{ all -> 0x0126 }
                okhttp3.Headers$Builder r1 = new okhttp3.Headers$Builder     // Catch:{ all -> 0x0126 }
                r1.<init>()     // Catch:{ all -> 0x0126 }
                okhttp3.Cache$Companion r2 = okhttp3.Cache.Companion     // Catch:{ all -> 0x0126 }
                int r2 = r2.readInt$okhttp(r10)     // Catch:{ all -> 0x0126 }
                r3 = 0
                r4 = 0
            L_0x0033:
                if (r4 >= r2) goto L_0x003f
                int r4 = r4 + 1
                java.lang.String r5 = r10.readUtf8LineStrict()     // Catch:{ all -> 0x0126 }
                r1.addLenient$okhttp(r5)     // Catch:{ all -> 0x0126 }
                goto L_0x0033
            L_0x003f:
                okhttp3.Headers r1 = r1.build()     // Catch:{ all -> 0x0126 }
                r9.varyHeaders = r1     // Catch:{ all -> 0x0126 }
                okhttp3.internal.http.StatusLine$Companion r1 = okhttp3.internal.http.StatusLine.Companion     // Catch:{ all -> 0x0126 }
                java.lang.String r2 = r10.readUtf8LineStrict()     // Catch:{ all -> 0x0126 }
                okhttp3.internal.http.StatusLine r1 = r1.parse(r2)     // Catch:{ all -> 0x0126 }
                okhttp3.Protocol r2 = r1.protocol     // Catch:{ all -> 0x0126 }
                r9.protocol = r2     // Catch:{ all -> 0x0126 }
                int r2 = r1.code     // Catch:{ all -> 0x0126 }
                r9.code = r2     // Catch:{ all -> 0x0126 }
                java.lang.String r1 = r1.message     // Catch:{ all -> 0x0126 }
                r9.message = r1     // Catch:{ all -> 0x0126 }
                okhttp3.Headers$Builder r1 = new okhttp3.Headers$Builder     // Catch:{ all -> 0x0126 }
                r1.<init>()     // Catch:{ all -> 0x0126 }
                okhttp3.Cache$Companion r2 = okhttp3.Cache.Companion     // Catch:{ all -> 0x0126 }
                int r2 = r2.readInt$okhttp(r10)     // Catch:{ all -> 0x0126 }
            ...
            L_0x0067:
                ...
                goto L_0x0067
            L_0x0073:
                java.lang.String r2 = SENT_MILLIS     // Catch:{ all -> 0x0126 }
                java.lang.String r4 = r1.get(r2)     // Catch:{ all -> 0x0126 }
                java.lang.String r5 = RECEIVED_MILLIS     // Catch:{ all -> 0x0126 }
                java.lang.String r6 = r1.get(r5)     // Catch:{ all -> 0x0126 }
                r1.removeAll(r2)     // Catch:{ all -> 0x0126 }
                r1.removeAll(r5)     // Catch:{ all -> 0x0126 }
                r7 = 0
                if (r4 != 0) goto L_0x008b
                r4 = r7
                goto L_0x008f
            L_0x008b:
                long r4 = java.lang.Long.parseLong(r4)     // Catch:{ all -> 0x0126 }
            L_0x008f:
                r9.sentRequestMillis = r4     // Catch:{ all -> 0x0126 }
                if (r6 != 0) goto L_0x0094
                goto L_0x0098
            L_0x0094:
                long r7 = java.lang.Long.parseLong(r6)     // Catch:{ all -> 0x0126 }
            L_0x0098:
                r9.receivedResponseMillis = r7     // Catch:{ all -> 0x0126 }
                okhttp3.Headers r1 = r1.build()     // Catch:{ all -> 0x0126 }
                r9.responseHeaders = r1     // Catch:{ all -> 0x0126 }
                boolean r1 = r9.isHttps()     // Catch:{ all -> 0x0126 }
                r2 = 0
                if (r1 == 0) goto L_0x0101
                java.lang.String r1 = r10.readUtf8LineStrict()     // Catch:{ all -> 0x0126 }
                r4 = r1
                java.lang.CharSequence r4 = (java.lang.CharSequence) r4     // Catch:{ all -> 0x0126 }
                int r4 = r4.length()     // Catch:{ all -> 0x0126 }
                if (r4 <= 0) goto L_0x00b5
                r3 = 1
            L_0x00b5:
                if (r3 != 0) goto L_0x00e5
                java.lang.String r1 = r10.readUtf8LineStrict()     // Catch:{ all -> 0x0126 }
                okhttp3.CipherSuite$Companion r3 = okhttp3.CipherSuite.Companion     // Catch:{ all -> 0x0126 }
                okhttp3.CipherSuite r1 = r3.forJavaName(r1)     // Catch:{ all -> 0x0126 }
                java.util.List r3 = r9.readCertificateList(r10)     // Catch:{ all -> 0x0126 }
                java.util.List r4 = r9.readCertificateList(r10)     // Catch:{ all -> 0x0126 }
                boolean r5 = r10.exhausted()     // Catch:{ all -> 0x0126 }
                if (r5 != 0) goto L_0x00da
                okhttp3.TlsVersion$Companion r5 = okhttp3.TlsVersion.Companion     // Catch:{ all -> 0x0126 }
                java.lang.String r10 = r10.readUtf8LineStrict()     // Catch:{ all -> 0x0126 }
                okhttp3.TlsVersion r10 = r5.forJavaName(r10)     // Catch:{ all -> 0x0126 }
                goto L_0x00dc
            L_0x00da:
                okhttp3.TlsVersion r10 = okhttp3.TlsVersion.SSL_3_0     // Catch:{ all -> 0x0126 }
            L_0x00dc:
                okhttp3.Handshake$Companion r5 = okhttp3.Handshake.Companion     // Catch:{ all -> 0x0126 }
                okhttp3.Handshake r10 = r5.get(r10, r1, r3, r4)     // Catch:{ all -> 0x0126 }
                r9.handshake = r10     // Catch:{ all -> 0x0126 }
                goto L_0x0103
            L_0x00e5:
                java.io.IOException r10 = new java.io.IOException     // Catch:{ all -> 0x0126 }
                ...
                r1 = 34
                r2.append(r1)     // Catch:{ all -> 0x0126 }
                java.lang.String r1 = r2.toString()     // Catch:{ all -> 0x0126 }
                r10.<init>(r1)     // Catch:{ all -> 0x0126 }
                throw r10     // Catch:{ all -> 0x0126 }
            L_0x0101:
                r9.handshake = r2     // Catch:{ all -> 0x0126 }
            L_0x0103:
                kotlin.Unit r10 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0126 }
                kotlin.io.CloseableKt.closeFinally(r0, r2)
                return
            L_0x0109:
                java.io.IOException r10 = new java.io.IOException     // Catch:{ all -> 0x0126 }
                java.lang.String r2 = "Cache corruption for "
                java.lang.String r1 = kotlin.jvm.internal.Intrinsics.stringPlus(r2, r1)     // Catch:{ all -> 0x0126 }
                r10.<init>(r1)     // Catch:{ all -> 0x0126 }
                okhttp3.internal.platform.Platform$Companion r1 = okhttp3.internal.platform.Platform.Companion     // Catch:{ all -> 0x0126 }
                okhttp3.internal.platform.Platform r1 = r1.get()     // Catch:{ all -> 0x0126 }
                java.lang.String r2 = "cache corruption"
                r3 = r10
                java.lang.Throwable r3 = (java.lang.Throwable) r3     // Catch:{ all -> 0x0126 }
                r4 = 5
                r1.log(r2, r4, r3)     // Catch:{ all -> 0x0126 }
                java.lang.Throwable r10 = (java.lang.Throwable) r10     // Catch:{ all -> 0x0126 }
                throw r10     // Catch:{ all -> 0x0126 }
            L_0x0126:
                r10 = move-exception
