    ...
    public final class RelaySource implements Source {
        ...
        public long read(okio.Buffer r20, long r21) throws java.io.IOException {
            ...
            L_0x0018:
                ...
                long r6 = r8.getUpstreamPos()     // Catch:{ all -> 0x0172 }
                okio.Buffer r4 = r8.getBuffer()     // Catch:{ all -> 0x0172 }
                long r9 = r4.size()     // Catch:{ all -> 0x0172 }
                long r6 = r6 - r9
                long r9 = r1.sourcePos     // Catch:{ all -> 0x0172 }
                ...
                goto L_0x0076
            L_0x003a:
                long r9 = r8.getUpstreamPos()     // Catch:{ all -> 0x0172 }
                long r11 = r1.sourcePos     // Catch:{ all -> 0x0172 }
                long r9 = r9 - r11
                long r9 = java.lang.Math.min(r2, r9)     // Catch:{ all -> 0x0172 }
                ...
                return r9
            L_0x005b:
                boolean r6 = r8.getComplete()     // Catch:{ all -> 0x0172 }
                if (r6 == 0) goto L_0x0063
                monitor-exit(r8)
                return r11
            L_0x0063:
                java.lang.Thread r6 = r8.getUpstreamReader()     // Catch:{ all -> 0x0172 }
                if (r6 == 0) goto L_0x006f
                okio.Timeout r0 = r1.timeout     // Catch:{ all -> 0x0172 }
                r0.waitUntilNotified(r8)     // Catch:{ all -> 0x0172 }
                goto L_0x0018
            L_0x006f:
                java.lang.Thread r6 = java.lang.Thread.currentThread()     // Catch:{ all -> 0x0172 }
                r8.setUpstreamReader(r6)     // Catch:{ all -> 0x0172 }
            L_0x0076:
                monitor-exit(r8)
                r8 = 32
            ...
            L_0x009c:
                ...
                monitor-enter(r2)
                r2.setUpstreamReader(r10)     // Catch:{ all -> 0x00d3 }
                r0 = r2
            ...
            L_0x00d3:
                ...
                throw r0
            L_0x00d6:
                long r11 = java.lang.Math.min(r14, r2)     // Catch:{ all -> 0x015e }
                okhttp3.internal.cache2.Relay r0 = r1.this$0     // Catch:{ all -> 0x015e }
                ...
                long r8 = r2.getBufferMaxSize()     // Catch:{ all -> 0x015b }
            ...
            L_0x013d:
                ...
                okhttp3.internal.cache2.Relay r2 = r1.this$0
                monitor-enter(r2)
                r2.setUpstreamReader(r10)     // Catch:{ all -> 0x0158 }
                r0 = r2
            ...
            L_0x015e:
                ...
                okhttp3.internal.cache2.Relay r2 = r1.this$0
                monitor-enter(r2)
                r2.setUpstreamReader(r10)     // Catch:{ all -> 0x016f }
                r3 = r2
