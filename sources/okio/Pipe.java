...
public final class Pipe {
    ...
    public final void fold(okio.Sink r8) throws java.io.IOException {
        ...
        L_0x0006:
            ...
            monitor-enter(r0)
            okio.Sink r1 = r7.getFoldedSink$okio()     // Catch:{ all -> 0x0093 }
            r2 = 1
        ...
        L_0x0013:
            ...
            boolean r1 = r7.getCanceled$okio()     // Catch:{ all -> 0x0093 }
            if (r1 != 0) goto L_0x0079
            okio.Buffer r1 = r7.getBuffer$okio()     // Catch:{ all -> 0x0093 }
            boolean r1 = r1.exhausted()     // Catch:{ all -> 0x0093 }
            if (r1 == 0) goto L_0x002d
            r7.setSourceClosed$okio(r2)     // Catch:{ all -> 0x0093 }
            r7.setFoldedSink$okio(r8)     // Catch:{ all -> 0x0093 }
            monitor-exit(r0)
            return
        L_0x002d:
            boolean r1 = r7.getSinkClosed$okio()     // Catch:{ all -> 0x0093 }
            okio.Buffer r3 = new okio.Buffer     // Catch:{ all -> 0x0093 }
            r3.<init>()     // Catch:{ all -> 0x0093 }
            okio.Buffer r4 = r7.getBuffer$okio()     // Catch:{ all -> 0x0093 }
            okio.Buffer r5 = r7.getBuffer$okio()     // Catch:{ all -> 0x0093 }
            ...
            monitor-exit(r0)
            long r4 = r3.size()     // Catch:{ all -> 0x0062 }
            r8.write(r3, r4)     // Catch:{ all -> 0x0062 }
            if (r1 == 0) goto L_0x005e
            r8.close()     // Catch:{ all -> 0x0062 }
            goto L_0x0006
        L_0x005e:
            r8.flush()     // Catch:{ all -> 0x0062 }
            goto L_0x0006
        L_0x0062:
            r8 = move-exception
            okio.Buffer r0 = r7.buffer
            monitor-enter(r0)
            r7.setSourceClosed$okio(r2)     // Catch:{ all -> 0x0076 }
            okio.Buffer r1 = r7.getBuffer$okio()     // Catch:{ all -> 0x0076 }
            java.lang.Object r1 = (java.lang.Object) r1     // Catch:{ all -> 0x0076 }
            r1.notifyAll()     // Catch:{ all -> 0x0076 }
            kotlin.Unit r1 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0076 }
            monitor-exit(r0)
            throw r8
        L_0x0076:
            r8 = move-exception
    ...
    public final Sink m1403deprecated_sink() {
        return this.sink;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "source", imports = {}))
    /* renamed from: -deprecated_source  reason: not valid java name */
    public final Source m1404deprecated_source() {
        return this.source;
    }
