...
public final class ResourceFileSystem extends FileSystem {
    ...
    private static final class Companion {
        ...
        public final Path removeBase(Path path, Path path2) {
            ...
            return getROOT().resolve(StringsKt.replace$default(StringsKt.removePrefix(path.toString(), (CharSequence) path2.toString()), (char) AbstractJsonLexerKt.STRING_ESC, '/', false, 4, (Object) null));
        }
