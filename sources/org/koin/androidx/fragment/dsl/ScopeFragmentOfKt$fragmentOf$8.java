...
public final class ScopeFragmentOfKt$fragmentOf$8 extends Lambda implements Function2<Scope, ParametersHolder, R> {
    final /* synthetic */ Function3<T1, T2, T3, R> $constructor;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ScopeFragmentOfKt$fragmentOf$8(Function3<? super T1, ? super T2, ? super T3, ? extends R> function3) {
        super(2);
