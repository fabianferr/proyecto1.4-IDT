...
public final class FragmentVMKt$viewModel$2 extends Lambda implements Function0<ViewModelProvider.Factory> {
    ...
    public FragmentVMKt$viewModel$2(Function0<? extends ViewModelStoreOwner> function0, Qualifier qualifier, Function0<? extends ParametersHolder> function02, Scope scope) {
        super(0);
    ...
    public final ViewModelProvider.Factory invoke() {
        ...
        return GetViewModelFactoryKt.getViewModelFactory(this.$owner.invoke(), Reflection.getOrCreateKotlinClass(ViewModel.class), qualifier, function0, (Function0<Bundle>) null, scope);
    }
}
