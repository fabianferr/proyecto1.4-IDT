...
final class PropertyRegistryExtKt$loadEnvironmentProperties$1 extends Lambda implements Function0<String> {
    ...
    PropertyRegistryExtKt$loadEnvironmentProperties$1() {
        super(0);
    }
