...
public final class Format implements Bundleable {
    ...
    public static String toLogString(Format format) {
        ...
        if (format.selectionFlags != 0) {
            ...
            Joiner.on((char) AbstractJsonLexerKt.COMMA).appendTo(sb, (Iterable<? extends Object>) arrayList);
            sb.append("]");
        }
        if (format.roleFlags != 0) {
            ...
            sb.append(", roleFlags=[");
            Joiner.on((char) AbstractJsonLexerKt.COMMA).appendTo(sb, (Iterable<? extends Object>) arrayList2);
            sb.append("]");
        }
        return sb.toString();
    }
