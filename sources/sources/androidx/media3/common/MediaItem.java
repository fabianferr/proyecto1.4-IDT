...
public final class MediaItem implements Bundleable {
    ...
    public static final class Builder {
        ...
        public MediaItem build() {
            ...
            if (uri2 != null) {
                ...
                localConfiguration = new LocalConfiguration(uri2, str, drmConfiguration2, this.adsConfiguration, this.streamKeys, this.customCacheKey, this.subtitleConfigurations, this.tag);
            } else {
    ...
    public static final class DrmConfiguration implements Bundleable {
        ...
        public static DrmConfiguration fromBundle(Bundle bundle) {
            ...
            ImmutableList<Integer> copyOf = ImmutableList.copyOf(BundleableUtil.getIntegerArrayListWithDefault(bundle, FIELD_FORCED_SESSION_TRACK_TYPES, new ArrayList()));
    ...
    public static final class LocalConfiguration implements Bundleable {
        public static final Bundleable.Creator<LocalConfiguration> CREATOR = new MediaItem$LocalConfiguration$$ExternalSyntheticLambda0();
        ...
        public static LocalConfiguration fromBundle(Bundle bundle) {
            ...
            ImmutableList immutableList;
            ImmutableList<SubtitleConfiguration> immutableList2;
            Bundle bundle2 = bundle.getBundle(FIELD_DRM_CONFIGURATION);
            AdsConfiguration adsConfiguration2 = null;
            if (bundle2 == null) {
                drmConfiguration2 = null;
            } else {
                drmConfiguration2 = DrmConfiguration.CREATOR.fromBundle(bundle2);
            }
            Bundle bundle3 = bundle.getBundle(FIELD_ADS_CONFIGURATION);
            if (bundle3 != null) {
                adsConfiguration2 = AdsConfiguration.CREATOR.fromBundle(bundle3);
            }
            ...
            if (parcelableArrayList == null) {
                ...
                immutableList = BundleableUtil.fromBundleList(new MediaItem$LocalConfiguration$$ExternalSyntheticLambda1(), parcelableArrayList);
            }
            ...
            if (parcelableArrayList2 == null) {
                ...
                immutableList2 = BundleableUtil.fromBundleList(SubtitleConfiguration.CREATOR, parcelableArrayList2);
            }
            return new LocalConfiguration((Uri) Assertions.checkNotNull((Uri) bundle.getParcelable(FIELD_URI)), bundle.getString(FIELD_MIME_TYPE), drmConfiguration2, adsConfiguration3, immutableList3, bundle.getString(FIELD_CUSTOM_CACHE_KEY), immutableList2, (Object) null);
        }
    }
    ...
    public static MediaItem fromBundle(Bundle bundle) {
        ...
        if (bundle6 == null) {
            ...
            localConfiguration2 = LocalConfiguration.CREATOR.fromBundle(bundle6);
        }
