...
public final class RawResourceDataSource extends BaseDataSource {
    ...
    public long open(DataSpec dataSpec) throws RawResourceDataSourceException {
        ...
        if (TextUtils.equals("rawresource", normalizeScheme.getScheme()) || (TextUtils.equals("android.resource", normalizeScheme.getScheme()) && normalizeScheme.getPathSegments().size() == 1 && ((String) Assertions.checkNotNull(normalizeScheme.getLastPathSegment())).matches("\\d+"))) {
            try {
                i = Integer.parseInt((String) Assertions.checkNotNull(normalizeScheme.getLastPathSegment()));
            ...
            throw new RawResourceDataSourceException("Unsupported URI scheme (" + normalizeScheme.getScheme() + "). Only rawresource and android.resource are supported.", (Throwable) null, 1004);
        }
