...
public final class PlayerMessage {
    ...
    public synchronized boolean blockUntilDelivered(long r7) throws java.lang.InterruptedException, java.util.concurrent.TimeoutException {
        ...
        L_0x0015:
            androidx.media3.common.util.Assertions.checkState(r0)     // Catch:{ all -> 0x0048 }
            androidx.media3.common.util.Clock r0 = r6.clock     // Catch:{ all -> 0x0048 }
        ...
        L_0x001f:
            ...
            androidx.media3.common.util.Clock r2 = r6.clock     // Catch:{ all -> 0x0048 }
            r2.onThreadBlocked()     // Catch:{ all -> 0x0048 }
            r6.wait(r7)     // Catch:{ all -> 0x0048 }
            androidx.media3.common.util.Clock r7 = r6.clock     // Catch:{ all -> 0x0048 }
