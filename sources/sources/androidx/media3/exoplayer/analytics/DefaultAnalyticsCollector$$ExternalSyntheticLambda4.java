...
public final /* synthetic */ class DefaultAnalyticsCollector$$ExternalSyntheticLambda4 implements ListenerSet.Event {
    ...
    public /* synthetic */ DefaultAnalyticsCollector$$ExternalSyntheticLambda4(AnalyticsListener.EventTime eventTime, Format format, DecoderReuseEvaluation decoderReuseEvaluation) {
        this.f$0 = eventTime;
        this.f$1 = format;
