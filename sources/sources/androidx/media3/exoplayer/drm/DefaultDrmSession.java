...
class DefaultDrmSession implements DrmSession {
    ...
    private void onError(Exception exc, int i) {
        ...
        dispatchEvent(new DefaultDrmSession$$ExternalSyntheticLambda0(exc));
        if (this.state != 4) {
            this.state = 1;
        }
    }
    ...
    private class RequestHandler extends Handler {
        ...
        public void handleMessage(android.os.Message r6) {
            /*
                ...
                androidx.media3.exoplayer.drm.DefaultDrmSession r1 = androidx.media3.exoplayer.drm.DefaultDrmSession.this     // Catch:{ MediaDrmCallbackException -> 0x0044, Exception -> 0x003b }
                androidx.media3.exoplayer.drm.MediaDrmCallback r1 = r1.callback     // Catch:{ MediaDrmCallbackException -> 0x0044, Exception -> 0x003b }
                androidx.media3.exoplayer.drm.DefaultDrmSession r2 = androidx.media3.exoplayer.drm.DefaultDrmSession.this     // Catch:{ MediaDrmCallbackException -> 0x0044, Exception -> 0x003b }
                ...
                androidx.media3.exoplayer.drm.ExoMediaDrm$KeyRequest r3 = (androidx.media3.exoplayer.drm.ExoMediaDrm.KeyRequest) r3     // Catch:{ MediaDrmCallbackException -> 0x0044, Exception -> 0x003b }
            ...
            L_0x0026:
                ...
                java.util.UUID r2 = r2.uuid     // Catch:{ MediaDrmCallbackException -> 0x0044, Exception -> 0x003b }
                java.lang.Object r3 = r0.request     // Catch:{ MediaDrmCallbackException -> 0x0044, Exception -> 0x003b }
                androidx.media3.exoplayer.drm.ExoMediaDrm$ProvisionRequest r3 = (androidx.media3.exoplayer.drm.ExoMediaDrm.ProvisionRequest) r3     // Catch:{ MediaDrmCallbackException -> 0x0044, Exception -> 0x003b }
            ...
            L_0x004c:
                ...
                androidx.media3.exoplayer.drm.DefaultDrmSession r2 = androidx.media3.exoplayer.drm.DefaultDrmSession.this     // Catch:{ all -> 0x0073 }
                androidx.media3.exoplayer.drm.DefaultDrmSession$ResponseHandler r2 = r2.responseHandler     // Catch:{ all -> 0x0073 }
