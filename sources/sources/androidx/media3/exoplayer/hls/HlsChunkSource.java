...
class HlsChunkSource {
    ...
    public void getNextChunk(long j, long j2, List<HlsMediaChunk> list, boolean z, HlsChunkHolder hlsChunkHolder) {
        ...
        long j6 = j5;
        this.trackSelection.updateSelectedTrack(j, j6, resolveTimeToLiveEdgeUs, list, createMediaChunkIterators(hlsMediaChunk, j4));
        ...
        if (longValue >= playlistSnapshot.mediaSequence || hlsMediaChunk == null || !z2) {
            ...
            HlsMediaPlaylist hlsMediaPlaylist3 = playlistSnapshot2;
        ...
        if (this.cmcdConfiguration == null) {
            ...
            CmcdHeadersFactory cmcdHeadersFactory2 = new CmcdHeadersFactory(this.cmcdConfiguration, this.trackSelection, j6, CmcdHeadersFactory.STREAMING_FORMAT_HLS, !hlsMediaPlaylist.hasEndTag);
            if (getIsMuxedAudioAndVideo()) {
                str = CmcdHeadersFactory.OBJECT_TYPE_MUXED_AUDIO_AND_VIDEO;
            } else {
                str = CmcdHeadersFactory.getObjectType(this.trackSelection);
            }
            cmcdHeadersFactory = cmcdHeadersFactory2.setObjectType(str);
        }
        Uri fullEncryptionKeyUri = getFullEncryptionKeyUri(hlsMediaPlaylist, nextSegmentHolder.segmentBase.initializationSegment);
        hlsChunkHolder2.chunk = maybeCreateEncryptionChunkFor(fullEncryptionKeyUri, i2, true, cmcdHeadersFactory);
        if (hlsChunkHolder2.chunk == null) {
            ...
            hlsChunkHolder2.chunk = maybeCreateEncryptionChunkFor(fullEncryptionKeyUri2, i2, false, cmcdHeadersFactory);
            if (hlsChunkHolder2.chunk == null) {
