...
final class ImaUtil {
    ...
    public static final class ServerSideAdInsertionConfiguration {
        ...
        public ServerSideAdInsertionConfiguration(AdViewProvider adViewProvider2, ImaSdkSettings imaSdkSettings2, AdEvent.AdEventListener adEventListener, AdErrorEvent.AdErrorListener adErrorListener, List<CompanionAdSlot> list, boolean z, boolean z2) {
            this.imaSdkSettings = imaSdkSettings2;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:37:0x010b, code lost:
        if (r4.isLive() == false) goto L_0x0129;
     */
    ...
    public static AdPlaybackState maybeCorrectPreviouslyUnknownAdDurations(Timeline timeline, AdPlaybackState adPlaybackState) {
        ...
        if (timeline.getPeriod(i2, period).durationUs == -9223372036854775807L) {
            i2--;
    ...
    public static long getAdGroupDurationUsForLiveAdPeriodIndex(Timeline timeline, AdPodInfo adPodInfo, int i, Timeline.Window window, Timeline.Period period) {
        ...
        return j != -9223372036854775807L ? j : secToUsRounded(adPodInfo.getMaxDuration());
    }
        ...
        if (adGroupIndexForPositionUs != -1) {
            ...
            for (int i3 = 0; i3 < adGroup.states.length; i3++) {
                ...
                if (windowStartTimeUs <= adGroup.timeUs + j) {
                    ...
                    return period.durationUs != -9223372036854775807L ? addLiveAdBreak(windowStartTimeUs, period.durationUs, 1, period.durationUs, 1, markAdGroupAsPlayed) : markAdGroupAsPlayed;
                }
                if (i4 == 1 || i4 == 0) {
    ...
    public static Pair<Integer, Integer> getAdGroupAndIndexInLiveMultiPeriodTimeline(int i, int i2, Timeline timeline, AdPlaybackState adPlaybackState) {
        ...
        throw new IllegalStateException(String.format("No unplayed ad group found before or at the start time us %d of the period with index %d", new Object[]{Long.valueOf(windowStartTimeUs), Integer.valueOf(i2)}));
    }
    ...
    public static Pair<Integer, Integer> getAdGroupAndIndexInVodMultiPeriodTimeline(int i, AdPlaybackState adPlaybackState, Timeline timeline) {
        ...
        while (i4 < adPlaybackState2.adGroupCount) {
            ...
            int i7 = 0;
            while (true) {
                if (i5 >= Math.min(timeline.getPeriodCount(), i3 + 1)) {
                    i2 = i4;
                    break;
                }
