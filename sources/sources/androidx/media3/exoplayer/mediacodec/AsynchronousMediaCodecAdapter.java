...
final class AsynchronousMediaCodecAdapter implements MediaCodecAdapter {
    ...
    public static final class Factory implements MediaCodecAdapter.Factory {
        ...
        public androidx.media3.exoplayer.mediacodec.AsynchronousMediaCodecAdapter createAdapter(androidx.media3.exoplayer.mediacodec.MediaCodecAdapter.Configuration r10) throws java.io.IOException {
            /*
                r9 = this;
                java.lang.String r0 = "createCodec:"
                androidx.media3.exoplayer.mediacodec.MediaCodecInfo r1 = r10.codecInfo
                ...
                androidx.media3.common.util.TraceUtil.beginSection(r0)     // Catch:{ Exception -> 0x004a }
                android.media.MediaCodec r0 = android.media.MediaCodec.createByCodecName(r1)     // Catch:{ Exception -> 0x004a }
                androidx.media3.exoplayer.mediacodec.AsynchronousMediaCodecAdapter r1 = new androidx.media3.exoplayer.mediacodec.AsynchronousMediaCodecAdapter     // Catch:{ Exception -> 0x0048 }
                ...
                androidx.media3.common.util.TraceUtil.endSection()     // Catch:{ Exception -> 0x0045 }
    ...
    public /* synthetic */ void m133lambda$setOnFrameRenderedListener$0$androidxmedia3exoplayermediacodecAsynchronousMediaCodecAdapter(MediaCodecAdapter.OnFrameRenderedListener onFrameRenderedListener, MediaCodec mediaCodec, long j, long j2) {
