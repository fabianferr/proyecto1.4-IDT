...
public final class DownloadHelper {
    ...
    public static RendererCapabilities[] getRendererCapabilities(RenderersFactory renderersFactory) {
        ...
        }, new DownloadHelper$$ExternalSyntheticLambda5(), new DownloadHelper$$ExternalSyntheticLambda6());
    ...
    public /* synthetic */ void m138lambda$prepare$3$androidxmedia3exoplayerofflineDownloadHelper(Callback callback2) {
    ...
    public void onMediaPrepared() throws ExoPlaybackException {
        ...
        ((Handler) Assertions.checkNotNull(this.callbackHandler)).post(new DownloadHelper$$ExternalSyntheticLambda3(this));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$onMediaPrepared$4$androidx-media3-exoplayer-offline-DownloadHelper  reason: not valid java name */
    public /* synthetic */ void m137lambda$onMediaPrepared$4$androidxmedia3exoplayerofflineDownloadHelper() {
    ...
    public void onMediaPreparationFailed(IOException iOException) {
        ((Handler) Assertions.checkNotNull(this.callbackHandler)).post(new DownloadHelper$$ExternalSyntheticLambda4(this, iOException));
    }
    ...
    public /* synthetic */ void m136lambda$onMediaPreparationFailed$5$androidxmedia3exoplayerofflineDownloadHelper(IOException iOException) {
            ...
            public ExoTrackSelection[] createTrackSelections(ExoTrackSelection.Definition[] definitionArr, BandwidthMeter bandwidthMeter, MediaSource.MediaPeriodId mediaPeriodId, Timeline timeline) {
                ...
                for (int i = 0; i < definitionArr.length; i++) {
                    ...
                    if (definition == null) {
                        ...
                        downloadTrackSelection = new DownloadTrackSelection(definition.group, definitionArr[i].tracks);
                    }
