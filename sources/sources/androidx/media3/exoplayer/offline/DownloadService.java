...
public abstract class DownloadService extends Service {
        ...
        switch (c) {
            case 0:
                if (((Intent) Assertions.checkNotNull(intent)).hasExtra("stop_reason")) {
                    access$100.setStopReason(str, intent.getIntExtra("stop_reason", 0));
                    break;
                } else {
            ...
            case 6:
                ...
                if (downloadRequest != null) {
                    access$100.addDownload(downloadRequest, intent.getIntExtra("stop_reason", 0));
                    break;
                } else {
    ...
    private static final class DownloadManagerHelper implements DownloadManager.Listener {
        ...
        public /* synthetic */ void m139lambda$attachService$0$androidxmedia3exoplayerofflineDownloadService$DownloadManagerHelper(DownloadService downloadService2) {
