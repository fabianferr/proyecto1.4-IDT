...
final class RtspMediaPeriod implements MediaPeriod {
    ...
    private final class InternalListener implements ExtractorOutput, Loader.Callback<RtpDataLoadable>, SampleQueue.UpstreamFormatChangedListener, RtspClient.SessionInfoListener, RtspClient.PlaybackEventListener {
        ...
        public void onRtspSetupCompleted() {
            ...
            if (RtspMediaPeriod.this.pendingSeekPositionUs != -9223372036854775807L) {
                ...
                j = RtspMediaPeriod.this.pendingSeekPositionUsForTcpRetry != -9223372036854775807L ? Util.usToMs(RtspMediaPeriod.this.pendingSeekPositionUsForTcpRetry) : 0;
            }
        ...
        public void onPlaybackStarted(long j, ImmutableList<RtspTrackTiming> immutableList) {
            ...
            for (int i2 = 0; i2 < RtspMediaPeriod.this.selectedLoadInfos.size(); i2++) {
                if (!arrayList.contains(((RtpLoadInfo) RtspMediaPeriod.this.selectedLoadInfos.get(i2)).getTrackUri().getPath())) {
                    ...
                    if (RtspMediaPeriod.this.isSeekPending()) {
                        ...
                        long unused3 = RtspMediaPeriod.this.requestedSeekPositionUs = -9223372036854775807L;
                        long unused4 = RtspMediaPeriod.this.pendingSeekPositionUsForTcpRetry = -9223372036854775807L;
                    }
                }
            }
            ...
            if (RtspMediaPeriod.this.isSeekPending()) {
                if (RtspMediaPeriod.this.pendingSeekPositionUs == RtspMediaPeriod.this.requestedSeekPositionUs) {
                    long unused5 = RtspMediaPeriod.this.pendingSeekPositionUs = -9223372036854775807L;
                    long unused6 = RtspMediaPeriod.this.requestedSeekPositionUs = -9223372036854775807L;
                    return;
                }
                long unused7 = RtspMediaPeriod.this.pendingSeekPositionUs = -9223372036854775807L;
                ...
                long unused8 = RtspMediaPeriod.this.pendingSeekPositionUsForTcpRetry = -9223372036854775807L;
            }
        }
    ...
    final class RtpLoadInfo {
        ...
        public /* synthetic */ void m142lambda$new$0$androidxmedia3exoplayerrtspRtspMediaPeriod$RtpLoadInfo(String str, RtpDataChannel rtpDataChannel) {
            this.transport = str;
