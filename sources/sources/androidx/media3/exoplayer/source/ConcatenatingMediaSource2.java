...
public final class ConcatenatingMediaSource2 extends CompositeMediaSource<Integer> {
    ...
    public static final class Builder {
        ...
        public Builder add(MediaItem mediaItem2) {
            return add(mediaItem2, -9223372036854775807L);
        }
        ...
        public Builder add(MediaSource mediaSource, long j) {
            ...
            Assertions.checkState(!(mediaSource instanceof ProgressiveMediaSource) || j != -9223372036854775807L, "Progressive media source must define an initial placeholder duration.");
