...
public class DefaultTrackSelector extends MappingTrackSelector implements RendererCapabilities.Listener {
    ...
    public static final Ordering<Integer> FORMAT_VALUE_ORDERING = Ordering.from(new DefaultTrackSelector$$ExternalSyntheticLambda7());
    private static final float FRACTION_TO_CONSIDER_FULLSCREEN = 0.98f;
    /* access modifiers changed from: private */
    public static final Ordering<Integer> NO_ORDER = Ordering.from(new DefaultTrackSelector$$ExternalSyntheticLambda8());
    ...
    public Pair<ExoTrackSelection.Definition, Integer> selectVideoTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, int[] iArr2, Parameters parameters2) throws ExoPlaybackException {
        return selectTracksForType(2, mappedTrackInfo, iArr, new DefaultTrackSelector$$ExternalSyntheticLambda3(parameters2, iArr2), new DefaultTrackSelector$$ExternalSyntheticLambda4());
    }
    ...
    public Pair<ExoTrackSelection.Definition, Integer> selectAudioTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, int[] iArr2, Parameters parameters2) throws ExoPlaybackException {
        ...
        return selectTracksForType(1, mappedTrackInfo, iArr, new DefaultTrackSelector$$ExternalSyntheticLambda1(this, parameters2, z), new DefaultTrackSelector$$ExternalSyntheticLambda2());
    }
    ...
    public /* synthetic */ List m1580lambda$selectAudioTrack$3$androidxmedia3exoplayertrackselectionDefaultTrackSelector(Parameters parameters2, boolean z, int i, TrackGroup trackGroup, int[] iArr) {
        return AudioTrackInfo.createForTrackGroup(i, trackGroup, parameters2, iArr, z, new DefaultTrackSelector$$ExternalSyntheticLambda0(this));
    }
    ...
    private static final class VideoTrackInfo extends TrackInfo<VideoTrackInfo> {
        ...
        public static ImmutableList<VideoTrackInfo> createForTrackGroup(int i, TrackGroup trackGroup, Parameters parameters2, int[] iArr, int i2) {
            ...
            int access$3900 = DefaultTrackSelector.getMaxVideoPixelsToRetainForViewport(trackGroup2, parameters3.viewportWidth, parameters3.viewportHeight, parameters3.viewportOrientationMayChange);
            ImmutableList.Builder builder = ImmutableList.builder();
            for (int i3 = 0; i3 < trackGroup2.length; i3++) {
                int pixelCount2 = trackGroup2.getFormat(i3).getPixelCount();
                builder.add((Object) new VideoTrackInfo(i, trackGroup, i3, parameters2, iArr[i3], i2, access$3900 == Integer.MAX_VALUE || (pixelCount2 != -1 && pixelCount2 <= access$3900)));
            }
    ...
    private static final class TextTrackInfo extends TrackInfo<TextTrackInfo> implements Comparable<TextTrackInfo> {
        ...
        public TextTrackInfo(int i, TrackGroup trackGroup, int i2, Parameters parameters, int i3, String str) {
            ...
            int access$4000 = DefaultTrackSelector.getRoleFlagMatchScore(this.format.roleFlags, parameters.preferredTextRoleFlags);
    ...
    private static class SpatializerWrapperV32 {
        ...
        public void ensureInitialized(final DefaultTrackSelector defaultTrackSelector, Looper looper) {
            if (this.listener == null && this.handler == null) {
                ...
                spatializer2.addOnSpatializerStateChangedListener(new ConcurrencyHelpers$$ExternalSyntheticLambda1(handler2), this.listener);
            }
        }
