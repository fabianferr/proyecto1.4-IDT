...
public final class CachedRegionTracker implements Cache.Listener {
    ...
    public synchronized int getRegionEndTimeMs(long r8) {
        /*
            r7 = this;
            monitor-enter(r7)
            androidx.media3.exoplayer.upstream.CachedRegionTracker$Region r0 = r7.lookupRegion     // Catch:{ all -> 0x0066 }
            r0.startOffset = r8     // Catch:{ all -> 0x0066 }
            java.util.TreeSet<androidx.media3.exoplayer.upstream.CachedRegionTracker$Region> r0 = r7.regions     // Catch:{ all -> 0x0066 }
            androidx.media3.exoplayer.upstream.CachedRegionTracker$Region r1 = r7.lookupRegion     // Catch:{ all -> 0x0066 }
            java.lang.Object r0 = r0.floor(r1)     // Catch:{ all -> 0x0066 }
            androidx.media3.exoplayer.upstream.CachedRegionTracker$Region r0 = (androidx.media3.exoplayer.upstream.CachedRegionTracker.Region) r0     // Catch:{ all -> 0x0066 }
            r1 = -1
        ...
        L_0x001d:
            int r8 = r0.endOffsetIndex     // Catch:{ all -> 0x0066 }
            androidx.media3.extractor.ChunkIndex r9 = r7.chunkIndex     // Catch:{ all -> 0x0066 }
