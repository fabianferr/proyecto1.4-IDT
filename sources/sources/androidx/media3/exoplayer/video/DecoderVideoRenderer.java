...
public abstract class DecoderVideoRenderer extends BaseRenderer {
    ...
    private boolean processOutputBuffer(long j, long j2) throws ExoPlaybackException, DecoderException {
        ...
        if (hasOutput()) {
            ...
            if ((this.renderedFirstFrameAfterEnable ? !this.renderedFirstFrameAfterReset : !(!z && !this.mayRenderFirstFrameAfterEnableIfNotStarted)) || (z && shouldForceRenderOutputBuffer(j3, msToUs))) {
