...
final class WavHeaderReader {
    ...
    public static WavFormat readFormat(ExtractorInput extractorInput) throws IOException {
        ...
        ChunkHeader skipToChunk = skipToChunk(1718449184, extractorInput2, parsableByteArray);
        ...
        if (i > 0) {
            ...
            extractorInput2.peekFully(bArr2, 0, i);
            bArr = bArr2;
        } else {
            bArr = Util.EMPTY_BYTE_ARRAY;
        }
        extractorInput2.skipFully((int) (extractorInput.getPeekPosition() - extractorInput.getPosition()));
