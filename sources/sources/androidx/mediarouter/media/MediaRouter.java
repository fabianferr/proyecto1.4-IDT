    ...
    static final class GlobalMediaRouter implements SystemMediaRouteProvider.SyncCallback, RegisteredMediaRouteProviderWatcher.Callback {
        ...
        public boolean isMediaTransferEnabled() {
            /*
                ...
                androidx.mediarouter.media.MediaRouterParams r0 = r1.mRouterParams
                if (r0 == 0) goto L_0x000e
                boolean r0 = r0.isMediaTransferReceiverEnabled()
                if (r0 == 0) goto L_0x0010
            L_0x000e:
                r0 = 1
                goto L_0x0011
        ...
        public boolean isGroupVolumeUxEnabled() {
            MediaRouterParams mediaRouterParams = this.mRouterParams;
            if (mediaRouterParams == null || mediaRouterParams.mExtras == null || this.mRouterParams.mExtras.getBoolean(MediaRouterParams.ENABLE_GROUP_VOLUME_UX, true)) {
                return true;
            }
            return false;
        }
        ...
        private final class MediaSessionRecord {
            ...
            public void configureVolume(int i, int i2, int i3, String str) {
                if (this.mMsCompat != null) {
                    ...
                    AnonymousClass1 r2 = new VolumeProviderCompat(i, i2, i3, str) {
    ...
    static final class PrepareTransferNotifier {
        ...
        private void unselectFromRouteAndNotify() {
            ...
            if (globalMediaRouter != null && globalMediaRouter.mSelectedRoute == this.mFromRoute) {
                globalMediaRouter.mCallbackHandler.post(GlobalMediaRouter.CallbackHandler.MSG_ROUTE_UNSELECTED, this.mFromRoute, this.mReason);
        ...
        private void selectToRouteAndNotify() {
            ...
            if (globalMediaRouter != null) {
                ...
                if (this.mRequestedRoute == null) {
                    globalMediaRouter.mCallbackHandler.post(GlobalMediaRouter.CallbackHandler.MSG_ROUTE_SELECTED, new Pair(this.mFromRoute, this.mToRoute), this.mReason);
                } else {
                    globalMediaRouter.mCallbackHandler.post(GlobalMediaRouter.CallbackHandler.MSG_ROUTE_ANOTHER_SELECTED, new Pair(this.mRequestedRoute, this.mToRoute), this.mReason);
                }
                globalMediaRouter.mRouteControllerMap.clear();
