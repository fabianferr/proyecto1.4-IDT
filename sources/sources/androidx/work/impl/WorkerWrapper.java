...
public class WorkerWrapper implements Runnable {
                            ...
                            this.mWorkerResultFuture.addListener(new Runnable() {
                                public void run() {
                                    try {
                                        ...
                                        logger4.error(str4, str5 + " failed because it threw an exception/error", e2);
                                    } catch (Throwable th) {
    ...
    public /* synthetic */ void m1633lambda$runWorker$0$androidxworkimplWorkerWrapper(ListenableFuture listenableFuture) {
