        ...
        if (!this.future.isCancelled()) {
            ...
            if (workConstraintsTrackerImpl.areAllConstraintsMet(uuid2)) {
                ...
                try {
                    ...
                    logger.debug(access$getTAG$p2, "Delegated worker " + string + " threw exception in startWork.", th);
                ...
                String access$getTAG$p3 = ConstraintTrackingWorkerKt.TAG;
                logger.debug(access$getTAG$p3, "Constraints not met for delegate " + string + ". Requesting retry.");
