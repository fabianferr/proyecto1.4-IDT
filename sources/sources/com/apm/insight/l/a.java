...
public final class a {
    ...
    private static void a(JSONObject jSONObject, ActivityManager activityManager) {
        JSONObject jSONObject2 = new JSONObject();
        boolean z = true;
        com.apm.insight.entity.a.a(jSONObject, ShareConstants.WEB_DIALOG_PARAM_FILTERS, "native_heap_leak", String.valueOf(Debug.getNativeHeapAllocatedSize() > 209715200));
        ...
        com.apm.insight.entity.a.a(jSONObject, ShareConstants.WEB_DIALOG_PARAM_FILTERS, "java_heap_leak", String.valueOf(z));
        if (activityManager != null) {
    ...
    public static boolean b(Context context) {
        String c2 = c(context);
        if (c2 != null && c2.contains(CertificateUtil.DELIMITER)) {
            return false;
        }
