...
public abstract class c {
    ...
    protected Context b;
    protected ICommonParams c = i.a().c();
    protected b d;
    protected d e;
    ...
    private void i(com.apm.insight.entity.a aVar) {
        List<AttachUserData> a2 = i.b().a(this.a);
        ...
        List<AttachUserData> b2 = i.b().b(this.a);
        if (b2 != null) {
    ...
    public com.apm.insight.entity.a b(com.apm.insight.entity.a aVar) {
        ...
        aVar.b((Map<Integer, String>) i.o());
        aVar.a("process_name", (Object) com.apm.insight.l.a.c(i.g()));
        return aVar;
    }
    ...
    public com.apm.insight.entity.a e(com.apm.insight.entity.a aVar) {
        ...
        aVar.c((Map<? extends String, ? extends String>) i.b().a());
        return aVar;
    }
