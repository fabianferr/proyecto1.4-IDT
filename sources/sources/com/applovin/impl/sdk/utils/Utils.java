...
public abstract class Utils {
    ...
    public static List<Uri> checkCachedResourcesExist(boolean z, e eVar, m mVar, Context context) {
        ...
        if (z) {
            Uri h = eVar.h();
            if (!(mVar.aa() != null ? mVar.aa().b(h.getLastPathSegment(), context) : mVar.ab().b(h.getLastPathSegment(), context))) {
                if (u.a()) {
                    u A2 = mVar.A();
                    A2.e(TAG, "Cached video missing: " + h);
                }
                arrayList.add(h);
            }
        }
    ...
    public static boolean checkExoPlayerEligibility(m mVar) {
        if (isExoPlayerEligible == null) {
            ...
            int intValue = ((Integer) mVar.a(b.cF)).intValue();
            isExoPlayerEligible = Boolean.valueOf(checkClassExistence("com.google.android.exoplayer2.ui.PlayerView") && tryToGetExoPlayerVersionCode >= ((Integer) mVar.a(b.cE)).intValue() && (intValue < 0 || tryToGetExoPlayerVersionCode <= intValue));
        }
    ...
    public static int compare(String str, String str2) {
        ...
        try {
            ...
            if (u.a()) {
                u.c(TAG, "Failed to process version string.", th);
            }
            return 0;
        }
    }
    ...
    public static String getAndroidOSInfo() {
        try {
            ...
            u.c(TAG, "Unable to get Android OS info", th);
            return "";
        }
    }
    ...
    public static String getAndroidSdkCodename() {
        try {
            ...
            u.c(TAG, "Unable to get Android SDK codename", th);
            return "";
        }
    }
    ...
    public static List<com.applovin.impl.sdk.e.a> getPostbacks(String str, JSONObject jSONObject, String str2, String str3, m mVar) {
        return getPostbacks(str, jSONObject, str2, (Map<String, String>) null, str3, mVar);
    }

    public static List<com.applovin.impl.sdk.e.a> getPostbacks(String str, JSONObject jSONObject, String str2, String str3, Map<String, String> map, m mVar) {
        return getPostbacks(str, jSONObject, str2, Collections.emptyMap(), str3, map, false, mVar);
    }

    public static List<com.applovin.impl.sdk.e.a> getPostbacks(String str, JSONObject jSONObject, String str2, Map<String, String> map, String str3, m mVar) {
        return getPostbacks(str, jSONObject, str2, map, str3, (Map<String, String>) null, false, mVar);
    }

    public static List<com.applovin.impl.sdk.e.a> getPostbacks(String str, JSONObject jSONObject, String str2, Map<String, String> map, String str3, Map<String, String> map2, boolean z, m mVar) {
        if (map == null) {
    ...
    public static List<com.applovin.impl.sdk.e.a> getPostbacks(String str, JSONObject jSONObject, Map<String, String> map, String str2, m mVar) {
        return getPostbacks(str, jSONObject, map, str2, (Map<String, String>) null, mVar);
    }

    public static List<com.applovin.impl.sdk.e.a> getPostbacks(String str, JSONObject jSONObject, Map<String, String> map, String str2, Map<String, String> map2, m mVar) {
        return getPostbacks(str, jSONObject, map, str2, map2, false, mVar);
    }

    public static List<com.applovin.impl.sdk.e.a> getPostbacks(String str, JSONObject jSONObject, Map<String, String> map, String str2, Map<String, String> map2, boolean z, m mVar) {
        ...
        if (StringUtils.isValidString(str2)) {
            arrayList.add(new com.applovin.impl.sdk.e.a(str2, (String) null, map2, z));
        }
            ...
            while (keys.hasNext()) {
                try {
                    ...
                    if (!TextUtils.isEmpty(next)) {
                        ...
                        arrayList.add(new com.applovin.impl.sdk.e.a(replace, optString, map2, z));
                    }
                } catch (Throwable th) {
                    if (u.a()) {
    ...
    public static long getServerAdjustedUnixTimestampMillis(m mVar) {
        long longValue = ((Long) mVar.a(b.eu)).longValue();
        long longValue2 = ((Long) mVar.a(b.ev)).longValue();
    ...
    public static d getZone(JSONObject jSONObject, m mVar) {
        return d.a(AppLovinAdSize.fromString(JsonUtils.getString(jSONObject, "ad_size", (String) null)), AppLovinAdType.fromString(JsonUtils.getString(jSONObject, "ad_type", (String) null)), JsonUtils.getString(jSONObject, AppLovinUtils.ServerParameterKeys.ZONE_ID, (String) null));
    }
    ...
    public static boolean isCurrentProcessInForeground() {
        ...
        try {
            ...
            if (u.a()) {
                u.c(TAG, "Exception thrown while getting memory state.", th);
            }
        }
    ...
    public static boolean isPubInDebugMode(Context context, m mVar) {
        String str = mVar.p().getExtraParameters().get(AppLovinSdkExtraParameterKey.RUN_IN_RELEASE_MODE);
    ...
    public static boolean isUserAgentCollectionEnabled(m mVar) {
        String str = mVar.p().getExtraParameters().get(AppLovinSdkExtraParameterKey.USER_AGENT_COLLECTION_ENABLED);
    ...
    public static boolean isVPNConnected() {
        ...
        L_0x002e:
            ...
            com.applovin.impl.sdk.u.c(r1, r2, r0)
        L_0x003c:
            r0 = 0
            return r0
        */
    ...
    public static boolean isVideoMutedInitially(m mVar) {
        return ((Boolean) mVar.a(b.cv)).booleanValue() ? mVar.p().isMuted() : ((Boolean) mVar.a(b.ct)).booleanValue();
    }
    ...
    public static void maybeHandleNoFillResponseForPublisher(String str, MaxAdFormat maxAdFormat, JSONObject jSONObject, m mVar) {
        if (jSONObject.has("no_fill_reason") && u.a()) {
    ...
    public static void maybeLogCustomDataSizeLimit(String str, String str2) {
        if (str != null && str.length() > kilobytesToByes(8)) {
            u.h(str2, "Provided custom data parameter longer than supported (" + str.length() + " bytes, " + kilobytesToByes(8) + " maximum)");
        }
    }
    ...
    public static Object sanitizeSuperProperty(Object obj, m mVar) {
        ...
        if (obj instanceof Map) {
            ...
            for (Map.Entry entry : map.entrySet()) {
                ...
                map2.put(key instanceof String ? (String) key : String.valueOf(key), sanitizeSuperProperty(entry.getValue(), mVar));
            }
            return map2;
        } else if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                i = ((Integer) mVar.a(b.bh)).intValue();
                if (i <= 0 || valueOf.length() <= i) {
                    return valueOf;
                }
            } else if (!(obj instanceof Uri) || (i = ((Integer) mVar.a(b.bi)).intValue()) <= 0 || valueOf.length() <= i) {
                return valueOf;
            }
    ...
    public static Map<String, String> toUrlSafeMap(Map<String, String> map, m mVar) {
        ...
        for (String next : map2.keySet()) {
            ...
            if (str != null) {
                map2.put(next, StringUtils.encodeUriString(str, mVar));
            }
        }
        return map2;
    }
    ...
    public static int toVersionCode(String str) {
        ...
        for (String str2 : str.replaceAll("-beta", ".").split("\\.")) {
            if (str2.length() > 2) {
                if (u.a()) {
                    u.i(TAG, "Version number components cannot be longer than two digits -> " + str);
                }
                return i;
            }
    ...
    public static double tryParseDouble(String str, double d) {
        try {
            ...
            if (u.a()) {
                u.c(TAG, "Failed to parse double from String: " + str, th);
            }
            return d;
        }
    }
    ...
    public static WebView tryToCreateWebView(Context context, String str) {
        try {
            ...
            u.c(TAG, "Failed to initialize WebView for " + str + ".", th);
            return null;
        }
    }
    ...
    public static void validateAdSdkKey(AppLovinAd appLovinAd, m mVar) {
        if (appLovinAd instanceof AppLovinAdBase) {
            ...
            if (!z.equals(z2)) {
                if (u.a()) {
                    u.i("AppLovinAd", "Ad was loaded from sdk with key: " + z2 + ", but is being rendered from sdk with key: " + z);
                }
                mVar.T().a(com.applovin.impl.sdk.e.f.n);
            }
        }
    }
}
