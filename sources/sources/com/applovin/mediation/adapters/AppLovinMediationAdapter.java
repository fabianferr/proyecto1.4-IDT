...
public class AppLovinMediationAdapter extends MediationAdapterBase implements MaxAdViewAdapter, MaxInterstitialAdapter, MaxRewardedAdapter, MaxRewardedInterstitialAdapter, MaxSignalProvider {
            ...
            if (appLovinNativeAdImpl != null) {
                ...
                if (StringUtils.isValidString(getBody()) && maxNativeAdView.getBodyTextView() != null) {
                    if (u.a()) {
                        ...
                        appLovinMediationAdapter3.d("Adding body TextView: " + maxNativeAdView.getBodyTextView());
                    }
                ...
                if (StringUtils.isValidString(getCallToAction()) && maxNativeAdView.getCallToActionButton() != null) {
                    if (u.a()) {
                        ...
                        appLovinMediationAdapter4.d("Adding CTA button: " + maxNativeAdView.getCallToActionButton());
                        AppLovinMediationAdapter appLovinMediationAdapter5 = AppLovinMediationAdapter.this;
                        appLovinMediationAdapter5.d("CTA button is clickable: " + maxNativeAdView.getCallToActionButton().isClickable());
                        AppLovinMediationAdapter appLovinMediationAdapter6 = AppLovinMediationAdapter.this;
                        appLovinMediationAdapter6.d("CTA button is enabled: " + maxNativeAdView.getCallToActionButton().isEnabled());
                        AppLovinMediationAdapter appLovinMediationAdapter7 = AppLovinMediationAdapter.this;
                        appLovinMediationAdapter7.d("CTA button has onClickListeners: " + maxNativeAdView.getCallToActionButton().hasOnClickListeners());
                    }
                    arrayList.add(maxNativeAdView.getCallToActionButton());
                }
                if (!(getIcon() == null || maxNativeAdView.getIconImageView() == null)) {
                    if (u.a()) {
                        AppLovinMediationAdapter appLovinMediationAdapter8 = AppLovinMediationAdapter.this;
                        appLovinMediationAdapter8.d("Adding icon iamge view: " + maxNativeAdView.getIconImageView());
                    }
    ...
    private void loadFullscreenAd(String str, MaxAdapterResponseParameters maxAdapterResponseParameters, final MaxAdFormat maxAdFormat, final MaxAdapterListener maxAdapterListener) {
        StringBuilder sb;
        AnonymousClass2 r0 = new AppLovinAdLoadListener() {
