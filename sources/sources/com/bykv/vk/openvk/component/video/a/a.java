    ...
    public static void a(JSONObject jSONObject) {
        if (jSONObject != null) {
            try {
                ...
                b = jSONObject.optInt(c.EXTRA_REWARD, 10);
                ...
                com.bykv.vk.openvk.component.video.api.f.c.b("MediaConfig", "splash=", Integer.valueOf(a), ",reward=", Integer.valueOf(b), ",brand=", Integer.valueOf(c), ",other=", Integer.valueOf(d));
            } catch (Throwable th) {
