...
public class c {
    ...
    public final d c;
    private final Executor d = new ThreadPoolExecutor(0, 1, 60, TimeUnit.SECONDS, new LinkedBlockingDeque(), new i(5, "video_proxy_db"));
    /* access modifiers changed from: private */
            ...
            this.d.execute(new Runnable() {
                public void run() {
                    try {
                        if (c.this.e == null) {
                            c cVar = c.this;
                            SQLiteStatement unused = cVar.e = cVar.c.getWritableDatabase().compileStatement("INSERT INTO video_http_header_t (key,mime,contentLength,flag,extra) VALUES(?,?,?,?,?)");
                        } else {
