...
public class f {
    ...
    /* access modifiers changed from: private */
    public final SparseArray<Set<g>> h;
    /* access modifiers changed from: private */
    public final g.c i;
                            ...
                            while (f.this.c.get() == 1) {
                                try {
                                    ...
                                    if (h != null) {
                                        ...
                                        com.bytedance.sdk.component.g.f.c().execute(new h("ProxyTask", 10) {
                                            public void run() {
                                                a2.run();
                                            }
                                        });
    ...
    public String a(boolean z, boolean z2, String str, String... strArr) {
        ...
        if (strArr == null || strArr.length == 0) {
            ...
            if (z) {
                str3 = "https://" + i() + CertificateUtil.DELIMITER + this.b + "?f=1&" + a3;
            } else {
                str3 = "https://" + i() + CertificateUtil.DELIMITER + this.b + "?" + a3;
            }
            return str3.replaceFirst(CmcdHeadersFactory.STREAMING_FORMAT_SS, "");
        }
    }
    ...
    private void f() {
        ...
        synchronized (this.h) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                Set set = sparseArray.get(sparseArray.keyAt(i2));
                if (set != null) {
