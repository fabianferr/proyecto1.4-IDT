...
public class c {
    ...
    private boolean a(java.util.List<com.bytedance.sdk.component.adexpress.a.c.a.C0043a> r6) {
        /*
            r5 = this;
            r0 = 0
        ...
        L_0x000e:
            ...
            com.bytedance.sdk.component.adexpress.a.c.a$a r1 = (com.bytedance.sdk.component.adexpress.a.c.a.C0043a) r1
    ...
    public void a(boolean z) {
        ...
        try {
            ...
            boolean z2 = true;
            this.d.set(true);
            com.bytedance.sdk.component.adexpress.a.c.a e2 = com.bytedance.sdk.component.adexpress.a.a.a.a().c().e();
            com.bytedance.sdk.component.adexpress.a.c.a b2 = f.b();
            if (e2 != null) {
                if (e2.f()) {
                    boolean b3 = f.b(e2.b());
    ...
    private List<a.C0043a> a(com.bytedance.sdk.component.adexpress.a.c.a aVar, com.bytedance.sdk.component.adexpress.a.c.a aVar2) {
        String str;
        int i;
        ArrayList arrayList = new ArrayList();
        ArrayList<a.C0043a> arrayList2 = new ArrayList<>();
        ...
        if (aVar2 == null || aVar2.e().isEmpty()) {
            ...
            for (a.C0043a next : aVar.e()) {
                if (!aVar2.e().contains(next)) {
                    arrayList2.add(next);
                } else {
                    a.C0043a a2 = f.a(next.a());
                    if (!(a2 == null || next.b() == null || next.b().equals(a2.b()))) {
                        arrayList2.add(next);
                    }
                }
            }
            for (a.C0043a next2 : aVar2.e()) {
    ...
    private void b(List<a.C0043a> list) {
        if (list != null && !list.isEmpty()) {
            for (a.C0043a a2 : list) {
    ...
    private void c(List<a.C0043a> list) {
        if (list != null && !list.isEmpty()) {
            for (a.C0043a a2 : list) {
                File file = new File(f(), com.bytedance.sdk.component.utils.e.a(a2.a()));
                File file2 = new File(file + ".tmp");
