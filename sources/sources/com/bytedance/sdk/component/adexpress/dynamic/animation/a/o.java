...
public class o extends d {
    ...
    public List<ObjectAnimator> a() {
        ObjectAnimator duration = ObjectAnimator.ofFloat(this.c, "translationX", new float[]{0.0f, e.a(d.a(), 20.0f), 0.0f, -e.a(d.a(), 20.0f), 0.0f}).setDuration((long) ((int) (this.b.j() * 1000.0d)));
