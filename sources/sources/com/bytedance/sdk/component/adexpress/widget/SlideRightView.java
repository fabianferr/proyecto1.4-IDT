...
public class SlideRightView extends FrameLayout {
    ...
    private void b() {
        ...
        this.d = imageView;
        imageView.setBackgroundResource(s.d(this.a, "tt_splash_slide_right_bg"));
        ...
        this.c = imageView2;
        imageView2.setImageResource(s.d(this.a, "tt_splash_slide_right_circle"));
        FrameLayout.LayoutParams layoutParams2 = new FrameLayout.LayoutParams((int) e.a(this.a, 50.0f), (int) e.a(this.a, 50.0f));
        layoutParams2.gravity = 48;
        addView(this.c, layoutParams2);
        ImageView imageView3 = new ImageView(this.a);
        this.b = imageView3;
        imageView3.setImageResource(s.d(this.a, "tt_splash_hand2"));
        FrameLayout.LayoutParams layoutParams3 = new FrameLayout.LayoutParams((int) e.a(this.a, 80.0f), (int) e.a(this.a, 80.0f));
        ...
        post(new Runnable() {
            public void run() {
                ...
                layoutParams.topMargin = (int) ((((float) SlideRightView.this.c.getMeasuredHeight()) / 2.0f) - e.a(SlideRightView.this.getContext(), 7.0f));
                ...
                layoutParams2.topMargin = (int) ((((float) SlideRightView.this.c.getMeasuredHeight()) / 2.0f) - e.a(SlideRightView.this.getContext(), 5.0f));
    ...
    private void c() {
        ...
        ObjectAnimator ofFloat5 = ObjectAnimator.ofFloat(this.b, "translationX", new float[]{0.0f, e.a(getContext(), 80.0f)});
        ofFloat5.setInterpolator(b.a(0.2f, 0.0f, 0.3f, 1.0f));
        ValueAnimator ofInt = ValueAnimator.ofInt(new int[]{0, (int) e.a(getContext(), 80.0f)});
        ...
        ObjectAnimator ofFloat6 = ObjectAnimator.ofFloat(this.c, "translationX", new float[]{0.0f, e.a(getContext(), 80.0f)});
