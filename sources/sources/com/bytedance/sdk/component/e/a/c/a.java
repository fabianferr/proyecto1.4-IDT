...
public class a {
    ...
    public static synchronized int d(com.bytedance.sdk.component.e.a.d.a r3) {
        /*
            ...
            org.json.JSONObject r2 = r3.g()     // Catch:{ all -> 0x0032 }
            if (r2 != 0) goto L_0x000d
            goto L_0x0035
        L_0x000d:
            boolean r2 = e()     // Catch:{ all -> 0x0032 }
            if (r2 != 0) goto L_0x0015
            monitor-exit(r0)
            return r1
        L_0x0015:
            org.json.JSONObject r3 = r3.g()     // Catch:{ Exception -> 0x002c }
            java.lang.String r2 = "ad_extra_data"
            java.lang.String r3 = r3.optString(r2)     // Catch:{ Exception -> 0x002c }
            ...
            int r3 = r2.optInt(r3)     // Catch:{ Exception -> 0x002c }
            monitor-exit(r0)
            return r3
        L_0x002c:
            r3 = move-exception
    ...
    public static void a(JSONObject jSONObject, com.bytedance.sdk.component.e.a.d.a.a aVar) {
        f m = i.e().m();
        if (m != null && m.b() && c()) {
            c.a("log_show_query :" + jSONObject.optString("label") + " " + aVar.e());
        }
    }
    ...
    public static void a(List<com.bytedance.sdk.component.e.a.d.a> list, int i2, String str) {
        ...
        if (m != null && m.b() && list != null && !b()) {
            ...
            if (z) {
                c.c(ThroughputConfigUtil.UPLOAD_TAG, "ads:" + sb + a(i2) + "," + str + ",total:" + list.size());
                return;
            }
            c.c(ThroughputConfigUtil.UPLOAD_TAG, "stats:" + sb + a(i2) + "," + str + ",total:" + list.size());
        }
    }
                ...
                if (m != null && m.b()) {
                    if (aVar.d() == 1) {
                        ...
                        if (aVar.b() != 3) {
                            ...
                            long i2 = i(aVar);
                            if (i2 != 0) {
                                sb.append("v1_core [label:");
                                sb.append(a(aVar));
                            } else {
                                sb.append("v1_debug [label:");
                                sb.append(a(aVar));
                            }
                            long h2 = h(aVar);
                            if (h2 != 0) {
                            ...
                            StringBuilder sb2 = new StringBuilder("v3,[label:");
