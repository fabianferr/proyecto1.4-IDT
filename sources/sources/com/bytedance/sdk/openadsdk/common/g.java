...
public class g {
    ...
    private void c() {
        this.f = (ImageView) this.a.findViewById(i.ai);
        this.g = (ImageView) this.a.findViewById(i.aj);
        ...
        ((ImageView) this.a.findViewById(i.ak)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (g.this.b != null) {
                    g.this.b("refresh");
                    g.this.b.d();
        ...
        ((ImageView) this.a.findViewById(i.al)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (g.this.b != null) {
    ...
    public void a(String str) {
        ...
        c.c(this.c, this.d, str, jSONObject);
    }
