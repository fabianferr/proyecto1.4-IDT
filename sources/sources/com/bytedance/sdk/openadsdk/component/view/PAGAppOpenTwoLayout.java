...
public class PAGAppOpenTwoLayout extends PAGAppOpenBaseLayout {
    public PAGAppOpenTwoLayout(Context context) {
        ...
        int b = ad.b(context, 8.0f);
        int b2 = ad.b(context, 9.0f);
        ...
        RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(ad.b(context, 31.0f), ad.b(context, 14.0f));
