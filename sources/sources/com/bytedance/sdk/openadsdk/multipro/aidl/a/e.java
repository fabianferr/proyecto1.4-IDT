...
public class e extends a {
    private static final Map<String, RemoteCallbackList<IFullScreenVideoAdInteractionListener>> a = Collections.synchronizedMap(new HashMap());
    ...
    private synchronized void a(String str, String str2) {
        ...
        try {
            Map<String, RemoteCallbackList<IFullScreenVideoAdInteractionListener>> map = a;
            if (map != null) {
