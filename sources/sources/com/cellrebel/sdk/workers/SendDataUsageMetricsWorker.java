...
public class SendDataUsageMetricsWorker extends BaseMetricsWorker {
    ...
    class a implements Runnable {
        ...
        public void run() {
            if (SendDataUsageMetricsWorker.this.k != null && !SendDataUsageMetricsWorker.this.k.isCanceled()) {
                SendDataUsageMetricsWorker.this.k.cancel();
            }
        }
    }
    ...
    class b implements Callback<Void> {
        ...
        final /* synthetic */ DataUsageMetricDAO c;
        final /* synthetic */ List d;

        b(HandlerThread handlerThread, Handler handler, DataUsageMetricDAO dataUsageMetricDAO, List list) {
        ...
        /* access modifiers changed from: private */
        public /* synthetic */ String a(Handler handler, Throwable th, List list, DataUsageMetricDAO dataUsageMetricDAO) {
            ...
            SendDataUsageMetricsWorker.this.j.countDown();
            return null;
        }

        /* access modifiers changed from: private */
        public /* synthetic */ String a(Handler handler, Response response, DataUsageMetricDAO dataUsageMetricDAO, List list) {
            handler.removeCallbacksAndMessages((Object) null);
        ...
        public void onFailure(Call<Void> call, Throwable th) {
            this.a.quit();
            try {
                ThreadPoolProvider.a().a(new SendDataUsageMetricsWorker$b$$ExternalSyntheticLambda0(this, this.b, th, this.d, this.c));
        ...
        public void onResponse(Call<Void> call, Response<Void> response) {
            this.a.quit();
            try {
                ThreadPoolProvider.a().a(new SendDataUsageMetricsWorker$b$$ExternalSyntheticLambda1(this, this.b, response, this.c, this.d));
            } catch (Exception | OutOfMemoryError unused) {
            }
        }
    }
    ...
    public void a(android.content.Context r8) {
        ...
        L_0x0007:
            com.cellrebel.sdk.database.SDKRoomDatabase r8 = com.cellrebel.sdk.database.DatabaseClient.a()     // Catch:{  }
            com.cellrebel.sdk.database.dao.DataUsageMetricDAO r4 = r8.f()     // Catch:{  }
        ...
        L_0x001e:
            ...
            com.cellrebel.sdk.networking.beans.request.DataUsageMetric r0 = (com.cellrebel.sdk.networking.beans.request.DataUsageMetric) r0     // Catch:{  }
            r1 = 1
            r0.isSending(r1)     // Catch:{  }
            goto L_0x001e
        L_0x002f:
            r4.a((java.util.List<com.cellrebel.sdk.networking.beans.request.DataUsageMetric>) r5)     // Catch:{  }
            ...
            r3.<init>(r8)     // Catch:{  }
            com.cellrebel.sdk.workers.SendDataUsageMetricsWorker$a r8 = new com.cellrebel.sdk.workers.SendDataUsageMetricsWorker$a     // Catch:{  }
            r8.<init>()     // Catch:{  }
            ...
            retrofit2.Call r8 = r0.j(r5, r8)     // Catch:{  }
            r7.k = r8     // Catch:{  }
            com.cellrebel.sdk.workers.SendDataUsageMetricsWorker$b r6 = new com.cellrebel.sdk.workers.SendDataUsageMetricsWorker$b     // Catch:{  }
            r0 = r6
            r1 = r7
        ...
        L_0x0077:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.cellrebel.sdk.workers.SendDataUsageMetricsWorker.a(android.content.Context):void");
    }
}
