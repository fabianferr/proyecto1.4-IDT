...
public final class FacebookSdk {
    ...
    public static final GraphRequest m229graphRequestCreator$lambda0(AccessToken accessToken, String str, JSONObject jSONObject, GraphRequest.Callback callback) {
    ...
    public static final synchronized void sdkInitialize(android.content.Context r4, com.facebook.FacebookSdk.InitializeCallback r5) {
        /*
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r4, r1)     // Catch:{ all -> 0x0100 }
            java.util.concurrent.atomic.AtomicBoolean r1 = sdkInitialized     // Catch:{ all -> 0x0100 }
            boolean r2 = r1.get()     // Catch:{ all -> 0x0100 }
            if (r2 == 0) goto L_0x0018
            if (r5 != 0) goto L_0x0013
            goto L_0x0016
        L_0x0013:
            r5.onInitialized()     // Catch:{ all -> 0x0100 }
        L_0x0016:
            monitor-exit(r0)
            return
        L_0x0018:
            com.facebook.internal.Validate r2 = com.facebook.internal.Validate.INSTANCE     // Catch:{ all -> 0x0100 }
            r2 = 0
            com.facebook.internal.Validate.hasFacebookActivity(r4, r2)     // Catch:{ all -> 0x0100 }
            com.facebook.internal.Validate r3 = com.facebook.internal.Validate.INSTANCE     // Catch:{ all -> 0x0100 }
            com.facebook.internal.Validate.hasInternetPermissions(r4, r2)     // Catch:{ all -> 0x0100 }
            android.content.Context r2 = r4.getApplicationContext()     // Catch:{ all -> 0x0100 }
            java.lang.String r3 = "applicationContext.applicationContext"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r3)     // Catch:{ all -> 0x0100 }
            applicationContext = r2     // Catch:{ all -> 0x0100 }
            com.facebook.appevents.AppEventsLogger$Companion r2 = com.facebook.appevents.AppEventsLogger.Companion     // Catch:{ all -> 0x0100 }
            r2.getAnonymousAppDeviceGUID(r4)     // Catch:{ all -> 0x0100 }
            android.content.Context r4 = applicationContext     // Catch:{ all -> 0x0100 }
            r2 = 0
            if (r4 == 0) goto L_0x00fa
            loadDefaultsFromMetadata$facebook_core_release(r4)     // Catch:{ all -> 0x0100 }
            com.facebook.internal.Utility r4 = com.facebook.internal.Utility.INSTANCE     // Catch:{ all -> 0x0100 }
            java.lang.String r4 = applicationId     // Catch:{ all -> 0x0100 }
            boolean r4 = com.facebook.internal.Utility.isNullOrEmpty((java.lang.String) r4)     // Catch:{ all -> 0x0100 }
            if (r4 != 0) goto L_0x00f2
            r4 = 1
            r1.set(r4)     // Catch:{ all -> 0x0100 }
            boolean r4 = getAutoInitEnabled()     // Catch:{ all -> 0x0100 }
            if (r4 == 0) goto L_0x0052
            fullyInitialize()     // Catch:{ all -> 0x0100 }
        L_0x0052:
            android.content.Context r4 = applicationContext     // Catch:{ all -> 0x0100 }
            if (r4 == 0) goto L_0x00ec
            boolean r4 = r4 instanceof android.app.Application     // Catch:{ all -> 0x0100 }
            if (r4 == 0) goto L_0x0076
            com.facebook.UserSettingsManager r4 = com.facebook.UserSettingsManager.INSTANCE     // Catch:{ all -> 0x0100 }
            boolean r4 = com.facebook.UserSettingsManager.getAutoLogAppEventsEnabled()     // Catch:{ all -> 0x0100 }
            if (r4 == 0) goto L_0x0076
            com.facebook.appevents.internal.ActivityLifecycleTracker r4 = com.facebook.appevents.internal.ActivityLifecycleTracker.INSTANCE     // Catch:{ all -> 0x0100 }
            android.content.Context r4 = applicationContext     // Catch:{ all -> 0x0100 }
            if (r4 == 0) goto L_0x0070
            android.app.Application r4 = (android.app.Application) r4     // Catch:{ all -> 0x0100 }
            java.lang.String r1 = applicationId     // Catch:{ all -> 0x0100 }
            com.facebook.appevents.internal.ActivityLifecycleTracker.startTracking(r4, r1)     // Catch:{ all -> 0x0100 }
            goto L_0x0076
        L_0x0070:
            java.lang.String r4 = "applicationContext"
            kotlin.jvm.internal.Intrinsics.throwUninitializedPropertyAccessException(r4)     // Catch:{ all -> 0x0100 }
            throw r2     // Catch:{ all -> 0x0100 }
        L_0x0076:
            com.facebook.internal.FetchedAppSettingsManager r4 = com.facebook.internal.FetchedAppSettingsManager.INSTANCE     // Catch:{ all -> 0x0100 }
            com.facebook.internal.FetchedAppSettingsManager.loadAppSettingsAsync()     // Catch:{ all -> 0x0100 }
            com.facebook.internal.NativeProtocol r4 = com.facebook.internal.NativeProtocol.INSTANCE     // Catch:{ all -> 0x0100 }
            com.facebook.internal.NativeProtocol.updateAllAvailableProtocolVersionsAsync()     // Catch:{ all -> 0x0100 }
            com.facebook.internal.BoltsMeasurementEventListener$Companion r4 = com.facebook.internal.BoltsMeasurementEventListener.Companion     // Catch:{ all -> 0x0100 }
            android.content.Context r1 = applicationContext     // Catch:{ all -> 0x0100 }
            if (r1 == 0) goto L_0x00e6
            r4.getInstance(r1)     // Catch:{ all -> 0x0100 }
            com.facebook.internal.LockOnGetVariable r4 = new com.facebook.internal.LockOnGetVariable     // Catch:{ all -> 0x0100 }
            com.facebook.FacebookSdk$$ExternalSyntheticLambda1 r1 = new com.facebook.FacebookSdk$$ExternalSyntheticLambda1     // Catch:{ all -> 0x0100 }
            r1.<init>()     // Catch:{ all -> 0x0100 }
            r4.<init>(r1)     // Catch:{ all -> 0x0100 }
            cacheDir = r4     // Catch:{ all -> 0x0100 }
            com.facebook.internal.FeatureManager r4 = com.facebook.internal.FeatureManager.INSTANCE     // Catch:{ all -> 0x0100 }
            com.facebook.internal.FeatureManager$Feature r4 = com.facebook.internal.FeatureManager.Feature.Instrument     // Catch:{ all -> 0x0100 }
            com.facebook.FacebookSdk$$ExternalSyntheticLambda2 r1 = new com.facebook.FacebookSdk$$ExternalSyntheticLambda2     // Catch:{ all -> 0x0100 }
            r1.<init>()     // Catch:{ all -> 0x0100 }
            com.facebook.internal.FeatureManager.checkFeature(r4, r1)     // Catch:{ all -> 0x0100 }
            com.facebook.internal.FeatureManager r4 = com.facebook.internal.FeatureManager.INSTANCE     // Catch:{ all -> 0x0100 }
            com.facebook.internal.FeatureManager$Feature r4 = com.facebook.internal.FeatureManager.Feature.AppEvents     // Catch:{ all -> 0x0100 }
            com.facebook.FacebookSdk$$ExternalSyntheticLambda3 r1 = new com.facebook.FacebookSdk$$ExternalSyntheticLambda3     // Catch:{ all -> 0x0100 }
            r1.<init>()     // Catch:{ all -> 0x0100 }
            com.facebook.internal.FeatureManager.checkFeature(r4, r1)     // Catch:{ all -> 0x0100 }
            com.facebook.internal.FeatureManager r4 = com.facebook.internal.FeatureManager.INSTANCE     // Catch:{ all -> 0x0100 }
            com.facebook.internal.FeatureManager$Feature r4 = com.facebook.internal.FeatureManager.Feature.ChromeCustomTabsPrefetching     // Catch:{ all -> 0x0100 }
            com.facebook.FacebookSdk$$ExternalSyntheticLambda4 r1 = new com.facebook.FacebookSdk$$ExternalSyntheticLambda4     // Catch:{ all -> 0x0100 }
            r1.<init>()     // Catch:{ all -> 0x0100 }
            com.facebook.internal.FeatureManager.checkFeature(r4, r1)     // Catch:{ all -> 0x0100 }
            com.facebook.internal.FeatureManager r4 = com.facebook.internal.FeatureManager.INSTANCE     // Catch:{ all -> 0x0100 }
            com.facebook.internal.FeatureManager$Feature r4 = com.facebook.internal.FeatureManager.Feature.IgnoreAppSwitchToLoggedOut     // Catch:{ all -> 0x0100 }
            com.facebook.FacebookSdk$$ExternalSyntheticLambda5 r1 = new com.facebook.FacebookSdk$$ExternalSyntheticLambda5     // Catch:{ all -> 0x0100 }
            r1.<init>()     // Catch:{ all -> 0x0100 }
            com.facebook.internal.FeatureManager.checkFeature(r4, r1)     // Catch:{ all -> 0x0100 }
            com.facebook.internal.FeatureManager r4 = com.facebook.internal.FeatureManager.INSTANCE     // Catch:{ all -> 0x0100 }
            com.facebook.internal.FeatureManager$Feature r4 = com.facebook.internal.FeatureManager.Feature.BypassAppSwitch     // Catch:{ all -> 0x0100 }
            com.facebook.FacebookSdk$$ExternalSyntheticLambda6 r1 = new com.facebook.FacebookSdk$$ExternalSyntheticLambda6     // Catch:{ all -> 0x0100 }
            r1.<init>()     // Catch:{ all -> 0x0100 }
            com.facebook.internal.FeatureManager.checkFeature(r4, r1)     // Catch:{ all -> 0x0100 }
            java.util.concurrent.FutureTask r4 = new java.util.concurrent.FutureTask     // Catch:{ all -> 0x0100 }
            com.facebook.FacebookSdk$$ExternalSyntheticLambda7 r1 = new com.facebook.FacebookSdk$$ExternalSyntheticLambda7     // Catch:{ all -> 0x0100 }
            r1.<init>(r5)     // Catch:{ all -> 0x0100 }
            r4.<init>(r1)     // Catch:{ all -> 0x0100 }
            java.util.concurrent.Executor r5 = getExecutor()     // Catch:{ all -> 0x0100 }
            java.lang.Runnable r4 = (java.lang.Runnable) r4     // Catch:{ all -> 0x0100 }
            r5.execute(r4)     // Catch:{ all -> 0x0100 }
            monitor-exit(r0)
            return
        L_0x00e6:
            java.lang.String r4 = "applicationContext"
        ...
        L_0x00ec:
            ...
            throw r2     // Catch:{ all -> 0x0100 }
        L_0x00f2:
            com.facebook.FacebookException r4 = new com.facebook.FacebookException     // Catch:{ all -> 0x0100 }
            ...
            r4.<init>((java.lang.String) r5)     // Catch:{ all -> 0x0100 }
    ...
    public static final File m231sdkInitialize$lambda3() {
    ...
    public static final void m232sdkInitialize$lambda4(boolean z) {
        if (z) {
    ...
    public static final void m233sdkInitialize$lambda5(boolean z) {
        if (z) {
    ...
    public static final void m234sdkInitialize$lambda6(boolean z) {
        if (z) {
    ...
    public static final void m235sdkInitialize$lambda7(boolean z) {
        if (z) {
    ...
    public static final void m236sdkInitialize$lambda8(boolean z) {
        if (z) {
    ...
    public static final Void m237sdkInitialize$lambda9(InitializeCallback initializeCallback) {
    ...
    public static final void m230publishInstallAsync$lambda15(Context context, String str) {
        Intrinsics.checkNotNullParameter(str, "$applicationId");
