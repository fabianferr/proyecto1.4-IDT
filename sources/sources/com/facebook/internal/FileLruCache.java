...
public final class FileLruCache {
    ...
    public final InputStream get(String str) throws IOException {
        Intrinsics.checkNotNullParameter(str, HEADER_CACHEKEY_KEY);
    ...
    public final java.io.InputStream get(java.lang.String r9, java.lang.String r10) throws java.io.IOException {
        /*
            ...
            r2.<init>(r3, r4)
            r3 = 0
            java.io.FileInputStream r4 = new java.io.FileInputStream     // Catch:{ IOException -> 0x008d }
            r4.<init>(r2)     // Catch:{ IOException -> 0x008d }
            java.io.BufferedInputStream r5 = new java.io.BufferedInputStream
            java.io.InputStream r4 = (java.io.InputStream) r4
            r6 = 8192(0x2000, float:1.14794E-41)
            r5.<init>(r4, r6)
            r4 = 0
            com.facebook.internal.FileLruCache$StreamHeader r6 = com.facebook.internal.FileLruCache.StreamHeader.INSTANCE     // Catch:{ all -> 0x0086 }
            r7 = r5
            java.io.InputStream r7 = (java.io.InputStream) r7     // Catch:{ all -> 0x0086 }
            org.json.JSONObject r6 = r6.readHeader(r7)     // Catch:{ all -> 0x0086 }
            if (r6 != 0) goto L_0x0033
            r5.close()
            return r3
        L_0x0033:
            java.lang.String r1 = r6.optString(r1)     // Catch:{ all -> 0x0086 }
            boolean r9 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r1, (java.lang.Object) r9)     // Catch:{ all -> 0x0086 }
            if (r9 != 0) goto L_0x0041
            r5.close()
            return r3
        L_0x0041:
            java.lang.String r9 = "tag"
            java.lang.String r9 = r6.optString(r9, r3)     // Catch:{ all -> 0x0086 }
            if (r10 != 0) goto L_0x0053
            boolean r9 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r10, (java.lang.Object) r9)     // Catch:{ all -> 0x0086 }
            if (r9 != 0) goto L_0x0053
            r5.close()
            return r3
        L_0x0053:
            java.util.Date r9 = new java.util.Date     // Catch:{ all -> 0x0086 }
            r9.<init>()     // Catch:{ all -> 0x0086 }
            long r9 = r9.getTime()     // Catch:{ all -> 0x0086 }
            com.facebook.internal.Logger$Companion r1 = com.facebook.internal.Logger.Companion     // Catch:{ all -> 0x0086 }
            com.facebook.LoggingBehavior r3 = com.facebook.LoggingBehavior.CACHE     // Catch:{ all -> 0x0086 }
            ...
            r7.append(r9)     // Catch:{ all -> 0x0086 }
            java.lang.String r0 = " for "
            r7.append(r0)     // Catch:{ all -> 0x0086 }
            java.lang.String r0 = r2.getName()     // Catch:{ all -> 0x0086 }
            r7.append(r0)     // Catch:{ all -> 0x0086 }
            java.lang.String r0 = r7.toString()     // Catch:{ all -> 0x0086 }
            r1.log(r3, r6, r0)     // Catch:{ all -> 0x0086 }
            r2.setLastModified(r9)     // Catch:{ all -> 0x0086 }
            java.io.InputStream r5 = (java.io.InputStream) r5     // Catch:{ all -> 0x0083 }
            return r5
        L_0x0083:
            r9 = move-exception
            r4 = 1
    ...
    public static final void m1931clearCache$lambda1(File[] fileArr) {
    ...
    public static final void m1932postTrim$lambda3$lambda2(FileLruCache fileLruCache) {
    ...
    private static final class BufferFile {
        ...
        public static final boolean m1933filterExcludeBufferFiles$lambda0(File file, String str) {
        ...
        public static final boolean m1934filterExcludeNonBufferFiles$lambda1(File file, String str) {
            Intrinsics.checkNotNullExpressionValue(str, "filename");
            return StringsKt.startsWith$default(str, FILE_NAME_PREFIX, false, 2, (Object) null);
        }
