...
public final class ImageDownloader {
    ...
    public static final void m1935issueResponse$lambda4(ImageRequest imageRequest, Exception exc, boolean z, Bitmap bitmap, ImageRequest.Callback callback) {
        Intrinsics.checkNotNullParameter(imageRequest, "$request");
    ...
    public final void download(com.facebook.internal.ImageDownloader.RequestKey r11) {
        /*
            ...
            r3.setInstanceFollowRedirects(r0)     // Catch:{ IOException -> 0x00c8, all -> 0x00c6 }
        ...
        L_0x003f:
            int r9 = r6.read(r8, r0, r7)     // Catch:{ IOException -> 0x0063 }
            if (r9 <= 0) goto L_0x0049
            r5.append(r8, r0, r9)     // Catch:{ IOException -> 0x0063 }
            goto L_0x003f
        L_0x0049:
        ...
        L_0x0066:
            ...
            r10.enqueueCacheRead(r4, r5, r0)     // Catch:{ IOException -> 0x00a6, all -> 0x00c6 }
        L_0x00a2:
            r5 = r1
            r6 = r5
            r2 = 0
