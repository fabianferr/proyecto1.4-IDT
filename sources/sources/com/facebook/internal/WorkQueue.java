...
public final class WorkQueue {
    ...
    public static final class Companion {
        ...
        public final void m1948assert(boolean z) {
            if (!z) {
    ...
    public static final void m1947execute$lambda2(WorkNode workNode, WorkQueue workQueue) {
    ...
    private final class WorkNode implements WorkItem {
        ...
        public final WorkNode addToList(WorkNode workNode, boolean z) {
            boolean z2 = true;
            WorkQueue.Companion.m1948assert(this.next == null);
            Companion companion = WorkQueue.Companion;
            if (this.prev != null) {
                z2 = false;
            }
            companion.m1948assert(z2);
            if (workNode == null) {
                this.prev = this;
                this.next = this;
                workNode = this;
