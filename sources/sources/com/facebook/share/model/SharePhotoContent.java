...
public final class SharePhotoContent extends ShareContent<SharePhotoContent, Builder> {
    ...
    public SharePhotoContent(Parcel parcel) {
        ...
        List<SharePhoto> readPhotoListFrom = SharePhoto.Builder.readPhotoListFrom(parcel);
        Intrinsics.checkNotNullExpressionValue(readPhotoListFrom, "readPhotoListFrom(parcel)");
        this.photos = CollectionsKt.toList(readPhotoListFrom);
    }
    ...
    public static final class Builder extends ShareContent.Builder<SharePhotoContent, Builder> {
        ...
        public final Builder addPhoto(SharePhoto sharePhoto) {
            if (sharePhoto != null) {
                ...
                SharePhoto build = new SharePhoto.Builder().readFrom(sharePhoto).build();
                Intrinsics.checkNotNullExpressionValue(build, "Builder().readFrom(photo).build()");
                list.add(build);
            }
            return this;
        }
