    ...
    public Task<NonceManager> loadNonceManager(NonceRequest nonceRequest) {
        ...
        try {
            ...
            if (!(zzg2 == null || zzh2 == null)) {
                zzjb.zza(zzak.ORIENTATION.zza(), zzg2.intValue() <= zzh2.intValue() ? CmcdHeadersFactory.STREAM_TYPE_LIVE : "p");
            }
            Boolean zzd2 = nonceRequest.zzd();
            if (zzd2 != null) {
                zzjb.zza(zzak.PLAY_ACTIVATION.zza(), true != zzd2.booleanValue() ? CampaignEx.JSON_NATIVE_VIDEO_CLICK : "auto");
            }
            String str2 = "0";
            String str3 = "1";
