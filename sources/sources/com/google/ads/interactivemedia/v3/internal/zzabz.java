...
public final class zzabz {
    ...
    public static java.util.Date zza(java.lang.String r17, java.text.ParsePosition r18) throws java.text.ParseException {
        /*
            ...
            int r3 = r0 + 4
            int r0 = zzb(r1, r0, r3)     // Catch:{ IndexOutOfBoundsException -> 0x01da, NumberFormatException -> 0x01d8, IllegalArgumentException -> 0x01d6 }
            r4 = 45
            boolean r5 = zzc(r1, r3, r4)     // Catch:{ IndexOutOfBoundsException -> 0x01da, NumberFormatException -> 0x01d8, IllegalArgumentException -> 0x01d6 }
            if (r5 == 0) goto L_0x0018
            int r3 = r3 + 1
        L_0x0018:
            int r5 = r3 + 2
            int r3 = zzb(r1, r3, r5)     // Catch:{ IndexOutOfBoundsException -> 0x01da, NumberFormatException -> 0x01d8, IllegalArgumentException -> 0x01d6 }
            boolean r6 = zzc(r1, r5, r4)     // Catch:{ IndexOutOfBoundsException -> 0x01da, NumberFormatException -> 0x01d8, IllegalArgumentException -> 0x01d6 }
            if (r6 == 0) goto L_0x0026
            int r5 = r5 + 1
        L_0x0026:
            int r6 = r5 + 2
            int r5 = zzb(r1, r5, r6)     // Catch:{ IndexOutOfBoundsException -> 0x01da, NumberFormatException -> 0x01d8, IllegalArgumentException -> 0x01d6 }
            r7 = 84
            boolean r7 = zzc(r1, r6, r7)     // Catch:{ IndexOutOfBoundsException -> 0x01da, NumberFormatException -> 0x01d8, IllegalArgumentException -> 0x01d6 }
            r8 = 0
        ...
        L_0x004d:
            ...
            int r6 = r6 + 1
            int r7 = r6 + 2
            int r6 = zzb(r1, r6, r7)     // Catch:{ IndexOutOfBoundsException -> 0x01da, NumberFormatException -> 0x01d8, IllegalArgumentException -> 0x01d6 }
            r13 = 58
            boolean r14 = zzc(r1, r7, r13)     // Catch:{ IndexOutOfBoundsException -> 0x01da, NumberFormatException -> 0x01d8, IllegalArgumentException -> 0x01d6 }
            if (r14 == 0) goto L_0x0067
            int r7 = r7 + 1
        L_0x0067:
            int r14 = r7 + 2
            int r7 = zzb(r1, r7, r14)     // Catch:{ IndexOutOfBoundsException -> 0x01da, NumberFormatException -> 0x01d8, IllegalArgumentException -> 0x01d6 }
            boolean r13 = zzc(r1, r14, r13)     // Catch:{ IndexOutOfBoundsException -> 0x01da, NumberFormatException -> 0x01d8, IllegalArgumentException -> 0x01d6 }
        ...
        L_0x0075:
            ...
            int r13 = r14 + 2
            int r14 = zzb(r1, r14, r13)     // Catch:{ IndexOutOfBoundsException -> 0x01da, NumberFormatException -> 0x01d8, IllegalArgumentException -> 0x01d6 }
            r15 = 59
        ...
        L_0x0095:
            r15 = 46
            boolean r15 = zzc(r1, r13, r15)     // Catch:{ IndexOutOfBoundsException -> 0x01da, NumberFormatException -> 0x01d8, IllegalArgumentException -> 0x01d6 }
        ...
        L_0x00be:
            ...
            int r8 = zzb(r1, r13, r4)     // Catch:{ IndexOutOfBoundsException -> 0x01da, NumberFormatException -> 0x01d8, IllegalArgumentException -> 0x01d6 }
            int r4 = r4 - r13
        ...
        L_0x00e1:
            ...
            java.util.TimeZone r9 = zza     // Catch:{ IndexOutOfBoundsException -> 0x01da, NumberFormatException -> 0x01d8, IllegalArgumentException -> 0x01d6 }
            int r6 = r6 + r12
            goto L_0x019c
        L_0x00f3:
        ...
        L_0x0147:
            ...
            r10.append(r9)     // Catch:{ IndexOutOfBoundsException -> 0x01da, NumberFormatException -> 0x01d8, IllegalArgumentException -> 0x01d6 }
            java.lang.String r9 = r10.toString()     // Catch:{ IndexOutOfBoundsException -> 0x01da, NumberFormatException -> 0x01d8, IllegalArgumentException -> 0x01d6 }
            java.util.TimeZone r10 = java.util.TimeZone.getTimeZone(r9)     // Catch:{ IndexOutOfBoundsException -> 0x01da, NumberFormatException -> 0x01d8, IllegalArgumentException -> 0x01d6 }
