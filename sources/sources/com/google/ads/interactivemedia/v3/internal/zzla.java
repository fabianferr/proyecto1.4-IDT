...
public final class zzla implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, Application.ActivityLifecycleCallbacks {
    ...
    public zzla(Context context, zzkm zzkm) {
    ...
    private final void zzh(View view) {
        ...
        if (this.zzf == null) {
            ...
            this.zzf = zzkz;
            this.zzb.registerReceiver(zzkz, intentFilter);
        }
    ...
    private final void zzi(android.view.View r4) {
        ...
        L_0x0038:
            ...
            com.google.ads.interactivemedia.v3.internal.zzki r0 = r3.zzj     // Catch:{ Exception -> 0x0041 }
            r4.unregisterActivityLifecycleCallbacks(r0)     // Catch:{ Exception -> 0x0041 }
        L_0x0041:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.ads.interactivemedia.v3.internal.zzla.zzi(android.view.View):void");
    }
