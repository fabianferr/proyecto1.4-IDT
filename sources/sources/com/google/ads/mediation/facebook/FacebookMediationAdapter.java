...
public class FacebookMediationAdapter extends RtbAdapter {
    ...
    static {
        Class<FacebookAdapter> cls = FacebookAdapter.class;
    }
    ...
    public VersionInfo getSDKVersionInfo() {
        ...
        Log.w(TAG, String.format("Unexpected SDK version format: %s.Returning 0.0.0 for SDK version.", new Object[]{"6.11.0"}));
        return new VersionInfo(0, 0, 0);
    }
