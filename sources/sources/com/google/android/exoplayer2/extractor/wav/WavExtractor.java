    ...
    private static final class PassthroughOutputWriter implements OutputWriter {
        ...
        public boolean sampleData(ExtractorInput extractorInput, long j) throws IOException {
            ...
            if (i4 > 0) {
                ...
                this.trackOutput.sampleMetadata(this.startTimeUs + Util.scaleLargeTimestamp(this.outputFrameCount, 1000000, (long) this.header.frameRateHz), 1, i5, i6, (TrackOutput.CryptoData) null);
