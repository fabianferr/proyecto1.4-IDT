...
final class AsynchronousMediaCodecCallback extends MediaCodec.Callback {
    ...
    public void flushAsync(Runnable runnable) {
        synchronized (this.lock) {
            ...
            ((Handler) Util.castNonNull(this.handler)).post(new AsynchronousMediaCodecCallback$$ExternalSyntheticLambda0(this, runnable));
        }
    }
    ...
    public void m2045lambda$flushAsync$0$comgoogleandroidexoplayer2mediacodecAsynchronousMediaCodecCallback(Runnable runnable) {
        synchronized (this.lock) {
