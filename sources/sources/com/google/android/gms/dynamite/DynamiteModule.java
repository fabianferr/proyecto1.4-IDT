...
public final class DynamiteModule {
    ...
    public static DynamiteModule load(Context context, VersionPolicy versionPolicy, String str) throws LoadingException {
        ...
        try {
            ...
            Log.i("DynamiteModule", "Considering local module " + str2 + CertificateUtil.DELIMITER + i2 + " and remote module " + str2 + CertificateUtil.DELIMITER + i3);
                ...
                if (!(i4 == 1 && selectModule.remoteVersion == 0)) {
                    if (i4 == -1) {
                        ...
                        try {
                            ...
                            if (i6 == 0 || versionPolicy2.selectModule(context2, str2, new zzo(i6, 0)).selection != -1) {
                        ...
                        throw new LoadingException(str4 + i4, (zzp) null);
                    }
                }
            }
            int i7 = selectModule.localVersion;
            int i8 = selectModule.remoteVersion;
            throw new LoadingException(str3 + str2 + " found. Local version is " + i7 + " and remote version is " + i8 + ".", (zzp) null);
        } finally {
            if (longValue == 0) {
                zzh.remove();
            } else {
