...
public final class zzajj {
                ...
                if (zza >= longValue) {
                    ...
                    if (allocate.getLong(8) == 2334950737559900225L && allocate.getLong(16) == 3617552046287187010L) {
                        ...
                        if (j3 < ((long) allocate.capacity()) || j3 > 2147483639) {
                            throw new zzajg("APK Signing Block size out of range: " + j3);
                        }
                        int i = (int) (8 + j3);
                        long j4 = zza - ((long) i);
                        if (j4 >= 0) {
                                            ...
                                            while (slice.hasRemaining()) {
                                                ...
                                                if (slice.remaining() >= 8) {
                                                    ...
                                                    if (j6 < 4 || j6 > 2147483647L) {
                                                        throw new zzajg("APK Signing Block entry #" + i2 + " size out of range: " + j6);
                                                    }
                                                    int i3 = (int) j6;
                                                    int position2 = slice.position() + i3;
                                                    if (i3 > slice.remaining()) {
                                                        throw new zzajg("APK Signing Block entry #" + i2 + " size out of range: " + i3 + ", available: " + slice.remaining());
                                                    } else if (slice.getInt() == 1896449818) {
                                                        long j7 = j2;
                                                        X509Certificate[][] zzl = zzl(randomAccessFile.getChannel(), new zzajf(zze(slice, i3 - 4), longValue2, zza, j2, byteBuffer2, (zzajb) null));
                            ...
                            throw new zzajg("APK Signing Block sizes in header and footer do not match: " + j5 + " vs " + j3);
                        }
                        throw new zzajg("APK Signing Block offset out of range: " + j4);
                    }
    ...
    private static byte[][] zzk(int[] iArr, zzajd[] zzajdArr) throws DigestException {
        ...
        while (true) {
            ...
            j3 += (zzajdArr[i3].zza() + 1048575) / PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED;
            i3++;
        }
        if (j3 < 2097151) {
            int i4 = (int) j3;
