        ...
        if (valueOf == null || zzl == null || valueOf.equals(zzl)) {
            ...
            if ("background".equals(str)) {
                ...
                if (equals || equals2) {
                    ...
                    int zzb4 = zzb(context, map, CmcdHeadersFactory.STREAMING_FORMAT_HLS, -1);
                    if (!((Boolean) zzay.zzc().zzb(zzbjc.zzcY)).booleanValue()) {
                        if (zze.zzc()) {
                ...
                if (zza3 == null) {
                    ...
                    String str10 = (String) map.get(MediaRouteProviderProtocol.CLIENT_DATA_VOLUME);
                    if (str10 == null) {
                ...
                } else if (MBridgeConstans.EXTRA_KEY_WM.equals(str)) {
                    zza3.zzn();
                } else {
