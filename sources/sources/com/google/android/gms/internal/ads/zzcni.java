...
final class zzcni extends WebView implements DownloadListener, ViewTreeObserver.OnGlobalLayoutListener, zzcmp {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:112:0x01ba A[SYNTHETIC, Splitter:B:112:0x01ba] */
    ...
    public final synchronized void onMeasure(int r10, int r11) {
        /*
            ...
            monitor-enter(r9)
            boolean r1 = r9.zzaB()     // Catch:{ all -> 0x01e0 }
            r2 = 0
            if (r1 == 0) goto L_0x000f
            r9.setMeasuredDimension(r2, r2)     // Catch:{ all -> 0x01e0 }
            monitor-exit(r9)
            return
        L_0x000f:
            boolean r1 = r9.isInEditMode()     // Catch:{ all -> 0x01e0 }
            if (r1 != 0) goto L_0x01db
            boolean r1 = r9.zzu     // Catch:{ all -> 0x01e0 }
            if (r1 != 0) goto L_0x01db
            com.google.android.gms.internal.ads.zzcoe r1 = r9.zzq     // Catch:{ all -> 0x01e0 }
            boolean r1 = r1.zzf()     // Catch:{ all -> 0x01e0 }
            if (r1 == 0) goto L_0x0023
            goto L_0x01db
        L_0x0023:
            com.google.android.gms.internal.ads.zzcoe r1 = r9.zzq     // Catch:{ all -> 0x01e0 }
            boolean r1 = r1.zzh()     // Catch:{ all -> 0x01e0 }
            if (r1 == 0) goto L_0x0030
            super.onMeasure(r10, r11)     // Catch:{ all -> 0x01e0 }
            monitor-exit(r9)
            return
        L_0x0030:
            com.google.android.gms.internal.ads.zzcoe r1 = r9.zzq     // Catch:{ all -> 0x01e0 }
            boolean r1 = r1.zzj()     // Catch:{ all -> 0x01e0 }
            if (r1 == 0) goto L_0x0097
            com.google.android.gms.internal.ads.zzbiu r0 = com.google.android.gms.internal.ads.zzbjc.zzcX     // Catch:{ all -> 0x01e0 }
            com.google.android.gms.internal.ads.zzbja r1 = com.google.android.gms.ads.internal.client.zzay.zzc()     // Catch:{ all -> 0x01e0 }
            java.lang.Object r0 = r1.zzb(r0)     // Catch:{ all -> 0x01e0 }
            java.lang.Boolean r0 = (java.lang.Boolean) r0     // Catch:{ all -> 0x01e0 }
            boolean r0 = r0.booleanValue()     // Catch:{ all -> 0x01e0 }
            if (r0 == 0) goto L_0x004f
            super.onMeasure(r10, r11)     // Catch:{ all -> 0x01e0 }
            monitor-exit(r9)
            return
        L_0x004f:
            com.google.android.gms.internal.ads.zzcnl r0 = r9.zzs()     // Catch:{ all -> 0x01e0 }
            r1 = 0
            if (r0 == 0) goto L_0x005b
            float r0 = r0.zze()     // Catch:{ all -> 0x01e0 }
            goto L_0x005c
        L_0x005b:
            r0 = 0
        L_0x005c:
            ...
            return
        L_0x0065:
            int r10 = android.view.View.MeasureSpec.getSize(r10)     // Catch:{ all -> 0x01e0 }
            int r11 = android.view.View.MeasureSpec.getSize(r11)     // Catch:{ all -> 0x01e0 }
            float r1 = (float) r11     // Catch:{ all -> 0x01e0 }
            float r1 = r1 * r0
            int r1 = (int) r1     // Catch:{ all -> 0x01e0 }
            float r3 = (float) r10     // Catch:{ all -> 0x01e0 }
            float r3 = r3 / r0
            int r3 = (int) r3     // Catch:{ all -> 0x01e0 }
            if (r11 != 0) goto L_0x0080
            if (r3 == 0) goto L_0x007f
            float r11 = (float) r3     // Catch:{ all -> 0x01e0 }
            float r11 = r11 * r0
            int r1 = (int) r11     // Catch:{ all -> 0x01e0 }
            r2 = r10
            r11 = r3
            goto L_0x008a
        L_0x007f:
        ...
        L_0x0080:
            ...
            float r10 = (float) r1     // Catch:{ all -> 0x01e0 }
            float r10 = r10 / r0
            int r3 = (int) r10     // Catch:{ all -> 0x01e0 }
            r2 = r1
            goto L_0x008a
        L_0x0089:
            r2 = r10
        L_0x008a:
            int r10 = java.lang.Math.min(r1, r2)     // Catch:{ all -> 0x01e0 }
            int r11 = java.lang.Math.min(r3, r11)     // Catch:{ all -> 0x01e0 }
            r9.setMeasuredDimension(r10, r11)     // Catch:{ all -> 0x01e0 }
            monitor-exit(r9)
            return
        L_0x0097:
            com.google.android.gms.internal.ads.zzcoe r1 = r9.zzq     // Catch:{ all -> 0x01e0 }
            boolean r1 = r1.zzg()     // Catch:{ all -> 0x01e0 }
            if (r1 == 0) goto L_0x00e0
            com.google.android.gms.internal.ads.zzbiu r0 = com.google.android.gms.internal.ads.zzbjc.zzdd     // Catch:{ all -> 0x01e0 }
            com.google.android.gms.internal.ads.zzbja r1 = com.google.android.gms.ads.internal.client.zzay.zzc()     // Catch:{ all -> 0x01e0 }
            java.lang.Object r0 = r1.zzb(r0)     // Catch:{ all -> 0x01e0 }
            java.lang.Boolean r0 = (java.lang.Boolean) r0     // Catch:{ all -> 0x01e0 }
            boolean r0 = r0.booleanValue()     // Catch:{ all -> 0x01e0 }
            ...
            return
        L_0x00b6:
            com.google.android.gms.internal.ads.zzcng r0 = new com.google.android.gms.internal.ads.zzcng     // Catch:{ all -> 0x01e0 }
            r0.<init>(r9)     // Catch:{ all -> 0x01e0 }
            java.lang.String r1 = "/contentHeight"
            r9.zzaf(r1, r0)     // Catch:{ all -> 0x01e0 }
            java.lang.String r0 = "(function() {  var height = -1;  if (document.body) {    height = document.body.offsetHeight;  } else if (document.documentElement) {    height = document.documentElement.offsetHeight;  }  var url = 'gmsg://mobileads.google.com/contentHeight?';  url += 'height=' + height;  try {    window.googleAdsJsInterface.notify(url);  } catch (e) {    var frame = document.getElementById('afma-notify-fluid');    if (!frame) {      frame = document.createElement('IFRAME');      frame.id = 'afma-notify-fluid';      frame.style.display = 'none';      var body = document.body || document.documentElement;      body.appendChild(frame);    }    frame.src = url;  }})();"
            r9.zzaQ(r0)     // Catch:{ all -> 0x01e0 }
            android.util.DisplayMetrics r0 = r9.zzh     // Catch:{ all -> 0x01e0 }
            float r0 = r0.density     // Catch:{ all -> 0x01e0 }
            int r10 = android.view.View.MeasureSpec.getSize(r10)     // Catch:{ all -> 0x01e0 }
            int r1 = r9.zzG     // Catch:{ all -> 0x01e0 }
            r2 = -1
            if (r1 == r2) goto L_0x00d7
            float r11 = (float) r1     // Catch:{ all -> 0x01e0 }
            float r11 = r11 * r0
            int r11 = (int) r11     // Catch:{ all -> 0x01e0 }
            goto L_0x00db
        L_0x00d7:
            int r11 = android.view.View.MeasureSpec.getSize(r11)     // Catch:{ all -> 0x01e0 }
        L_0x00db:
        ...
        L_0x00e0:
            com.google.android.gms.internal.ads.zzcoe r1 = r9.zzq     // Catch:{ all -> 0x01e0 }
            boolean r1 = r1.zzi()     // Catch:{ all -> 0x01e0 }
            if (r1 == 0) goto L_0x00f5
            android.util.DisplayMetrics r10 = r9.zzh     // Catch:{ all -> 0x01e0 }
            int r10 = r10.widthPixels     // Catch:{ all -> 0x01e0 }
            android.util.DisplayMetrics r11 = r9.zzh     // Catch:{ all -> 0x01e0 }
            int r11 = r11.heightPixels     // Catch:{ all -> 0x01e0 }
            r9.setMeasuredDimension(r10, r11)     // Catch:{ all -> 0x01e0 }
            monitor-exit(r9)
            return
        L_0x00f5:
            int r1 = android.view.View.MeasureSpec.getMode(r10)     // Catch:{ all -> 0x01e0 }
            int r10 = android.view.View.MeasureSpec.getSize(r10)     // Catch:{ all -> 0x01e0 }
            int r3 = android.view.View.MeasureSpec.getMode(r11)     // Catch:{ all -> 0x01e0 }
            int r11 = android.view.View.MeasureSpec.getSize(r11)     // Catch:{ all -> 0x01e0 }
        ...
        L_0x0115:
            r1 = r10
        L_0x0116:
            if (r3 == r6) goto L_0x011a
            if (r3 != r5) goto L_0x011b
        L_0x011a:
            r4 = r11
        L_0x011b:
            com.google.android.gms.internal.ads.zzcoe r3 = r9.zzq     // Catch:{ all -> 0x01e0 }
            int r5 = r3.zzb     // Catch:{ all -> 0x01e0 }
            r6 = 1
            if (r5 > r1) goto L_0x0129
            int r3 = r3.zza     // Catch:{ all -> 0x01e0 }
        ...
        L_0x0129:
            r3 = 1
        L_0x012a:
            com.google.android.gms.internal.ads.zzbiu r5 = com.google.android.gms.internal.ads.zzbjc.zzez     // Catch:{ all -> 0x01e0 }
            com.google.android.gms.internal.ads.zzbja r7 = com.google.android.gms.ads.internal.client.zzay.zzc()     // Catch:{ all -> 0x01e0 }
            java.lang.Object r5 = r7.zzb(r5)     // Catch:{ all -> 0x01e0 }
            java.lang.Boolean r5 = (java.lang.Boolean) r5     // Catch:{ all -> 0x01e0 }
            boolean r5 = r5.booleanValue()     // Catch:{ all -> 0x01e0 }
            if (r5 == 0) goto L_0x0158
            com.google.android.gms.internal.ads.zzcoe r5 = r9.zzq     // Catch:{ all -> 0x01e0 }
            int r7 = r5.zzb     // Catch:{ all -> 0x01e0 }
            float r8 = r9.zzi     // Catch:{ all -> 0x01e0 }
            float r7 = (float) r7     // Catch:{ all -> 0x01e0 }
            float r7 = r7 / r8
            float r1 = (float) r1     // Catch:{ all -> 0x01e0 }
            float r1 = r1 / r8
            int r1 = (r7 > r1 ? 1 : (r7 == r1 ? 0 : -1))
            if (r1 > 0) goto L_0x0156
            int r1 = r5.zza     // Catch:{ all -> 0x01e0 }
            float r1 = (float) r1     // Catch:{ all -> 0x01e0 }
            float r1 = r1 / r8
            float r4 = (float) r4     // Catch:{ all -> 0x01e0 }
            float r4 = r4 / r8
        ...
        L_0x0158:
            ...
            com.google.android.gms.internal.ads.zzcoe r3 = r9.zzq     // Catch:{ all -> 0x01e0 }
            int r4 = r3.zzb     // Catch:{ all -> 0x01e0 }
            float r5 = r9.zzi     // Catch:{ all -> 0x01e0 }
            int r3 = r3.zza     // Catch:{ all -> 0x01e0 }
            java.lang.StringBuilder r7 = new java.lang.StringBuilder     // Catch:{ all -> 0x01e0 }
            r7.<init>(r0)     // Catch:{ all -> 0x01e0 }
            float r0 = (float) r4     // Catch:{ all -> 0x01e0 }
            float r0 = r0 / r5
            int r0 = (int) r0     // Catch:{ all -> 0x01e0 }
            r7.append(r0)     // Catch:{ all -> 0x01e0 }
            java.lang.String r0 = "x"
            r7.append(r0)     // Catch:{ all -> 0x01e0 }
            float r0 = (float) r3     // Catch:{ all -> 0x01e0 }
            float r0 = r0 / r5
            int r0 = (int) r0     // Catch:{ all -> 0x01e0 }
            r7.append(r0)     // Catch:{ all -> 0x01e0 }
            java.lang.String r0 = " dp, but only has "
            r7.append(r0)     // Catch:{ all -> 0x01e0 }
            float r10 = (float) r10     // Catch:{ all -> 0x01e0 }
            float r10 = r10 / r5
            int r10 = (int) r10     // Catch:{ all -> 0x01e0 }
            r7.append(r10)     // Catch:{ all -> 0x01e0 }
            java.lang.String r10 = "x"
            r7.append(r10)     // Catch:{ all -> 0x01e0 }
            float r10 = (float) r11     // Catch:{ all -> 0x01e0 }
            float r10 = r10 / r5
            int r10 = (int) r10     // Catch:{ all -> 0x01e0 }
            r7.append(r10)     // Catch:{ all -> 0x01e0 }
            java.lang.String r10 = " dp."
            r7.append(r10)     // Catch:{ all -> 0x01e0 }
            java.lang.String r10 = r7.toString()     // Catch:{ all -> 0x01e0 }
            com.google.android.gms.ads.internal.util.zze.zzj(r10)     // Catch:{ all -> 0x01e0 }
            int r10 = r9.getVisibility()     // Catch:{ all -> 0x01e0 }
            if (r10 == r1) goto L_0x01a6
            r10 = 4
            r9.setVisibility(r10)     // Catch:{ all -> 0x01e0 }
        L_0x01a6:
            r9.setMeasuredDimension(r2, r2)     // Catch:{ all -> 0x01e0 }
            boolean r10 = r9.zzl     // Catch:{ all -> 0x01e0 }
            if (r10 != 0) goto L_0x01b8
            com.google.android.gms.internal.ads.zzbep r10 = r9.zzX     // Catch:{ all -> 0x01e0 }
            r11 = 10001(0x2711, float:1.4014E-41)
            r10.zzc(r11)     // Catch:{ all -> 0x01e0 }
            r9.zzl = r6     // Catch:{ all -> 0x01e0 }
            monitor-exit(r9)
            return
        L_0x01b8:
            monitor-exit(r9)
        ...
        L_0x01ba:
            int r10 = r9.getVisibility()     // Catch:{ all -> 0x01e0 }
            if (r10 == r1) goto L_0x01c3
            r9.setVisibility(r2)     // Catch:{ all -> 0x01e0 }
        L_0x01c3:
            boolean r10 = r9.zzm     // Catch:{ all -> 0x01e0 }
            if (r10 != 0) goto L_0x01d0
            com.google.android.gms.internal.ads.zzbep r10 = r9.zzX     // Catch:{ all -> 0x01e0 }
            r11 = 10002(0x2712, float:1.4016E-41)
            r10.zzc(r11)     // Catch:{ all -> 0x01e0 }
            r9.zzm = r6     // Catch:{ all -> 0x01e0 }
        L_0x01d0:
            com.google.android.gms.internal.ads.zzcoe r10 = r9.zzq     // Catch:{ all -> 0x01e0 }
            int r11 = r10.zzb     // Catch:{ all -> 0x01e0 }
            int r10 = r10.zza     // Catch:{ all -> 0x01e0 }
            r9.setMeasuredDimension(r11, r10)     // Catch:{ all -> 0x01e0 }
            monitor-exit(r9)
            return
        L_0x01db:
            super.onMeasure(r10, r11)     // Catch:{ all -> 0x01e0 }
