...
public final class zzdrq {
    ...
    private final zzfzp zzp(JSONObject jSONObject, zzfdk zzfdk, zzfdn zzfdn) {
        zzfzp zzb2 = this.zzi.zzb(jSONObject.optString("base_url"), jSONObject.optString("html"), zzfdk, zzfdn, zzk(jSONObject.optInt(ViewHierarchyConstants.DIMENSION_WIDTH_KEY, 0), jSONObject.optInt(ViewHierarchyConstants.DIMENSION_HEIGHT_KEY, 0)));
