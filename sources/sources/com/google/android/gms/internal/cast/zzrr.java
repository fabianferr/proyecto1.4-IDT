...
final class zzrr extends zzru {
    ...
    public final void zze(int i, zzrm zzrm) throws IOException {
        zzq((i << 3) | 2);
        zzq(zzrm.zzd());
        zzrm.zzh(this);
    }
    ...
    public final void zzn(String str) throws IOException {
        ...
        try {
            ...
            if (zzx2 == zzx) {
                int i2 = i + zzx2;
                this.zze = i2;
                int zzb = zzvf.zzb(str, this.zzc, i2, this.zzd - i2);
                this.zze = i;
                zzq((zzb - i) - zzx2);
                this.zze = zzb;
                return;
            ...
            byte[] bArr = this.zzc;
            int i3 = this.zze;
            this.zze = zzvf.zzb(str, bArr, i3, this.zzd - i3);
        } catch (zzve e) {
            this.zze = i;
            zzB(str, e);
    ...
    public final void zzs(long j) throws IOException {
        if (!zzru.zzd || this.zzd - this.zze < 10) {
            ...
            while ((j & -128) != 0) {
                ...
                int i3 = this.zze;
                this.zze = i3 + 1;
                zzvb.zzn(bArr3, (long) i3, (byte) ((((int) j) & 127) | 128));
                j >>>= 7;
            }
            byte[] bArr4 = this.zzc;
            int i4 = this.zze;
            this.zze = i4 + 1;
            zzvb.zzn(bArr4, (long) i4, (byte) ((int) j));
        }
    }
}
