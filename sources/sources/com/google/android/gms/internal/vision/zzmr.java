...
interface zzmr {
    ...
    void zza(int i, zzht zzht) throws IOException;

    <K, V> void zza(int i, zzkf<K, V> zzkf, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzlc zzlc) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzlc zzlc) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzlc zzlc) throws IOException;

    void zzb(int i, List<zzht> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzlc zzlc) throws IOException;
