...
public final class zzlb extends zzkn {
    ...
    static zzlk zzl(zzlk zzlk, byte[] bArr) throws zzko {
        zzjq zza = zzjq.zza();
        if (zza != null) {
        ...
        for (zzgc zzgc : zzga.zzd()) {
            if (zzgc != null) {
                ...
                if (this.zzs.zzf().zzs((String) null, zzeb.zzar) && zzgc.zzbm()) {
                    zzI(sb, 1, "session_stitching_token", zzgc.zzK());
                }
                zzI(sb, 1, "platform", zzgc.zzI());
                if (zzgc.zzbf()) {
                    zzI(sb, 1, "gmp_version", Long.valueOf(zzgc.zzm()));
                }
                if (zzgc.zzbq()) {
                    zzI(sb, 1, "uploading_gmp_version", Long.valueOf(zzgc.zzr()));
                }
                if (zzgc.zzbd()) {
                    zzI(sb, 1, "dynamite_version", Long.valueOf(zzgc.zzj()));
                }
                if (zzgc.zzba()) {
                    zzI(sb, 1, "config_version", Long.valueOf(zzgc.zzh()));
                }
                zzI(sb, 1, "gmp_app_id", zzgc.zzF());
                zzI(sb, 1, "admob_app_id", zzgc.zzw());
                zzI(sb, 1, "app_id", zzgc.zzx());
                zzI(sb, 1, "app_version", zzgc.zzA());
                if (zzgc.zzaY()) {
                    zzI(sb, 1, "app_version_major", Integer.valueOf(zzgc.zza()));
                }
                zzI(sb, 1, "firebase_instance_id", zzgc.zzE());
                if (zzgc.zzbc()) {
                    zzI(sb, 1, "dev_cert_hash", Long.valueOf(zzgc.zzi()));
                }
                zzI(sb, 1, "app_store", zzgc.zzz());
                if (zzgc.zzbp()) {
                    zzI(sb, 1, "upload_timestamp_millis", Long.valueOf(zzgc.zzq()));
                }
                if (zzgc.zzbn()) {
                    zzI(sb, 1, "start_timestamp_millis", Long.valueOf(zzgc.zzp()));
                }
                if (zzgc.zzbe()) {
                    zzI(sb, 1, "end_timestamp_millis", Long.valueOf(zzgc.zzk()));
                }
                if (zzgc.zzbi()) {
                    zzI(sb, 1, "previous_bundle_start_timestamp_millis", Long.valueOf(zzgc.zzo()));
                }
                if (zzgc.zzbh()) {
                    zzI(sb, 1, "previous_bundle_end_timestamp_millis", Long.valueOf(zzgc.zzn()));
                }
                zzI(sb, 1, "app_instance_id", zzgc.zzy());
                zzI(sb, 1, "resettable_device_id", zzgc.zzJ());
                zzI(sb, 1, "ds_id", zzgc.zzD());
                if (zzgc.zzbg()) {
                    zzI(sb, 1, "limited_ad_tracking", Boolean.valueOf(zzgc.zzaW()));
                }
                zzI(sb, 1, "os_version", zzgc.zzH());
                zzI(sb, 1, "device_model", zzgc.zzC());
                zzI(sb, 1, "user_default_language", zzgc.zzL());
                if (zzgc.zzbo()) {
                ...
                if (zzgc.zzbl()) {
                    zzI(sb, 1, "service_upload", Boolean.valueOf(zzgc.zzaX()));
                }
                zzI(sb, 1, "health_monitor", zzgc.zzG());
                if (zzgc.zzbk()) {
                    zzI(sb, 1, "retry_counter", Integer.valueOf(zzgc.zze()));
                }
                if (zzgc.zzbb()) {
                    zzI(sb, 1, "consent_signals", zzgc.zzB());
                }
