...
public class d implements a {
    ...
    private void a(ViewGroup viewGroup, JSONObject jSONObject, a.C0079a aVar, boolean z) {
        for (int i = 0; i < viewGroup.getChildCount(); i++) {
            aVar.a(viewGroup.getChildAt(i), this, jSONObject, z);
        }
    }

    private void b(ViewGroup viewGroup, JSONObject jSONObject, a.C0079a aVar, boolean z) {
    ...
    public void a(View view, JSONObject jSONObject, a.C0079a aVar, boolean z, boolean z2) {
