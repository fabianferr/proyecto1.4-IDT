...
public class TreeWalker implements a.C0079a {
    ...
    private final List<com.iab.omid.library.applovin.e.a> g = new ArrayList();
    private b h = new b();
    private a i = new a();
    /* access modifiers changed from: private */
    ...
    private boolean a(View view, JSONObject jSONObject) {
        ...
        com.iab.omid.library.applovin.d.b.a(jSONObject, Boolean.valueOf(this.i.d(view)));
        this.i.e();
        return true;
    }

    private boolean b(View view, JSONObject jSONObject) {
        a.C0080a b2 = this.i.b(view);
        if (b2 == null) {
            return false;
        }
        ...
        if (f.d(view) && (c2 = this.i.c(view)) != c.UNDERLYING_VIEW) {
            ...
            if (!a(view, a2)) {
                ...
                if (this.f && c2 == c.OBSTRUCTION_VIEW && !z2) {
                    this.g.add(new com.iab.omid.library.applovin.e.a(view));
                }
    ...
    public void d() {
        this.i.c();
        long a2 = d.a();
        com.iab.omid.library.applovin.c.a a3 = this.h.a();
        if (this.i.b().size() > 0) {
