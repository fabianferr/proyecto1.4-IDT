...
public class TreeWalker implements a.C0085a {
    ...
    private a f = new a();
    /* access modifiers changed from: private */
    public b g = new b(new com.iab.omid.library.ironsrc.walking.async.c());
    private long h;
    ...
    private void a(View view, com.iab.omid.library.ironsrc.processor.a aVar, JSONObject jSONObject, c cVar, boolean z) {
    ...
    private boolean b(View view, JSONObject jSONObject) {
        ...
        com.iab.omid.library.ironsrc.utils.c.a(jSONObject, d2);
    ...
    public void f() {
        ...
        if (this.f.c().size() > 0) {
            ...
            if (this.c) {
                for (com.iab.omid.library.ironsrc.adsession.a a5 : com.iab.omid.library.ironsrc.internal.c.c().a()) {
                    a5.a(this.d);
                }
            }
        } else {
