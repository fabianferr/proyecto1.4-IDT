...
public class OpenUrlActivity extends Activity {
                    ...
                    if (str.contains(contains)) {
                        try {
                            ...
                            if (OpenUrlActivity.this.d != null) {
                                A d = OpenUrlActivity.this.d;
                                String sb2 = sb.toString();
                                if (TextUtils.isEmpty(str)) {
                                    str = "unknown url";
                                }
                                d.b(A.b("failedToStartStoreActivity", A.a("errMsg", TextUtils.isEmpty(sb2) ? "activity failed to open with unspecified reason" : sb2, "url", str, (String) null, (String) null, (String) null, (String) null, (String) null, false)));
                            }
                        }
                        OpenUrlActivity.this.finish();
                        return true;
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            this.d = (A) com.ironsource.sdk.d.b.a((Context) this).a.a;
            requestWindowFeature(1);
            getWindow().setFlags(1024, 1024);
            Bundle extras = getIntent().getExtras();
            this.h = extras.getString(A.c);
            this.f = extras.getBoolean(A.d);
