...
public class x {
    ...
    static {
        ...
        try {
            ...
            printStream.println(x.class.getName() + "初始化失败，MessageDigest不支持MD5Util.");
            e.printStackTrace();
        }
    }
    ...
    public static java.lang.String a(java.io.File r8) throws java.io.IOException {
        /*
            ...
            java.security.MessageDigest r0 = b     // Catch:{ Exception -> 0x002e, all -> 0x002b }
            r0.update(r8)     // Catch:{ Exception -> 0x002e, all -> 0x002b }
            java.security.MessageDigest r8 = b     // Catch:{ Exception -> 0x002e, all -> 0x002b }
            byte[] r8 = r8.digest()     // Catch:{ Exception -> 0x002e, all -> 0x002b }
            int r0 = r8.length     // Catch:{ Exception -> 0x002e, all -> 0x002b }
            r2 = 0
            java.lang.String r8 = a(r8, r2, r0)     // Catch:{ Exception -> 0x002e, all -> 0x002b }
            r1.close()
            return r8
        L_0x002b:
            r8 = move-exception
        ...
        L_0x0033:
            r8 = move-exception
        L_0x0034:
            java.lang.String r1 = c     // Catch:{ all -> 0x0031 }
            java.lang.String r2 = "FILE EXCEPTION"
            com.mbridge.msdk.foundation.tools.aa.b(r1, r2, r8)     // Catch:{ all -> 0x0031 }
