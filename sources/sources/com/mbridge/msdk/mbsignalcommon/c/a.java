...
public final class a {
    ...
    public static abstract class b {
        ...
        /* compiled from: Mapping */
        public static class C0148a extends Throwable {
            private Class<?> a;
            private String b;
    ...
    public static class d {
        ...
        d(Class<?> cls, String str, Class<?>[] clsArr, int i) throws b.C0148a {
            Method method = null;
            ...
            if (i > 0 && (method.getModifiers() & i) != i) {
                a.b(new b.C0148a(method + " does not match modifiers: " + i));
            }
    ...
    public static class c<C> {
        ...
        public final d a(String str, Class<?>... clsArr) throws b.C0148a {
    ...
    public static <T> c<T> a(ClassLoader classLoader, String str) throws b.C0148a {
        try {
    ...
    public static void b(b.C0148a aVar) throws b.C0148a {
        C0147a aVar2 = a;
