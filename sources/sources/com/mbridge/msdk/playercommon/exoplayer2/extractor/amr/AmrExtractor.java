...
public final class AmrExtractor implements Extractor {
    ...
    private void maybeOutputFormat() {
        if (!this.hasOutputFormat) {
            ...
            this.trackOutput.format(Format.createAudioSampleFormat((String) null, z ? "audio/amr-wb" : "audio/3gpp", (String) null, -1, MAX_FRAME_SIZE_BYTES, 1, z ? 16000 : 8000, -1, (List<byte[]>) null, (DrmInitData) null, 0, (String) null));
        }
    }
