...
public final class DownloadManager {
    ...
    public static final class TaskState {
        ...
        public static String getStateString(int i) {
            ...
            if (i == 1) {
                return ServiceStateConstants.STARTED;
            }
            if (i == 2) {
                return "COMPLETED";
            }
        ...
        public final void run() {
            ...
            this.downloadManager.handler.post(new Runnable() {
                public void run() {
                    Task task = Task.this;
                    Throwable th = th;
                    if (!task.changeStateAndNotify(1, th != null ? 4 : 2, th) && !Task.this.changeStateAndNotify(6, 3) && !Task.this.changeStateAndNotify(7, 0)) {
                        throw new IllegalStateException();
                    }
                }
            });
