...
public class ConcatenatingMediaSource extends CompositeMediaSource<MediaSourceHolder> implements PlayerMessage.Target {
    ...
    public final synchronized void moveMediaSource(int r3, int r4, java.lang.Runnable r5) {
        /*
            ...
            return
        L_0x0005:
            java.util.List<com.mbridge.msdk.playercommon.exoplayer2.source.ConcatenatingMediaSource$MediaSourceHolder> r0 = r2.mediaSourcesPublic     // Catch:{ all -> 0x0033 }
            java.lang.Object r1 = r0.remove(r3)     // Catch:{ all -> 0x0033 }
            r0.add(r4, r1)     // Catch:{ all -> 0x0033 }
            com.mbridge.msdk.playercommon.exoplayer2.ExoPlayer r0 = r2.player     // Catch:{ all -> 0x0033 }
            if (r0 == 0) goto L_0x002c
            com.mbridge.msdk.playercommon.exoplayer2.PlayerMessage r0 = r0.createMessage(r2)     // Catch:{ all -> 0x0033 }
            r1 = 3
            com.mbridge.msdk.playercommon.exoplayer2.PlayerMessage r0 = r0.setType(r1)     // Catch:{ all -> 0x0033 }
            com.mbridge.msdk.playercommon.exoplayer2.source.ConcatenatingMediaSource$MessageData r1 = new com.mbridge.msdk.playercommon.exoplayer2.source.ConcatenatingMediaSource$MessageData     // Catch:{ all -> 0x0033 }
            java.lang.Integer r4 = java.lang.Integer.valueOf(r4)     // Catch:{ all -> 0x0033 }
            r1.<init>(r3, r4, r5)     // Catch:{ all -> 0x0033 }
            com.mbridge.msdk.playercommon.exoplayer2.PlayerMessage r3 = r0.setPayload(r1)     // Catch:{ all -> 0x0033 }
