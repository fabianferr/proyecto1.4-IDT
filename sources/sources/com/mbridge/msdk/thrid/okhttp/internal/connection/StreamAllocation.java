...
public final class StreamAllocation {
    ...
    public void streamFailed(java.io.IOException r7) {
        /*
            ...
            monitor-enter(r0)
            boolean r1 = r7 instanceof com.mbridge.msdk.thrid.okhttp.internal.http2.StreamResetException     // Catch:{ all -> 0x0065 }
            r2 = 0
            r3 = 1
            r4 = 0
            if (r1 == 0) goto L_0x0023
            com.mbridge.msdk.thrid.okhttp.internal.http2.StreamResetException r7 = (com.mbridge.msdk.thrid.okhttp.internal.http2.StreamResetException) r7     // Catch:{ all -> 0x0065 }
            com.mbridge.msdk.thrid.okhttp.internal.http2.ErrorCode r7 = r7.errorCode     // Catch:{ all -> 0x0065 }
            com.mbridge.msdk.thrid.okhttp.internal.http2.ErrorCode r1 = com.mbridge.msdk.thrid.okhttp.internal.http2.ErrorCode.REFUSED_STREAM     // Catch:{ all -> 0x0065 }
            ...
            goto L_0x0044
        L_0x001c:
            com.mbridge.msdk.thrid.okhttp.internal.http2.ErrorCode r1 = com.mbridge.msdk.thrid.okhttp.internal.http2.ErrorCode.CANCEL     // Catch:{ all -> 0x0065 }
            if (r7 == r1) goto L_0x0046
            r6.route = r2     // Catch:{ all -> 0x0065 }
            goto L_0x0044
        L_0x0023:
            com.mbridge.msdk.thrid.okhttp.internal.connection.RealConnection r1 = r6.connection     // Catch:{ all -> 0x0065 }
            if (r1 == 0) goto L_0x0046
            boolean r1 = r1.isMultiplexed()     // Catch:{ all -> 0x0065 }
            if (r1 == 0) goto L_0x0031
            boolean r1 = r7 instanceof com.mbridge.msdk.thrid.okhttp.internal.http2.ConnectionShutdownException     // Catch:{ all -> 0x0065 }
            if (r1 == 0) goto L_0x0046
        L_0x0031:
            com.mbridge.msdk.thrid.okhttp.internal.connection.RealConnection r1 = r6.connection     // Catch:{ all -> 0x0065 }
            int r1 = r1.successCount     // Catch:{ all -> 0x0065 }
            if (r1 != 0) goto L_0x0044
            com.mbridge.msdk.thrid.okhttp.Route r1 = r6.route     // Catch:{ all -> 0x0065 }
            if (r1 == 0) goto L_0x0042
            if (r7 == 0) goto L_0x0042
            com.mbridge.msdk.thrid.okhttp.internal.connection.RouteSelector r5 = r6.routeSelector     // Catch:{ all -> 0x0065 }
        ...
        L_0x0047:
            ...
            com.mbridge.msdk.thrid.okhttp.internal.connection.RealConnection r3 = r6.connection     // Catch:{ all -> 0x0065 }
