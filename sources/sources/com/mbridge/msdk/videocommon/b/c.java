...
public final class c {
    ...
    public static com.mbridge.msdk.videocommon.b.c b(java.lang.String r3) {
        ...
        L_0x0015:
            ...
            java.util.Map r2 = r1.k()     // Catch:{ Exception -> 0x002f }
            if (r2 == 0) goto L_0x0028
            java.util.Map r1 = r1.k()     // Catch:{ Exception -> 0x002f }
    ...
    public final String toString() {
        return "Reward{name='" + this.a + "', amount=" + this.b + AbstractJsonLexerKt.END_OBJ;
    }
}
