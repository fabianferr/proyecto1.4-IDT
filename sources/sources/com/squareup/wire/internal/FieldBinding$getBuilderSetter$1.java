...
final class FieldBinding$getBuilderSetter$1 extends Lambda implements Function2<B, Object, Unit> {
    final /* synthetic */ WireField $wireField;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FieldBinding$getBuilderSetter$1(WireField wireField) {
        super(2);
    ...
    public final void invoke(B b, Object obj) {
        ...
        ((KotlinConstructorBuilder) b).set(this.$wireField, obj);
    }
}
