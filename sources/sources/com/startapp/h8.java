...
public class h8 extends j6<f8> {
    public final u1 j;
    public final i2<TelephonyMetadata> k;
    public final i2<LocationMetadata> l;
    ...
    public final boolean a(int i) {
        TelephonyMetadata a2 = this.k.a();
        if (a2 == null || !a2.c()) {
            a2 = null;
        }
        if (a2 == null || (a2.a() & i) != i || Math.random() >= a2.b()) {
            return false;
        }
        return true;
    }
    ...
    public void b(boolean r6) {
        /*
            r5 = this;
            android.content.Context r0 = r5.a     // Catch:{ all -> 0x00e1 }
            ...
            com.startapp.f8 r1 = new com.startapp.f8     // Catch:{ all -> 0x00e1 }
        ...
        L_0x0052:
            ...
            r4 = 12
            r1.a(r4, r3)     // Catch:{ all -> 0x00e1 }
            com.startapp.i2<com.startapp.sdk.adsbase.remoteconfig.LocationMetadata> r3 = r5.l     // Catch:{ all -> 0x00e1 }
            java.lang.Object r3 = r3.a()     // Catch:{ all -> 0x00e1 }
            ...
            if (r3 == 0) goto L_0x0092
            android.content.Context r3 = r5.a     // Catch:{ all -> 0x00e1 }
        ...
        L_0x0093:
            ...
            com.startapp.i2<com.startapp.sdk.adsbase.remoteconfig.TelephonyMetadata> r6 = r5.k     // Catch:{ all -> 0x00e1 }
            java.lang.Object r6 = r6.a()     // Catch:{ all -> 0x00e1 }
        ...
        L_0x00c0:
            if (r6 == 0) goto L_0x00d4
            com.startapp.v2 r2 = r5.f     // Catch:{ all -> 0x00c8 }
        ...
        L_0x00c8:
            ...
            com.startapp.i3.a((java.lang.Throwable) r6)     // Catch:{ all -> 0x00e1 }
        L_0x00d4:
            java.util.List r6 = r0.getAllCellInfo()     // Catch:{ all -> 0x00e1 }
            if (r6 == 0) goto L_0x00dd
            r5.a((com.startapp.f8) r1, (java.util.List<android.telephony.CellInfo>) r6)     // Catch:{ all -> 0x00e1 }
        L_0x00dd:
    ...
    public boolean f() {
        ...
        if (!this.j.c() || (a2 = this.k.a()) == null || !a2.c()) {
            return false;
        }
        return true;
    }
