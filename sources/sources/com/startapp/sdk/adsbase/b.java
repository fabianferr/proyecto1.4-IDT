...
public abstract class b {
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ...
            bVar.getClass();
            try {
                new Handler(Looper.getMainLooper()).post(new x0(bVar, b));
            } catch (Throwable th) {
                i3.a(th);
            }
        }
    ...
    public com.startapp.sdk.adsbase.model.GetAdRequest a(com.startapp.sdk.adsbase.model.GetAdRequest r11) {
        /*
            ...
            com.startapp.sdk.adsbase.SimpleTokenUtils$TokenType r1 = com.startapp.sdk.adsbase.SimpleTokenUtils.h     // Catch:{ all -> 0x0078 }
            ...
            boolean r1 = com.startapp.sdk.adsbase.SimpleTokenUtils.f     // Catch:{ all -> 0x0078 }
            boolean r6 = com.startapp.sdk.adsbase.SimpleTokenUtils.g     // Catch:{ all -> 0x0078 }
        ...
        L_0x0040:
            ...
            goto L_0x004a
        L_0x0043:
            boolean r1 = com.startapp.sdk.adsbase.SimpleTokenUtils.g     // Catch:{ all -> 0x0078 }
        ...
        L_0x0049:
            r1 = 0
        L_0x004a:
            com.startapp.sdk.adsbase.SimpleTokenUtils.g = r1     // Catch:{ all -> 0x0078 }
        ...
        L_0x007c:
            ...
            monitor-exit(r4)
            android.content.Context r1 = r10.a     // Catch:{ all -> 0x00ee }
            com.startapp.sdk.adsbase.model.AdPreferences r2 = r10.c     // Catch:{ all -> 0x00ee }
            com.startapp.sdk.adsbase.model.AdPreferences$Placement r3 = r10.e     // Catch:{ all -> 0x00ee }
            r11.a(r1, r2, r3, r0)     // Catch:{ all -> 0x00ee }
            android.content.Context r1 = r10.a     // Catch:{ all -> 0x00ee }
            r11.g(r1)     // Catch:{ all -> 0x00ee }
            com.startapp.sdk.adsbase.AdsCommonMetaData r1 = com.startapp.sdk.adsbase.AdsCommonMetaData.h     // Catch:{ all -> 0x00ee }
            boolean r1 = r1.M()     // Catch:{ all -> 0x00ee }
            if (r1 != 0) goto L_0x00ae
            android.content.Context r1 = r10.a     // Catch:{ all -> 0x00ee }
            com.startapp.sdk.adsbase.model.AdPreferences$Placement r2 = r10.e     // Catch:{ all -> 0x00ee }
            ...
            if (r1 == 0) goto L_0x00ae
            r11.v0 = r8     // Catch:{ all -> 0x00ee }
        L_0x00ae:
            android.content.Context r0 = r10.a     // Catch:{ all -> 0x00b6 }
            com.startapp.sdk.adsbase.model.AdPreferences r1 = r10.c     // Catch:{ all -> 0x00b6 }
        ...
        L_0x00ba:
            android.content.Context r0 = r10.a     // Catch:{ all -> 0x00e9 }
        ...
        L_0x00ee:
            ...
            com.startapp.sdk.adsbase.SimpleTokenUtils.h = r11
            r11 = 0
            return r11
        L_0x00fe:
            r11 = move-exception
