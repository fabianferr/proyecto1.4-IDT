...
public class CacheKey implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.forceOfferWall3D != cacheKey.forceOfferWall3D || this.forceOfferWall2D != cacheKey.forceOfferWall2D || this.forceFullpage != cacheKey.forceFullpage || this.forceOverlay != cacheKey.forceOverlay || this.testMode != cacheKey.testMode || this.videoMuted != cacheKey.videoMuted || this.placement != cacheKey.placement || !k9.a(this.placementId, cacheKey.placementId) || !k9.a(this.categories, cacheKey.categories) || !k9.a(this.categoriesExclude, cacheKey.categoriesExclude) || !k9.a(this.minCpm, cacheKey.minCpm) || !k9.a(this.adTag, cacheKey.adTag) || !k9.a(this.productId, cacheKey.productId) || !k9.a(this.country, cacheKey.country) || !k9.a(this.advertiserId, cacheKey.advertiserId) || !k9.a(this.template, cacheKey.template) || this.type != cacheKey.type) {
            return false;
        }
        return true;
    }
