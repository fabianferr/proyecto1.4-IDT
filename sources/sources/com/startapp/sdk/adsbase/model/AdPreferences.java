...
public class AdPreferences implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.forceOfferWall3D != adPreferences.forceOfferWall3D || this.forceOfferWall2D != adPreferences.forceOfferWall2D || this.forceFullpage != adPreferences.forceFullpage || this.forceOverlay != adPreferences.forceOverlay || this.testMode != adPreferences.testMode || this.videoMuted != adPreferences.videoMuted || this.hardwareAccelerated != adPreferences.hardwareAccelerated || this.type != adPreferences.type || !k9.a(this.packageInclude, adPreferences.packageInclude) || !k9.a(this.minCpm, adPreferences.minCpm) || !k9.a(this.longitude, adPreferences.longitude) || !k9.a(this.latitude, adPreferences.latitude) || !k9.a(this.keywords, adPreferences.keywords) || this.gender != adPreferences.gender || !k9.a(this.age, adPreferences.age) || !k9.a(this.ai, adPreferences.ai) || !k9.a(this.as, adPreferences.as) || !k9.a(this.adTag, adPreferences.adTag) || !k9.a(this.productId, adPreferences.productId) || !k9.a(this.autoLoadAmount, adPreferences.autoLoadAmount) || !k9.a(this.categories, adPreferences.categories) || !k9.a(this.categoriesExclude, adPreferences.categoriesExclude) || !k9.a(this.placementId, adPreferences.placementId)) {
            return false;
        }
        return true;
    }
    ...
    public String getAge(Context context) {
        ...
        return StartAppSDKInternal.d.a.c(context).getAge();
    }
    ...
    public SDKAdPreferences.Gender getGender(Context context) {
        ...
        Object obj = StartAppSDKInternal.E;
        return StartAppSDKInternal.d.a.c(context).getGender();
    }
