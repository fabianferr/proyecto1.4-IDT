...
public class RcdMetadata implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.enabled == rcdMetadata.enabled && Double.compare(this.prb, rcdMetadata.prb) == 0 && this.ief == rcdMetadata.ief && Double.compare(this.iep, rcdMetadata.iep) == 0 && k9.a(this.targets, rcdMetadata.targets)) {
            return true;
        }
        return false;
    }
