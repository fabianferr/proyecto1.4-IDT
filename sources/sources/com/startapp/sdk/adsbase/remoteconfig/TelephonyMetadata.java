...
public class TelephonyMetadata implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.enabled == telephonyMetadata.enabled && this.ief == telephonyMetadata.ief && Double.compare(this.iep, telephonyMetadata.iep) == 0 && this.rciu == telephonyMetadata.rciu && k9.a(this.data, telephonyMetadata.data)) {
            return true;
        }
        return false;
    }
