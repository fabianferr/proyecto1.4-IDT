...
public class RatingBar extends LinearLayout {
    ...
    public final void a(String str) {
        try {
            int a2 = f9.a(getContext(), 2);
            int a3 = f9.a(getContext(), 5);
            ImageView imageView = new ImageView(getContext());
            Bitmap a4 = a1.a(getContext(), str);
            if (a4 == null) {
                a4 = c1.a((String) ((HashMap) a).get(str));
            }
            imageView.setImageBitmap(Bitmap.createScaledBitmap(a4, f9.a(getContext(), 15), f9.a(getContext(), 15), true));
