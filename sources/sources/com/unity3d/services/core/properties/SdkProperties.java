...
public class SdkProperties {
    ...
    public static void notifyInitializationFailed(UnityAds.UnityAdsInitializationError unityAdsInitializationError, String str) {
        ...
        for (IUnityAdsInitializationListener sdkProperties$$ExternalSyntheticLambda1 : getInitializationListeners()) {
            Utilities.wrapCustomerListener(new SdkProperties$$ExternalSyntheticLambda1(sdkProperties$$ExternalSyntheticLambda1, unityAdsInitializationError, str));
        }
    ...
    public static void notifyInitializationComplete() {
        ...
        for (IUnityAdsInitializationListener iUnityAdsInitializationListener : getInitializationListeners()) {
            ...
            Utilities.wrapCustomerListener(new SdkProperties$$ExternalSyntheticLambda0(iUnityAdsInitializationListener));
        }
        resetInitializationListeners();
    }
