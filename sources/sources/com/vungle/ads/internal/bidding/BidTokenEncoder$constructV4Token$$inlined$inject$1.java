...
public final class BidTokenEncoder$constructV4Token$$inlined$inject$1 extends Lambda implements Function0<VungleApiClient> {
    final /* synthetic */ Context $context;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public BidTokenEncoder$constructV4Token$$inlined$inject$1(Context context) {
        super(0);
