...
public final class AdPayload$TemplateSettings$$serializer implements GeneratedSerializer<AdPayload.TemplateSettings> {
    ...
    public AdPayload.TemplateSettings deserialize(Decoder decoder) {
        ...
        if (beginStructure.decodeSequentially()) {
            obj2 = beginStructure.decodeNullableSerializableElement(descriptor2, 0, new LinkedHashMapSerializer(StringSerializer.INSTANCE, StringSerializer.INSTANCE), null);
            obj = beginStructure.decodeNullableSerializableElement(descriptor2, 1, new LinkedHashMapSerializer(StringSerializer.INSTANCE, AdPayload$CacheableReplacement$$serializer.INSTANCE), null);
            i = 3;
        } else {
            obj2 = null;
            Object obj3 = null;
            ...
            while (z) {
                ...
                if (decodeElementIndex == -1) {
                    ...
                    obj2 = beginStructure.decodeNullableSerializableElement(descriptor2, 0, new LinkedHashMapSerializer(StringSerializer.INSTANCE, StringSerializer.INSTANCE), obj2);
                    i2 |= 1;
        ...
        return new AdPayload.TemplateSettings(i, (Map) obj2, (Map) obj, (SerializationConstructorMarker) null);
    }

    public void serialize(Encoder encoder, AdPayload.TemplateSettings templateSettings) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(templateSettings, "value");
        SerialDescriptor descriptor2 = getDescriptor();
