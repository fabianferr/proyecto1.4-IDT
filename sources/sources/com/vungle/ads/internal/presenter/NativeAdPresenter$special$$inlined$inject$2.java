...
public final class NativeAdPresenter$special$$inlined$inject$2 extends Lambda implements Function0<Executors> {
    final /* synthetic */ Context $context;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public NativeAdPresenter$special$$inlined$inject$2(Context context) {
        super(0);
