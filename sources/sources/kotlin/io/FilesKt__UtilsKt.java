...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:32:0x009f A[Catch:{ TerminateException -> 0x00df }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final boolean copyRecursively(java.io.File r11, java.io.File r12, boolean r13, kotlin.jvm.functions.Function2<? super java.io.File, ? super java.io.IOException, ? extends kotlin.io.OnErrorAction> r14) {
        ...
        L_0x002e:
            return r1
        L_0x002f:
            kotlin.io.FileTreeWalk r0 = kotlin.io.FilesKt.walkTopDown(r11)     // Catch:{ TerminateException -> 0x00df }
            kotlin.io.FilesKt__UtilsKt$copyRecursively$2 r3 = new kotlin.io.FilesKt__UtilsKt$copyRecursively$2     // Catch:{ TerminateException -> 0x00df }
            r3.<init>(r14)     // Catch:{ TerminateException -> 0x00df }
            kotlin.jvm.functions.Function2 r3 = (kotlin.jvm.functions.Function2) r3     // Catch:{ TerminateException -> 0x00df }
            kotlin.io.FileTreeWalk r0 = r0.onFail(r3)     // Catch:{ TerminateException -> 0x00df }
            java.util.Iterator r0 = r0.iterator()     // Catch:{ TerminateException -> 0x00df }
        L_0x0042:
            boolean r3 = r0.hasNext()     // Catch:{ TerminateException -> 0x00df }
            if (r3 == 0) goto L_0x00de
            java.lang.Object r3 = r0.next()     // Catch:{ TerminateException -> 0x00df }
            java.io.File r3 = (java.io.File) r3     // Catch:{ TerminateException -> 0x00df }
            boolean r4 = r3.exists()     // Catch:{ TerminateException -> 0x00df }
            if (r4 != 0) goto L_0x0069
            kotlin.io.NoSuchFileException r10 = new kotlin.io.NoSuchFileException     // Catch:{ TerminateException -> 0x00df }
            r6 = 0
            ...
            r4 = r10
            r5 = r3
            r4.<init>(r5, r6, r7, r8, r9)     // Catch:{ TerminateException -> 0x00df }
            java.lang.Object r3 = r14.invoke(r3, r10)     // Catch:{ TerminateException -> 0x00df }
            kotlin.io.OnErrorAction r4 = kotlin.io.OnErrorAction.TERMINATE     // Catch:{ TerminateException -> 0x00df }
            if (r3 != r4) goto L_0x0042
            return r2
        L_0x0069:
            java.lang.String r4 = kotlin.io.FilesKt.toRelativeString(r3, r11)     // Catch:{ TerminateException -> 0x00df }
            java.io.File r5 = new java.io.File     // Catch:{ TerminateException -> 0x00df }
            r5.<init>(r12, r4)     // Catch:{ TerminateException -> 0x00df }
            boolean r4 = r5.exists()     // Catch:{ TerminateException -> 0x00df }
            if (r4 == 0) goto L_0x00af
            boolean r4 = r3.isDirectory()     // Catch:{ TerminateException -> 0x00df }
            if (r4 == 0) goto L_0x0084
            boolean r4 = r5.isDirectory()     // Catch:{ TerminateException -> 0x00df }
            if (r4 != 0) goto L_0x00af
        L_0x0084:
        ...
        L_0x0088:
            ...
            boolean r4 = kotlin.io.FilesKt.deleteRecursively(r5)     // Catch:{ TerminateException -> 0x00df }
            if (r4 != 0) goto L_0x009c
            goto L_0x0086
        L_0x0095:
            boolean r4 = r5.delete()     // Catch:{ TerminateException -> 0x00df }
            if (r4 != 0) goto L_0x009c
            goto L_0x0086
        L_0x009c:
            r4 = 0
        L_0x009d:
            if (r4 == 0) goto L_0x00af
            kotlin.io.FileAlreadyExistsException r4 = new kotlin.io.FileAlreadyExistsException     // Catch:{ TerminateException -> 0x00df }
            java.lang.String r6 = "The destination file already exists."
            r4.<init>(r3, r5, r6)     // Catch:{ TerminateException -> 0x00df }
            java.lang.Object r3 = r14.invoke(r5, r4)     // Catch:{ TerminateException -> 0x00df }
            kotlin.io.OnErrorAction r4 = kotlin.io.OnErrorAction.TERMINATE     // Catch:{ TerminateException -> 0x00df }
            if (r3 != r4) goto L_0x0042
            return r2
        L_0x00af:
            ...
            r5.mkdirs()     // Catch:{ TerminateException -> 0x00df }
            goto L_0x0042
        L_0x00b9:
            r7 = 0
            r8 = 4
            ...
            r4 = r3
            r6 = r13
            java.io.File r4 = kotlin.io.FilesKt.copyTo$default(r4, r5, r6, r7, r8, r9)     // Catch:{ TerminateException -> 0x00df }
            long r4 = r4.length()     // Catch:{ TerminateException -> 0x00df }
            long r6 = r3.length()     // Catch:{ TerminateException -> 0x00df }
            int r8 = (r4 > r6 ? 1 : (r4 == r6 ? 0 : -1))
            if (r8 == 0) goto L_0x0042
            java.io.IOException r4 = new java.io.IOException     // Catch:{ TerminateException -> 0x00df }
            java.lang.String r5 = "Source file wasn't copied completely, length of destination file differs."
            r4.<init>(r5)     // Catch:{ TerminateException -> 0x00df }
            java.lang.Object r3 = r14.invoke(r3, r4)     // Catch:{ TerminateException -> 0x00df }
            kotlin.io.OnErrorAction r4 = kotlin.io.OnErrorAction.TERMINATE     // Catch:{ TerminateException -> 0x00df }
            if (r3 != r4) goto L_0x0042
            return r2
        L_0x00de:
