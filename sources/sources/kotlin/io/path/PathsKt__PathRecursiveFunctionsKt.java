...
class PathsKt__PathRecursiveFunctionsKt extends PathsKt__PathReadWriteKt {
    ...
    private static final java.util.List<java.lang.Exception> deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt(java.nio.file.Path r8) {
        ...
        L_0x0013:
            r5 = r3
            java.nio.file.DirectoryStream r5 = (java.nio.file.DirectoryStream) r5
            r5 = r3
        L_0x0017:
            if (r5 == 0) goto L_0x0044
            java.io.Closeable r5 = (java.io.Closeable) r5
            r6 = r5
            java.nio.file.DirectoryStream r6 = (java.nio.file.DirectoryStream) r6     // Catch:{ all -> 0x003d }
            boolean r7 = r6 instanceof java.nio.file.SecureDirectoryStream     // Catch:{ all -> 0x003d }
            if (r7 == 0) goto L_0x0035
            r0.setPath(r4)     // Catch:{ all -> 0x003d }
            java.nio.file.SecureDirectoryStream r6 = (java.nio.file.SecureDirectoryStream) r6     // Catch:{ all -> 0x003d }
            java.nio.file.Path r2 = r8.getFileName()     // Catch:{ all -> 0x003d }
            java.lang.String r4 = "this.fileName"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r4)     // Catch:{ all -> 0x003d }
            handleEntry$PathsKt__PathRecursiveFunctionsKt(r6, r2, r0)     // Catch:{ all -> 0x003d }
            goto L_0x0036
        L_0x0035:
            r1 = 1
        L_0x0036:
    ...
    private static final void enterDirectory$PathsKt__PathRecursiveFunctionsKt(java.nio.file.SecureDirectoryStream<java.nio.file.Path> r4, java.nio.file.Path r5, kotlin.io.path.ExceptionsCollector r6) {
        ...
        L_0x0012:
            ...
            r5 = r4
            java.nio.file.SecureDirectoryStream r5 = (java.nio.file.SecureDirectoryStream) r5     // Catch:{ all -> 0x003c }
            java.util.Iterator r0 = r5.iterator()     // Catch:{ all -> 0x003c }
        L_0x001d:
            boolean r2 = r0.hasNext()     // Catch:{ all -> 0x003c }
            if (r2 == 0) goto L_0x0036
            java.lang.Object r2 = r0.next()     // Catch:{ all -> 0x003c }
            java.nio.file.Path r2 = (java.nio.file.Path) r2     // Catch:{ all -> 0x003c }
            java.nio.file.Path r2 = r2.getFileName()     // Catch:{ all -> 0x003c }
            java.lang.String r3 = "entry.fileName"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r3)     // Catch:{ all -> 0x003c }
            handleEntry$PathsKt__PathRecursiveFunctionsKt(r5, r2, r6)     // Catch:{ all -> 0x003c }
            goto L_0x001d
        L_0x0036:
            kotlin.Unit r5 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x003c }
    ...
    private static final void insecureEnterDirectory$PathsKt__PathRecursiveFunctionsKt(java.nio.file.Path r4, kotlin.io.path.ExceptionsCollector r5) {
        ...
        L_0x000a:
            ...
            r1 = r4
            java.nio.file.DirectoryStream r1 = (java.nio.file.DirectoryStream) r1     // Catch:{ all -> 0x0030 }
        ...
        L_0x0015:
            ...
            java.nio.file.Path r2 = (java.nio.file.Path) r2     // Catch:{ all -> 0x0030 }
            java.lang.String r3 = "entry"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r3)     // Catch:{ all -> 0x0030 }
            insecureHandleEntry$PathsKt__PathRecursiveFunctionsKt(r2, r5)     // Catch:{ all -> 0x0030 }
            goto L_0x0015
        L_0x002a:
