...
public final class JavaTypeResolver {
    ...
    private final TypeProjection transformToTypeProjection(JavaType javaType, JavaTypeAttributes javaTypeAttributes, TypeParameterDescriptor typeParameterDescriptor) {
        ...
        if (bound == null || isConflictingArgumentFor(variance, typeParameterDescriptor)) {
            ...
            typeProjection = TypeUtilsKt.createProjection(transformJavaType(bound, JavaTypeAttributesKt.toAttributes$default(TypeUsage.COMMON, false, false, (TypeParameterDescriptor) null, 7, (Object) null)), variance, typeParameterDescriptor);
        }
