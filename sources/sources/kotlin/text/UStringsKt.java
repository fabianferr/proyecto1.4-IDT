...
public final class UStringsKt {
    ...
    public static final String m2819toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m2821toStringolVBNx4(short s, int i) {
    ...
    public static final String m2820toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m2818toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m2412unboximpl();
        }
    ...
    public static final short toUShort(String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m2675unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final int toUInt(String str) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m2491unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final long toULong(String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m2570unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m2491unboximpl();
        if (Integer.compare(r1 ^ Integer.MIN_VALUE, UInt.m2439constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m2356boximpl(UByte.m2362constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m2491unboximpl();
        if (Integer.compare(r1 ^ Integer.MIN_VALUE, UInt.m2439constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m2619boximpl(UShort.m2625constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r3 = UInt.m2439constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            int r2 = UInt.m2439constructorimpl(i3 * r3);
            int r7 = UInt.m2439constructorimpl(UInt.m2439constructorimpl(digitOf) + r2);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r5 = ULong.m2518constructorimpl((long) i2);
        long j = 0;
        ...
        while (i3 < length) {
            ...
            long r9 = ULong.m2518constructorimpl(j * r5);
            long r13 = ULong.m2518constructorimpl(ULong.m2518constructorimpl(((long) UInt.m2439constructorimpl(digitOf)) & 4294967295L) + r9);
