...
public final class LongSaturatedMathKt {
    ...
    public static final long m2844saturatingAddpTJri5U(long j, long j2) {
        long r4 = Duration.m1126getInWholeNanosecondsimpl(j2);
        boolean z = true;
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m2843checkInfiniteSumDefinedPjuGub4(j, j2, r4);
        }
        if ((1 | (r4 - 1)) != Long.MAX_VALUE) {
            z = false;
        }
        if (z) {
            return m2845saturatingAddInHalvespTJri5U(j, j2);
        }
        long j3 = j + r4;
        if (((j ^ j3) & (r4 ^ j3)) >= 0) {
            return j3;
    ...
    private static final long m2843checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m1138isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m2845saturatingAddInHalvespTJri5U(long j, long j2) {
        long r0 = Duration.m1109divUwyO8pc(j2, 2);
        if (!(((Duration.m1126getInWholeNanosecondsimpl(r0) - 1) | 1) == Long.MAX_VALUE)) {
            return m2844saturatingAddpTJri5U(m2844saturatingAddpTJri5U(j, r0), Duration.m1141minusLRDsOJo(j2, r0));
        }
        double d = (double) j;
        double r9 = Duration.m1149toDoubleimpl(j2, DurationUnit.NANOSECONDS);
        Double.isNaN(d);
        return (long) (d + r9);
    }
    ...
    public static final long saturatingDiff(long j, long j2) {
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m1158unaryMinusUwyO8pc(DurationKt.toDuration(j2, DurationUnit.DAYS));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2) {
        ...
        if (((j3 ^ j) & ((j3 ^ j2) ^ -1)) < 0) {
            ...
            return Duration.m1142plusLRDsOJo(duration, DurationKt.toDuration(j5, DurationUnit.NANOSECONDS));
        }
