...
public final class DelayKt {
    ...
    public static final Object m2888delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m2889toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2889toDelayMillisLRDsOJo(long j) {
        if (Duration.m1105compareToLRDsOJo(j, Duration.Companion.m1208getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1124getInWholeMillisecondsimpl(j), 1);
        }
        return 0;
    }
}
