...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    public final Object m2896trySendJP2dKIU(E e) {
        Object offerInternal = offerInternal(e);
        if (offerInternal == AbstractChannelKt.OFFER_SUCCESS) {
            return ChannelResult.Companion.m2912successJP2dKIU(Unit.INSTANCE);
        }
        if (offerInternal == AbstractChannelKt.OFFER_FAILED) {
            ...
            return ChannelResult.Companion.m2910closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        } else if (offerInternal instanceof Closed) {
            return ChannelResult.Companion.m2910closedJP2dKIU(helpCloseAndGetSendException((Closed) offerInternal));
        } else {
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 == null || (callUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, (UndeliveredElementException) null, 2, (Object) null)) == null) {
            ...
            continuation.resumeWith(Result.m2344constructorimpl(ResultKt.createFailure(sendException)));
            return;
        }
        Throwable th = callUndeliveredElementCatchingException$default;
        ExceptionsKt.addSuppressed(th, sendException);
        Result.Companion companion2 = Result.Companion;
        continuation.resumeWith(Result.m2344constructorimpl(ResultKt.createFailure(th)));
    }
    ...
    private final void invokeOnCloseHandler(Throwable th) {
        ...
        if (obj != null && obj != AbstractChannelKt.HANDLER_INVOKED && UByte$$ExternalSyntheticBackport0.m(onCloseHandler$FU, (Object) this, obj, (Object) AbstractChannelKt.HANDLER_INVOKED)) {
    ...
    public void invokeOnClose(Function1<? super Throwable, Unit> function1) {
        ...
        if (!UByte$$ExternalSyntheticBackport0.m(atomicReferenceFieldUpdater, (Object) this, (Object) null, (Object) function1)) {
            Object obj = this.onCloseHandler;
        ...
        Closed<?> closedForSend = getClosedForSend();
        if (closedForSend != null && UByte$$ExternalSyntheticBackport0.m(atomicReferenceFieldUpdater, (Object) this, (Object) function1, (Object) AbstractChannelKt.HANDLER_INVOKED)) {
            function1.invoke(closedForSend.closeCause);
        }
    }

    private final void helpClose(Closed<?> closed) {
        Object r2 = InlineList.m2926constructorimpl$default((Object) null, 1, (DefaultConstructorMarker) null);
        while (true) {
            ...
            if (receive == null) {
                ...
                r2 = InlineList.m2931plusFjFbRPM(r2, receive);
            }
        }
        if (r2 != null) {
    ...
    public final Object sendSuspend(E e, Continuation<? super Unit> continuation) {
        ...
        while (true) {
            ...
            if (offerInternal == AbstractChannelKt.OFFER_SUCCESS) {
                Result.Companion companion = Result.Companion;
                cancellableContinuation.resumeWith(Result.m2344constructorimpl(Unit.INSTANCE));
                break;
