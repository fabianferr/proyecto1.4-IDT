...
final /* synthetic */ class TestBuildersKt__TestBuildersDeprecatedKt {
    ...
    public static final void runBlockingTest(CoroutineContext coroutineContext, Function2<? super TestCoroutineScope, ? super Continuation<? super Unit>, ? extends Object> function2) {
        ...
        Deferred async$default = BuildersKt__Builders_commonKt.async$default(createTestCoroutineScope, (CoroutineContext) null, (CoroutineStart) null, new TestBuildersKt__TestBuildersDeprecatedKt$runBlockingTest$deferred$1(function2, createTestCoroutineScope, (Continuation<? super TestBuildersKt__TestBuildersDeprecatedKt$runBlockingTest$deferred$1>) null), 3, (Object) null);
    ...
    public static final void runBlockingTestOnTestScope(CoroutineContext coroutineContext, Function2<? super TestScope, ? super Continuation<? super Unit>, ? extends Object> function2) {
        ...
        asSpecificImplementation.start(CoroutineStart.UNDISPATCHED, asSpecificImplementation, new TestBuildersKt__TestBuildersDeprecatedKt$runBlockingTestOnTestScope$1(function2, asSpecificImplementation, (Continuation<? super TestBuildersKt__TestBuildersDeprecatedKt$runBlockingTestOnTestScope$1>) null));
    ...
    public static final void runTestWithLegacyScope(CoroutineContext coroutineContext, long j, Function2<? super TestCoroutineScope, ? super Continuation<? super Unit>, ? extends Object> function2) {
        if (coroutineContext.get(RunningInRunTest.INSTANCE) == null) {
            TestBuildersJvmKt.createTestResult(new TestBuildersKt__TestBuildersDeprecatedKt$runTestWithLegacyScope$1(new TestBodyCoroutine(TestCoroutineScopeKt.createTestCoroutineScope(coroutineContext.plus(RunningInRunTest.INSTANCE))), j, function2, (Continuation<? super TestBuildersKt__TestBuildersDeprecatedKt$runTestWithLegacyScope$1>) null));
            return;
        }
