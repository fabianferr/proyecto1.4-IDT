...
final class TestBuildersKt__TestBuildersKt$runTest$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (TestBuildersKt.runTestCoroutine((CoroutineScope) this.L$0, this.$it, this.$dispatchTimeoutMs, AnonymousClass1.INSTANCE, function2, new Function0<List<? extends Throwable>>() {
