...
public final class UIntArrayBuilder extends PrimitiveArrayBuilder<UIntArray> {
    ...
    public /* bridge */ /* synthetic */ Object build$kotlinx_serialization_core() {
        return UIntArray.m2492boximpl(m2964buildhP7Qyg$kotlinx_serialization_core());
    }

    private UIntArrayBuilder(int[] iArr) {
        this.buffer = iArr;
        this.position = UIntArray.m2500getSizeimpl(iArr);
    ...
    public void ensureCapacity$kotlinx_serialization_core(int i) {
        if (UIntArray.m2500getSizeimpl(this.buffer) < i) {
            int[] iArr = this.buffer;
            int[] copyOf = Arrays.copyOf(iArr, RangesKt.coerceAtLeast(i, UIntArray.m2500getSizeimpl(iArr) * 2));
            Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(this, newSize)");
            this.buffer = UIntArray.m2494constructorimpl(copyOf);
        }
    }

    /* renamed from: append-WZ4Q5Ns$kotlinx_serialization_core  reason: not valid java name */
    public final void m2963appendWZ4Q5Ns$kotlinx_serialization_core(int i) {
        PrimitiveArrayBuilder.ensureCapacity$kotlinx_serialization_core$default(this, 0, 1, (Object) null);
        int[] iArr = this.buffer;
        int position$kotlinx_serialization_core = getPosition$kotlinx_serialization_core();
        this.position = position$kotlinx_serialization_core + 1;
        UIntArray.m2504setVXSXFK8(iArr, position$kotlinx_serialization_core, i);
    }

    /* renamed from: build--hP7Qyg$kotlinx_serialization_core  reason: not valid java name */
    public int[] m2964buildhP7Qyg$kotlinx_serialization_core() {
        int[] copyOf = Arrays.copyOf(this.buffer, getPosition$kotlinx_serialization_core());
        Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(this, newSize)");
        return UIntArray.m2494constructorimpl(copyOf);
    }
}
