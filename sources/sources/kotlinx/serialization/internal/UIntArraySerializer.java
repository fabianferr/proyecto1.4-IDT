...
public final class UIntArraySerializer extends PrimitiveArraySerializer<UInt, UIntArray, UIntArrayBuilder> implements KSerializer<UIntArray> {
    ...
    public /* bridge */ /* synthetic */ int collectionSize(Object obj) {
        return m2965collectionSizeajY9A(((UIntArray) obj).m2508unboximpl());
    }

    public /* bridge */ /* synthetic */ Object empty() {
        return UIntArray.m2492boximpl(m2966emptyhP7Qyg());
    }

    public /* bridge */ /* synthetic */ Object toBuilder(Object obj) {
        return m2967toBuilderajY9A(((UIntArray) obj).m2508unboximpl());
    }

    public /* bridge */ /* synthetic */ void writeContent(CompositeEncoder compositeEncoder, Object obj, int i) {
        m2968writeContentCPlH8fI(compositeEncoder, ((UIntArray) obj).m2508unboximpl(), i);
    }
    ...
    public int m2965collectionSizeajY9A(int[] iArr) {
        Intrinsics.checkNotNullParameter(iArr, "$this$collectionSize");
        return UIntArray.m2500getSizeimpl(iArr);
    }

    /* access modifiers changed from: protected */
    /* renamed from: toBuilder--ajY-9A  reason: not valid java name */
    public UIntArrayBuilder m2967toBuilderajY9A(int[] iArr) {
    ...
    public int[] m2966emptyhP7Qyg() {
        return UIntArray.m2493constructorimpl(0);
    }
    ...
    public void readElement(CompositeDecoder compositeDecoder, int i, UIntArrayBuilder uIntArrayBuilder, boolean z) {
        ...
        uIntArrayBuilder.m2963appendWZ4Q5Ns$kotlinx_serialization_core(UInt.m2439constructorimpl(compositeDecoder.decodeInlineElement(getDescriptor(), i).decodeInt()));
    }

    /* access modifiers changed from: protected */
    /* renamed from: writeContent-CPlH8fI  reason: not valid java name */
    public void m2968writeContentCPlH8fI(CompositeEncoder compositeEncoder, int[] iArr, int i) {
        Intrinsics.checkNotNullParameter(compositeEncoder, "encoder");
        Intrinsics.checkNotNullParameter(iArr, "content");
        for (int i2 = 0; i2 < i; i2++) {
            compositeEncoder.encodeInlineElement(getDescriptor(), i2).encodeInt(UIntArray.m2499getpVg5ArA(iArr, i2));
        }
    }
}
