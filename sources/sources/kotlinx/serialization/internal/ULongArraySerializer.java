...
public final class ULongArraySerializer extends PrimitiveArraySerializer<ULong, ULongArray, ULongArrayBuilder> implements KSerializer<ULongArray> {
    ...
    public /* bridge */ /* synthetic */ int collectionSize(Object obj) {
        return m2973collectionSizeQwZRm1k(((ULongArray) obj).m2587unboximpl());
    }

    public /* bridge */ /* synthetic */ Object empty() {
        return ULongArray.m2571boximpl(m2974emptyY2RjT0g());
    }

    public /* bridge */ /* synthetic */ Object toBuilder(Object obj) {
        return m2975toBuilderQwZRm1k(((ULongArray) obj).m2587unboximpl());
    }

    public /* bridge */ /* synthetic */ void writeContent(CompositeEncoder compositeEncoder, Object obj, int i) {
        m2976writeContent0q3Fkuo(compositeEncoder, ((ULongArray) obj).m2587unboximpl(), i);
    }
    ...
    public int m2973collectionSizeQwZRm1k(long[] jArr) {
        Intrinsics.checkNotNullParameter(jArr, "$this$collectionSize");
        return ULongArray.m2579getSizeimpl(jArr);
    }

    /* access modifiers changed from: protected */
    /* renamed from: toBuilder-QwZRm1k  reason: not valid java name */
    public ULongArrayBuilder m2975toBuilderQwZRm1k(long[] jArr) {
    ...
    public long[] m2974emptyY2RjT0g() {
        return ULongArray.m2572constructorimpl(0);
    }
    ...
    public void readElement(CompositeDecoder compositeDecoder, int i, ULongArrayBuilder uLongArrayBuilder, boolean z) {
        ...
        uLongArrayBuilder.m2971appendVKZWuLQ$kotlinx_serialization_core(ULong.m2518constructorimpl(compositeDecoder.decodeInlineElement(getDescriptor(), i).decodeLong()));
    }

    /* access modifiers changed from: protected */
    /* renamed from: writeContent-0q3Fkuo  reason: not valid java name */
    public void m2976writeContent0q3Fkuo(CompositeEncoder compositeEncoder, long[] jArr, int i) {
        Intrinsics.checkNotNullParameter(compositeEncoder, "encoder");
        Intrinsics.checkNotNullParameter(jArr, "content");
        for (int i2 = 0; i2 < i; i2++) {
            compositeEncoder.encodeInlineElement(getDescriptor(), i2).encodeLong(ULongArray.m2578getsVKNKU(jArr, i2));
        }
    }
}
