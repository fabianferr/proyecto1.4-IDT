...
public final class UShortArraySerializer extends PrimitiveArraySerializer<UShort, UShortArray, UShortArrayBuilder> implements KSerializer<UShortArray> {
    ...
    public /* bridge */ /* synthetic */ int collectionSize(Object obj) {
        return m2981collectionSizerL5Bavg(((UShortArray) obj).m2692unboximpl());
    }

    public /* bridge */ /* synthetic */ Object empty() {
        return UShortArray.m2676boximpl(m2982emptyamswpOA());
    }

    public /* bridge */ /* synthetic */ Object toBuilder(Object obj) {
        return m2983toBuilderrL5Bavg(((UShortArray) obj).m2692unboximpl());
    }

    public /* bridge */ /* synthetic */ void writeContent(CompositeEncoder compositeEncoder, Object obj, int i) {
        m2984writeContenteny0XGE(compositeEncoder, ((UShortArray) obj).m2692unboximpl(), i);
    }
    ...
    public int m2981collectionSizerL5Bavg(short[] sArr) {
        Intrinsics.checkNotNullParameter(sArr, "$this$collectionSize");
        return UShortArray.m2684getSizeimpl(sArr);
    }

    /* access modifiers changed from: protected */
    /* renamed from: toBuilder-rL5Bavg  reason: not valid java name */
    public UShortArrayBuilder m2983toBuilderrL5Bavg(short[] sArr) {
    ...
    public short[] m2982emptyamswpOA() {
        return UShortArray.m2677constructorimpl(0);
    }
    ...
    public void readElement(CompositeDecoder compositeDecoder, int i, UShortArrayBuilder uShortArrayBuilder, boolean z) {
        ...
        uShortArrayBuilder.m2979appendxj2QHRw$kotlinx_serialization_core(UShort.m2625constructorimpl(compositeDecoder.decodeInlineElement(getDescriptor(), i).decodeShort()));
    }

    /* access modifiers changed from: protected */
    /* renamed from: writeContent-eny0XGE  reason: not valid java name */
    public void m2984writeContenteny0XGE(CompositeEncoder compositeEncoder, short[] sArr, int i) {
        Intrinsics.checkNotNullParameter(compositeEncoder, "encoder");
        Intrinsics.checkNotNullParameter(sArr, "content");
        for (int i2 = 0; i2 < i; i2++) {
            compositeEncoder.encodeInlineElement(getDescriptor(), i2).encodeShort(UShortArray.m2683getMh2AYeg(sArr, i2));
        }
    }
}
