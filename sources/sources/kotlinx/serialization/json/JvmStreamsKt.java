...
public final class JvmStreamsKt {
    ...
    public static final /* synthetic */ <T> void encodeToStream(Json json, T t, OutputStream outputStream) {
        ...
        encodeToStream(json, serializer, t, outputStream);
    }
    ...
    public static final <T> T decodeFromStream(Json json, DeserializationStrategy<T> deserializationStrategy, InputStream inputStream) {
        ...
        return JsonStreamsKt.decodeByReader(json, deserializationStrategy, new JavaStreamSerialReader(inputStream, (Charset) null, 2, (DefaultConstructorMarker) null));
    }
    ...
    public static final /* synthetic */ <T> T decodeFromStream(Json json, InputStream inputStream) {
        ...
        Intrinsics.checkNotNull(serializer, "null cannot be cast to non-null type kotlinx.serialization.KSerializer<T of kotlinx.serialization.internal.Platform_commonKt.cast>");
        KSerializer kSerializer = serializer;
        return decodeFromStream(json, serializer, inputStream);
    }
    ...
    public static final <T> Sequence<T> decodeToSequence(Json json, InputStream inputStream, DeserializationStrategy<T> deserializationStrategy, DecodeSequenceMode decodeSequenceMode) {
        ...
        return JsonStreamsKt.decodeToSequenceByReader(json, new JavaStreamSerialReader(inputStream, (Charset) null, 2, (DefaultConstructorMarker) null), deserializationStrategy, decodeSequenceMode);
    }
    ...
    public static /* synthetic */ Sequence decodeToSequence$default(Json json, InputStream inputStream, DecodeSequenceMode decodeSequenceMode, int i, Object obj) {
        ...
        Intrinsics.checkNotNull(serializer, "null cannot be cast to non-null type kotlinx.serialization.KSerializer<T of kotlinx.serialization.internal.Platform_commonKt.cast>");
        KSerializer kSerializer = serializer;
        return decodeToSequence(json, inputStream, serializer, decodeSequenceMode);
    }
