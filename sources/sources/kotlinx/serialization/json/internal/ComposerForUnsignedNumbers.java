...
public final class ComposerForUnsignedNumbers extends Composer {
    ...
    public void print(int i) {
        ...
        int r2 = UInt.m2439constructorimpl(i);
        if (z) {
    ...
    public void print(long j) {
        boolean z = this.forceQuoting;
        long r2 = ULong.m2518constructorimpl(j);
        if (z) {
            printQuoted(UByte$$ExternalSyntheticBackport0.m$1(r2));
        } else {
    ...
    public void print(byte b) {
        boolean z = this.forceQuoting;
        String r2 = UByte.m2406toStringimpl(UByte.m2362constructorimpl(b));
        if (z) {
            printQuoted(r2);
        } else {
            print(r2);
    ...
    public void print(short s) {
        boolean z = this.forceQuoting;
        String r2 = UShort.m2669toStringimpl(UShort.m2625constructorimpl(s));
        if (z) {
            printQuoted(r2);
        } else {
            print(r2);
