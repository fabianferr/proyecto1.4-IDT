...
public final class RealCall implements Call {
    ...
    public final class AsyncCall implements Runnable {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:19:0x0046 A[Catch:{ all -> 0x0060, all -> 0x009f }] */
        /* JADX WARNING: Removed duplicated region for block: B:26:0x0067 A[Catch:{ all -> 0x0060, all -> 0x009f }] */
        /* JADX WARNING: Removed duplicated region for block: B:27:0x007e A[Catch:{ all -> 0x0060, all -> 0x009f }] */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void run() {
            /*
                r7 = this;
                okhttp3.internal.connection.RealCall r0 = r7.this$0
                ...
                r2.setName(r0)
                okhttp3.internal.connection.RealCall$timeout$1 r0 = r1.timeout     // Catch:{ all -> 0x009f }
                r0.enter()     // Catch:{ all -> 0x009f }
                r0 = 0
                okhttp3.Response r0 = r1.getResponseWithInterceptorChain$okhttp()     // Catch:{ IOException -> 0x0062, all -> 0x003e }
                r4 = 1
                okhttp3.Callback r5 = r7.responseCallback     // Catch:{ IOException -> 0x003c, all -> 0x003a }
                r6 = r1
                ...
                okhttp3.OkHttpClient r0 = r1.getClient()     // Catch:{ all -> 0x009f }
                okhttp3.Dispatcher r0 = r0.dispatcher()     // Catch:{ all -> 0x009f }
            L_0x0036:
                r0.finished$okhttp((okhttp3.internal.connection.RealCall.AsyncCall) r7)     // Catch:{ all -> 0x009f }
                goto L_0x008f
            L_0x003a:
                r0 = move-exception
                goto L_0x0041
            ...
            L_0x003e:
                ...
                r4 = 0
            L_0x0041:
                r1.cancel()     // Catch:{ all -> 0x0060 }
                if (r4 != 0) goto L_0x005f
                java.io.IOException r4 = new java.io.IOException     // Catch:{ all -> 0x0060 }
                java.lang.String r5 = "canceled due to "
                java.lang.String r5 = kotlin.jvm.internal.Intrinsics.stringPlus(r5, r0)     // Catch:{ all -> 0x0060 }
                r4.<init>(r5)     // Catch:{ all -> 0x0060 }
                r5 = r4
                java.lang.Throwable r5 = (java.lang.Throwable) r5     // Catch:{ all -> 0x0060 }
                kotlin.ExceptionsKt.addSuppressed(r5, r0)     // Catch:{ all -> 0x0060 }
                okhttp3.Callback r5 = r7.responseCallback     // Catch:{ all -> 0x0060 }
                r6 = r1
                okhttp3.Call r6 = (okhttp3.Call) r6     // Catch:{ all -> 0x0060 }
                r5.onFailure(r6, r4)     // Catch:{ all -> 0x0060 }
            L_0x005f:
            ...
            L_0x0065:
                ...
                okhttp3.internal.platform.Platform$Companion r4 = okhttp3.internal.platform.Platform.Companion     // Catch:{ all -> 0x0060 }
                okhttp3.internal.platform.Platform r4 = r4.get()     // Catch:{ all -> 0x0060 }
                java.lang.String r5 = "Callback failure for "
                java.lang.String r6 = r1.toLoggableString()     // Catch:{ all -> 0x0060 }
                java.lang.String r5 = kotlin.jvm.internal.Intrinsics.stringPlus(r5, r6)     // Catch:{ all -> 0x0060 }
                java.lang.Throwable r0 = (java.lang.Throwable) r0     // Catch:{ all -> 0x0060 }
                r6 = 4
                r4.log(r5, r6, r0)     // Catch:{ all -> 0x0060 }
                goto L_0x0086
            L_0x007e:
                okhttp3.Callback r4 = r7.responseCallback     // Catch:{ all -> 0x0060 }
                r5 = r1
                okhttp3.Call r5 = (okhttp3.Call) r5     // Catch:{ all -> 0x0060 }
                r4.onFailure(r5, r0)     // Catch:{ all -> 0x0060 }
            L_0x0086:
                okhttp3.OkHttpClient r0 = r1.getClient()     // Catch:{ all -> 0x009f }
                okhttp3.Dispatcher r0 = r0.dispatcher()     // Catch:{ all -> 0x009f }
                goto L_0x0036
            L_0x008f:
                ...
                return
            L_0x0093:
                okhttp3.OkHttpClient r1 = r1.getClient()     // Catch:{ all -> 0x009f }
                okhttp3.Dispatcher r1 = r1.dispatcher()     // Catch:{ all -> 0x009f }
                r1.finished$okhttp((okhttp3.internal.connection.RealCall.AsyncCall) r7)     // Catch:{ all -> 0x009f }
