...
public abstract class ForwardingFileSystem extends FileSystem {
    ...
    public FileMetadata metadataOrNull(Path path) throws IOException {
        ...
        return FileMetadata.copy$default(metadataOrNull, false, false, onPathResult(metadataOrNull.getSymlinkTarget(), "metadataOrNull"), (Long) null, (Long) null, (Long) null, (Long) null, (Map) null, PreciseDisconnectCause.NETWORK_RESP_TIMEOUT, (Object) null);
    }
