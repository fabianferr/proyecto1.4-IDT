...
public final class HashingSource extends ForwardingSource implements Source {
    ...
    public HashingSource(okio.Source r3, okio.ByteString r4, java.lang.String r5) {
        /*
            ...
            javax.crypto.Mac r0 = javax.crypto.Mac.getInstance(r5)     // Catch:{ InvalidKeyException -> 0x002e }
            javax.crypto.spec.SecretKeySpec r1 = new javax.crypto.spec.SecretKeySpec     // Catch:{ InvalidKeyException -> 0x002e }
            byte[] r4 = r4.toByteArray()     // Catch:{ InvalidKeyException -> 0x002e }
            r1.<init>(r4, r5)     // Catch:{ InvalidKeyException -> 0x002e }
            java.security.Key r1 = (java.security.Key) r1     // Catch:{ InvalidKeyException -> 0x002e }
            r0.init(r1)     // Catch:{ InvalidKeyException -> 0x002e }
            kotlin.Unit r4 = kotlin.Unit.INSTANCE     // Catch:{ InvalidKeyException -> 0x002e }
    ...
    public final ByteString m1402deprecated_hash() {
        return hash();
    }
