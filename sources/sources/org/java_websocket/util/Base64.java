...
public class Base64 {
    ...
    public static int decode4to3(byte[] bArr, int i, byte[] bArr2, int i2, int i3) {
        ...
        if (bArr == null) {
            ...
            byte b2 = bArr[i4];
            if (b2 == 61) {
                int i6 = ((decodabet[bArr[i + 1]] & 255) << Ascii.FF) | ((decodabet[bArr[i]] & 255) << Ascii.DC2) | ((decodabet[b] & 255) << 6);
                bArr2[i2] = (byte) (i6 >>> 16);
                bArr2[i2 + 1] = (byte) (i6 >>> 8);
                return 2;
            }
            byte b3 = ((decodabet[bArr[i + 1]] & 255) << Ascii.FF) | ((decodabet[bArr[i]] & 255) << Ascii.DC2) | ((decodabet[b] & 255) << 6) | (decodabet[b2] & 255);
            bArr2[i2] = (byte) (b3 >> Ascii.DLE);
