...
public final class FragmentOfKt$fragmentOf$5 extends Lambda implements Function2<Scope, ParametersHolder, R> {
    final /* synthetic */ Function2<T1, T2, R> $constructor;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FragmentOfKt$fragmentOf$5(Function2<? super T1, ? super T2, ? extends R> function2) {
        super(2);
