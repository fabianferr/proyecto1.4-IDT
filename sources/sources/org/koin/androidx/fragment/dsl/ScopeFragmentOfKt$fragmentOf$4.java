...
public final class ScopeFragmentOfKt$fragmentOf$4 extends Lambda implements Function2<Scope, ParametersHolder, R> {
    final /* synthetic */ Function1<T1, R> $constructor;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ScopeFragmentOfKt$fragmentOf$4(Function1<? super T1, ? extends R> function1) {
        super(2);
