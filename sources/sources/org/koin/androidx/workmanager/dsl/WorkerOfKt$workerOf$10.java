...
public final class WorkerOfKt$workerOf$10 extends Lambda implements Function2<Scope, ParametersHolder, R> {
    final /* synthetic */ Function4<T1, T2, T3, T4, R> $constructor;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public WorkerOfKt$workerOf$10(Function4<? super T1, ? super T2, ? super T3, ? super T4, ? extends R> function4) {
        super(2);
