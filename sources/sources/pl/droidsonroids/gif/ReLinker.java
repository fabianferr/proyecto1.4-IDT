...
class ReLinker {
     ...
     */
    /* JADX WARNING: Removed duplicated region for block: B:39:0x0093 A[Catch:{ IOException -> 0x007a, all -> 0x0078, all -> 0x00ba }] */
    /* JADX WARNING: Removed duplicated region for block: B:52:0x00c8 A[SYNTHETIC, Splitter:B:52:0x00c8] */
    /* JADX WARNING: Removed duplicated region for block: B:59:0x0094 A[SYNTHETIC] */
    ...
    private static java.io.File unpackLibrary(android.content.Context r8) {
        ...
        L_0x0036:
            ...
            r0.<init>(r8)
            r8 = 0
            java.util.zip.ZipFile r0 = openZipFile(r0)     // Catch:{ all -> 0x00c2 }
        L_0x0057:
            int r4 = r3 + 1
            r5 = 5
            if (r3 >= r5) goto L_0x00bc
            java.util.zip.ZipEntry r3 = findLibraryEntry(r0)     // Catch:{ all -> 0x00ba }
            if (r3 == 0) goto L_0x009c
            java.io.InputStream r3 = r0.getInputStream(r3)     // Catch:{ IOException -> 0x008d, all -> 0x0082 }
            ...
            closeSilently(r3)     // Catch:{ all -> 0x00ba }
            closeSilently(r5)     // Catch:{ all -> 0x00ba }
            setFilePermissions(r1)     // Catch:{ all -> 0x00ba }
            goto L_0x00bc
        L_0x0078:
            r8 = move-exception
            goto L_0x0086
        ...
        L_0x0094:
            ...
            goto L_0x0057
        L_0x009c:
            java.lang.IllegalStateException r8 = new java.lang.IllegalStateException     // Catch:{ all -> 0x00ba }
