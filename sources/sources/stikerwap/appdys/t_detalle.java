...
public class t_detalle extends FragmentActivity_ext_class implements Activity_ext, View.OnClickListener, RewardedVideoAdListener, OnAdLoaded, OnAdClosed, OnVideoEnded, OnAdError, VideoListener, AdEventListener {
    Anuncios anun;
    config globales;
    ...
    public void onCreate(Bundle bundle) {
        ...
        searchManager.setOnCancelListener(new SearchManager.OnCancelListener() {
            public void onCancel() {
                t_detalle.this.finalizar = false;
                t_detalle.this.setResult(0);
            }
        });
        searchManager.setOnDismissListener(new SearchManager.OnDismissListener() {
            public void onDismiss() {
                t_detalle.this.buscador_on = false;
            }
        });
        ...
        t_detalle_fr t_detalle_fr = (t_detalle_fr) getSupportFragmentManager().findFragmentById(R.id.detalle_fr);
        this.viewer = t_detalle_fr;
        t_detalle_fr.actContenido(string, j);
    }
    ...
    private void establec_ralc(final Context context) {
        this.ralc = new RewardedAdLoadCallback() {
            public void onAdFailedToLoad(LoadAdError loadAdError) {
                if (!t_detalle.this.globales.admob_rew_failed(context, t_detalle.this.mAd_appnext)) {
                    t_detalle.this.dialog_cargando.cancel();
                    t_detalle t_detalle = t_detalle.this;
                    t_detalle.abrir_secc(t_detalle.v_abrir_secc);
                }
            }
            ...
            public void onAdLoaded(RewardedAd rewardedAd) {
                ...
                rewardedAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                    ...
                    public void onAdFailedToShowFullScreenContent(AdError adError) {
                        t_detalle.this.abrir_secc(t_detalle.this.v_abrir_secc);
                    }

                    public void onAdDismissedFullScreenContent() {
                        if (t_detalle.this.mAd_visto) {
                            t_detalle.this.abrir_secc(t_detalle.this.v_abrir_secc);
                        }
                    }
                });
