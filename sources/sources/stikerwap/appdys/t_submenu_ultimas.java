...
public class t_submenu_ultimas extends Activity_ext_class implements Activity_ext, View.OnClickListener, SharedPreferences.OnSharedPreferenceChangeListener, AdapterView.OnItemClickListener, RewardedVideoAdListener, OnAdLoaded, OnAdClosed, OnVideoEnded, OnAdError, VideoListener, AdEventListener {
    int H_MAXIMA = 80;
    int H_MAXIMA_ROW = 30;
    ...
    public void onCreate(Bundle bundle) {
        ...
        searchManager.setOnCancelListener(new SearchManager.OnCancelListener() {
            public void onCancel() {
                t_submenu_ultimas.this.finalizar = false;
                t_submenu_ultimas.this.setResult(0);
            }
        });
        searchManager.setOnDismissListener(new SearchManager.OnDismissListener() {
            public void onDismiss() {
                t_submenu_ultimas.this.buscador_on = false;
            }
        });
        if (bundle == null) {
        ...
        this.seccs_a_aux = this.settings.getString("seccs_ultimas", "").split(",");
            ...
            if (intValue == 1) {
                ...
                nativeAd.loadAd(nativeAd.buildLoadAdConfig().withAdListener(new NativeAdListener() {
                    ...
                    public void onAdLoaded(Ad ad) {
                        ...
                        if (t_submenu_ultimas.this.s.c2 != null && !t_submenu_ultimas.this.s.c2.equals("")) {
                            int canviarColor = config.canviarColor(Color.parseColor("#" + t_submenu_ultimas.this.s.c2), 0.2f, 0);
                        ...
                        if (t_submenu_ultimas.this.s.mostrar_txt && t_submenu_ultimas.this.s.txt_col != null && !t_submenu_ultimas.this.s.txt_col.equals("") && t_submenu_ultimas.this.s.txt_bg != null && !t_submenu_ultimas.this.s.txt_bg.equals("")) {
                            NativeAdViewAttributes buttonBorderColor = backgroundColor.setButtonTextColor(Color.parseColor("#" + t_submenu_ultimas.this.s.txt_col)).setButtonBorderColor(-12303292);
                            buttonBorderColor.setButtonColor(Color.parseColor("#" + t_submenu_ultimas.this.s.txt_bg));
                        }
                        View render = NativeAdView.render(t_submenu_ultimas.this, nativeAd, NativeAdView.Type.HEIGHT_300, backgroundColor);
                        LinearLayout linearLayout = (LinearLayout) t_submenu_ultimas.this.findViewById(R.id.ll_nat);
                        try {
                            if (config.esClaro("#" + t_submenu_ultimas.this.s.c2)) {
                                linearLayout.setBackgroundColor(ViewCompat.MEASURED_STATE_MASK);
                            } else {
                                linearLayout.setBackgroundColor(-1);
                            }
                            int dp_to_px = config.dp_to_px(t_submenu_ultimas.this.getApplicationContext(), 1);
                ...
                this.adView_nat_w.setListener(new BannerAd.Listener() {
                    ...
                    public void onBannerFailed(BannerAd bannerAd, com.wortise.ads.AdError adError) {
                        ...
                        if (z2) {
                            if (!t_submenu_ultimas.this.globales.menu_c1.equals("")) {
                                if (config.esClaro("#" + t_submenu_ultimas.this.globales.menu_c1)) {
                                    ((TextView) t_submenu_ultimas.this.findViewById(R.id.tv_appsreco)).setTextColor(config.NEGRO);
                                }
                            }
                            t_submenu_ultimas.this.globales.appnext_mostrar_2(t_submenu_ultimas.this, 1, 3, -1, (String) null);
                        }
                    }

                    public void onBannerLoaded(BannerAd bannerAd) {
                        ((LinearLayout) t_submenu_ultimas.this.findViewById(R.id.ll_nat)).removeViewAt(1);
                        ((LinearLayout) t_submenu_ultimas.this.findViewById(R.id.ll_nat)).addView(t_submenu_ultimas.this.adView_nat_w, 1);
                    }
                });
    ...
    public void mostrar_grid() {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (this.seccs_a_aux[i11].equals(this.globales.secciones_a[i12].id + "")) {
                    Seccion seccion2 = this.globales.secciones_a[i12];
                    if (seccion2.tipo != 22 && ((seccion2.tipo != 12 || this.s.incl_submenu) && (seccion2.tipo != 14 || this.s.incl_card))) {
                        Seccion[] seccionArr = this.seccs_a;
                        int i13 = this.seccs_a_length;
                        seccionArr[i13] = seccion2;
        ...
        if (this.seccs_a_length == 0) {
            if (!this.s.c1.equals("")) {
                if (config.esClaro("#" + this.s.c1)) {
                    ((TextView) findViewById(R.id.tv_sinseccs)).setTextColor(config.NEGRO);
                }
            }
        ...
        gridView2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long j) {
                if (view != null) {
                    try {
                        ((ScrollView) t_submenu_ultimas.this.findViewById(R.id.sv_menugrid)).smoothScrollTo(0, view.getTop() - 20);
                    } catch (Exception unused) {
                    }
                }
            }
    ...
    public class GridAdapter extends BaseAdapter {
        ...
        public int getCount() {
            return t_submenu_ultimas.this.seccs_a_length;
        }
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
                ...
                if (t_submenu_ultimas.this.s.icos_izq) {
                    i2 = R.layout.t_menugrid_row;
                } else if (t_submenu_ultimas.this.s.estilo == 1) {
                    i2 = R.layout.t_menugrid_row_formato2;
                } else {
                    i2 = t_submenu_ultimas.this.s.estilo == 2 ? R.layout.t_menugrid_row_formato3 : R.layout.t_menugrid_row_v;
                }
                view = layoutInflater.inflate(i2, viewGroup, false);
                if (!t_submenu_ultimas.this.s.icos_izq && (t_submenu_ultimas.this.s.estilo == 1 || t_submenu_ultimas.this.s.estilo == 2)) {
                    ((CardView) view.findViewById(R.id.cv)).setRadius((float) t_submenu_ultimas.this.s.txt_radius);
                }
                if (t_submenu_ultimas.this.s.mostrar_icos) {
                    ImageView imageView = (ImageView) view.findViewById(R.id.iv_menugrid);
                    if (t_submenu_ultimas.this.s.icos_izq) {
                        imageView.getLayoutParams().height = t_submenu_ultimas.this.h_max;
                        imageView.getLayoutParams().width = t_submenu_ultimas.this.w_max;
                    } else {
                        imageView.getLayoutParams().height = t_submenu_ultimas.this.h_max;
                        imageView.getLayoutParams().width = t_submenu_ultimas.this.w_max;
                    }
                ...
                if (t_submenu_ultimas.this.s.mostrar_txt) {
                    TextView textView = (TextView) view.findViewById(R.id.tv_menugrid);
                    if (t_submenu_ultimas.this.s.txt_b) {
                        textView.setTypeface(textView.getTypeface(), 1);
                    }
                    if (!t_submenu_ultimas.this.s.txt_col.equals("")) {
                        textView.setTextColor(Color.parseColor("#" + t_submenu_ultimas.this.s.txt_col));
                    }
                    textView.getLayoutParams().width = t_submenu_ultimas.this.w_txt_max;
                    if (t_submenu_ultimas.this.s.txt_c) {
                        textView.setGravity(17);
                    } else if (t_submenu_ultimas.this.getResources().getBoolean(R.bool.es_rtl)) {
                        textView.setTextDirection(4);
                    }
                    if (t_submenu_ultimas.this.s.txt_bg.equals("")) {
                        textView.setBackgroundDrawable((Drawable) null);
                    } else {
                        ((GradientDrawable) textView.getBackground()).setColor(Color.parseColor("#" + t_submenu_ultimas.this.s.txt_bg));
                        ((GradientDrawable) textView.getBackground()).setCornerRadius((float) t_submenu_ultimas.this.s.txt_radius);
                    }
            ...
            if (t_submenu_ultimas.this.s.mostrar_icos) {
                ...
                if (t_submenu_ultimas.this.seccs_a[i].ico_cargando || t_submenu_ultimas.this.seccs_a[i].ico == null) {
                    imageView2.setImageBitmap((Bitmap) null);
                } else {
                    if (!t_submenu_ultimas.this.seccs_a[i].ico_mostrado) {
                        imageView2.setVisibility(4);
                    }
                    imageView2.setImageDrawable(new BitmapDrawable(t_submenu_ultimas.this.getResources(), t_submenu_ultimas.this.seccs_a[i].ico));
                    if (!t_submenu_ultimas.this.seccs_a[i].ico_mostrado) {
                        t_submenu_ultimas.this.seccs_a[i].ico_mostrado = true;
                        config.fade_in(imageView2);
                    }
                }
            }
            if (t_submenu_ultimas.this.s.mostrar_txt) {
                ((TextView) view.findViewById(R.id.tv_menugrid)).setText(t_submenu_ultimas.this.seccs_a[i].titulo);
            }
            return view;
        }
    }
    ...
    private class cargarfoto extends AsyncTask<String, Void, Byte> {
        ...
        public java.lang.Byte doInBackground(java.lang.String... r6) {
            /*
                ...
                stikerwap.appdys.t_submenu_ultimas r1 = stikerwap.appdys.t_submenu_ultimas.this     // Catch:{ Exception -> 0x007a }
            ...
            L_0x0084:
                ...
                return r6
            */
            throw new UnsupportedOperationException("Method not decompiled: stikerwap.appdys.t_submenu_ultimas.cargarfoto.doInBackground(java.lang.String[]):java.lang.Byte");
        }
        ...
        public void onPostExecute(Byte b) {
            if (b.byteValue() == 0) {
                try {
                    ...
                    t_submenu_ultimas.this.globales.tratar_fondo(imageView, Boolean.valueOf(t_submenu_ultimas.this.s.fondo_margen), t_submenu_ultimas.this.s.fondo_tipo);
                    imageView.setVisibility(8);
                    config config = t_submenu_ultimas.this.globales;
                    config.file_to_iv("fondo_" + t_submenu_ultimas.this.s.idfondo, imageView);
                    config.fade_in(imageView);
                } catch (Exception unused) {
                }
                SharedPreferences.Editor edit = t_submenu_ultimas.this.getSharedPreferences(CampaignUnit.JSON_KEY_SH, 0).edit();
                edit.putInt(CmcdHeadersFactory.STREAMING_FORMAT_SS + this.idfoto + "_fondo_modif", 0);
                edit.commit();
                t_submenu_ultimas.this.globales.secciones_a[Integer.parseInt(this.ind)].fondo_modif = false;
            }
        }
    }
    ...
    private void establec_ralc(final Context context) {
        this.ralc = new RewardedAdLoadCallback() {
            public void onAdFailedToLoad(LoadAdError loadAdError) {
                if (!t_submenu_ultimas.this.globales.admob_rew_failed(context, t_submenu_ultimas.this.mAd_appnext)) {
                    t_submenu_ultimas.this.dialog_cargando.cancel();
                    t_submenu_ultimas t_submenu_ultimas = t_submenu_ultimas.this;
                    t_submenu_ultimas.abrir_secc(t_submenu_ultimas.v_abrir_secc);
                }
            }
            ...
            public void onAdLoaded(RewardedAd rewardedAd) {
                ...
                rewardedAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                    ...
                    public void onAdFailedToShowFullScreenContent(com.google.android.gms.ads.AdError adError) {
                        t_submenu_ultimas.this.abrir_secc(t_submenu_ultimas.this.v_abrir_secc);
                    }

                    public void onAdDismissedFullScreenContent() {
                        if (t_submenu_ultimas.this.mAd_visto) {
                            t_submenu_ultimas.this.abrir_secc(t_submenu_ultimas.this.v_abrir_secc);
                        }
                    }
                });
                rewardedAd.show((Activity) context, new OnUserEarnedRewardListener() {
                    public void onUserEarnedReward(RewardItem rewardItem) {
                        t_submenu_ultimas.this.mAd_visto = true;
