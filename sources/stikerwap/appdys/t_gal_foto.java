...
public class t_gal_foto extends Activity_ext_class implements Activity_ext, View.OnClickListener, SharedPreferences.OnSharedPreferenceChangeListener, RewardedVideoAdListener, OnAdLoaded, OnAdClosed, OnVideoEnded, OnAdError, VideoListener, AdEventListener {
    Anuncios anun;
    Bundle extras;
    config globales;
    ...
    public void onCreate(Bundle bundle) {
        ...
        searchManager.setOnCancelListener(new SearchManager.OnCancelListener() {
            public void onCancel() {
                t_gal_foto.this.finalizar = false;
                t_gal_foto.this.setResult(0);
            }
        });
        searchManager.setOnDismissListener(new SearchManager.OnDismissListener() {
            public void onDismiss() {
                t_gal_foto.this.buscador_on = false;
            }
        });
        ...
        this.myWebView.setWebViewClient(new WebViewClient() {
            public void onPageStarted(WebView webView, String str, Bitmap bitmap) {
                boolean z;
                boolean z2;
                if (!t_gal_foto.this.finalizar && !t_gal_foto.this.isFinishing() && !t_gal_foto.this.extras.getString("url").contains("youtube.com") && !t_gal_foto.this.extras.getString("url").contains("youtu.be")) {
                    if (t_gal_foto.this.primer_load) {
                        z = true;
                        z2 = t_gal_foto.this.extras != null && t_gal_foto.this.extras.containsKey("ad_entrar");
                        if (t_gal_foto.this.extras == null || !t_gal_foto.this.extras.containsKey("fb_entrar")) {
                            z = false;
                        }
                    ...
                    t_gal_foto.this.globales.toca_int_2(t_gal_foto.this, z2, z, false);
                }
            }
        });
        if (bundle == null) {
        ...
        String trim = this.extras.getString("descr").trim();
        if (!trim.equals("")) {
    ...
    private void establec_ralc(final Context context) {
        this.ralc = new RewardedAdLoadCallback() {
            public void onAdFailedToLoad(LoadAdError loadAdError) {
                if (!t_gal_foto.this.globales.admob_rew_failed(context, t_gal_foto.this.mAd_appnext)) {
                    t_gal_foto.this.dialog_cargando.cancel();
                    t_gal_foto t_gal_foto = t_gal_foto.this;
                    t_gal_foto.abrir_secc(t_gal_foto.v_abrir_secc);
                }
            }
            ...
            public void onAdLoaded(RewardedAd rewardedAd) {
                ...
                rewardedAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                    ...
                    public void onAdFailedToShowFullScreenContent(AdError adError) {
                        t_gal_foto.this.abrir_secc(t_gal_foto.this.v_abrir_secc);
                    }

                    public void onAdDismissedFullScreenContent() {
                        if (t_gal_foto.this.mAd_visto) {
                            t_gal_foto.this.abrir_secc(t_gal_foto.this.v_abrir_secc);
                        }
                    }
                });
                rewardedAd.show((Activity) context, new OnUserEarnedRewardListener() {
                    public void onUserEarnedReward(RewardItem rewardItem) {
                        t_gal_foto.this.mAd_visto = true;
