...
public class t_video extends FragmentActivity_ext_class implements Activity_ext, View.OnKeyListener, View.OnClickListener, SharedPreferences.OnSharedPreferenceChangeListener, RewardedVideoAdListener, OnAdLoaded, OnAdClosed, OnVideoEnded, OnAdError, VideoListener, AdEventListener {
    ...
    private class SessionManagerListenerImpl implements SessionManagerListener {
        ...
        public void onSessionStarted(Session session, String str) {
            ...
            String string = t_video.this.extras.getString("url");
            MediaMetadata mediaMetadata = new MediaMetadata(1);
            mediaMetadata.putString(MediaMetadata.KEY_TITLE, t_video.this.globales.secciones_a[t_video.this.ind].titulo);
            if (!t_video.this.globales.secciones_a[t_video.this.ind].ico_cargando && t_video.this.globales.secciones_a[t_video.this.ind].ico != null) {
                if (t_video.this.globales.secciones_a[t_video.this.ind].ico_id == 0) {
                    str2 = config.DOM_CDN + "/srv/imgs/seccs/" + t_video.this.globales.secciones_a[t_video.this.ind].id + "_ico.png?v=" + t_video.this.globales.secciones_a[t_video.this.ind].v_ico;
                } else {
                    str2 = config.DOM_CDN + "/android-app-creator/icos_secc/" + t_video.this.globales.secciones_a[t_video.this.ind].ico_id + ".png";
                }
                mediaMetadata.addImage(new WebImage(Uri.parse(str2)));
            }
            MediaInfo build = new MediaInfo.Builder(string).setStreamType(0).setContentType("video/*").setMetadata(mediaMetadata).build();
            try {
                t_video t_video = t_video.this;
                t_video.mCastSession = t_video.mSessionManager.getCurrentCastSession();
                final RemoteMediaClient remoteMediaClient = t_video.this.mCastSession.getRemoteMediaClient();
    ...
    public void onCreate(Bundle bundle) {
        ...
        searchManager.setOnCancelListener(new SearchManager.OnCancelListener() {
            public void onCancel() {
                t_video.this.finalizar = false;
                t_video.this.setResult(0);
            }
        });
        searchManager.setOnDismissListener(new SearchManager.OnDismissListener() {
            public void onDismiss() {
                t_video.this.buscador_on = false;
            }
        });
        ...
        config2.oncreate_popup(this, config2.ind_secc_sel_2, this.cbtn, bundle);
        ...
        this.videoView = (FullscreenVideoLayout) findViewById(R.id.vv);
        ...
        edit.commit();
        if (this.globales.appnext_video_cod.equals("") || i < this.globales.appnext_video_ini || (i - this.globales.appnext_video_ini) % this.globales.appnext_video_interv != 0) {
            empezar_video();
        } else {
        ...
        if (this.con_chat) {
            ...
            findViewById(R.id.rl_chat).setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    t_video.this.cerrar_chat();
                }
            });
            findViewById(R.id.btn_verchat).setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    if (!t_video.this.logineado_ok) {
                        Intent intent = new Intent(t_video.this, chat_perfil.class);
                        intent.putExtra("idsecc", t_video.this.globales.secciones_a[t_video.this.ind].id);
                        intent.putExtra("desde_video", true);
                        if (t_video.this.es_root) {
                            intent.putExtra("es_root", t_video.this.es_root);
                        }
                        t_video.this.es_root = false;
                        t_video.this.finalizar = true;
                        t_video.this.startActivityForResult(intent, 0);
                    } else if (t_video.this.findViewById(R.id.sv_chat).getVisibility() == 0) {
                        t_video.this.cerrar_chat();
                    } else {
                        t_video.this.videoView.hideControls();
                        t_video.this.findViewById(R.id.sv_chat).setVisibility(0);
                        if (!t_video.this.globales.banners_enchats && t_video.this.anun != null && t_video.this.anun.adView != null) {
                            t_video.this.ocultar_banner();
                        }
                    }
                }
            });
    ...
    public void onPictureInPictureModeChanged(boolean z, Configuration configuration) {
        if (z) {
            this.estaba_en_fs = this.videoView.isFullscreen();
            this.videoView.hideControls();
            this.videoView.setFullscreen(true);
        } else if (!this.estaba_en_fs) {
                ...
                if (string.equals(this.idtema + "")) {
                    runOnUiThread(new Runnable() {
                        ...
                        /* JADX WARNING: Code restructure failed: missing block: B:3:0x0035, code lost:
                            if (r3.equals(stikerwap.appdys.t_video.m1507$$Nest$fgetidusu_act(r1.this$0) + "") == false) goto L_0x0037;
                         */
                        ...
                        public void run() {
                            /*
                                ...
                                r8.<init>()
                                stikerwap.appdys.t_video r9 = stikerwap.appdys.t_video.this
                            ...
                            L_0x0057:
                                ...
                                stikerwap.appdys.t_video r3 = stikerwap.appdys.t_video.this
                                android.content.SharedPreferences r8 = r4
                            ...
                            L_0x00ac:
                                ...
                                stikerwap.appdys.t_video r10 = stikerwap.appdys.t_video.this
                                ...
                                r10.dia_act = r8
                            L_0x00dd:
                                stikerwap.appdys.t_video r8 = stikerwap.appdys.t_video.this
                                ...
                                r11 = -2
                                r10.<init>(r12, r11)
                                stikerwap.appdys.t_video r11 = stikerwap.appdys.t_video.this
                                int r11 = r11.marge_mateix
                                stikerwap.appdys.t_video r12 = stikerwap.appdys.t_video.this
                            ...
                            L_0x019b:
                                ...
                                r10.setTag(r13, r12)
                                android.view.View r10 = r8.findViewById(r11)
                                stikerwap.appdys.t_video$7$1 r11 = new stikerwap.appdys.t_video$7$1
                                r11.<init>()
                            ...
                            L_0x01f8:
                                ...
                                stikerwap.appdys.t_video r13 = stikerwap.appdys.t_video.this
                            ...
                            L_0x023e:
                                ...
                                stikerwap.appdys.t_video r15 = stikerwap.appdys.t_video.this
                            ...
                            L_0x028f:
                                ...
                                stikerwap.appdys.t_video r5 = stikerwap.appdys.t_video.this
                            ...
                            L_0x02c4:
                                ...
                                r13.setText(r6)
                                stikerwap.appdys.t_video r6 = stikerwap.appdys.t_video.this
                            ...
                            L_0x04f2:
                                ...
                                if (r15 == 0) goto L_0x0525
                                stikerwap.appdys.t_video r2 = stikerwap.appdys.t_video.this
                            ...
                            L_0x058e:
                                ...
                                stikerwap.appdys.t_video r10 = stikerwap.appdys.t_video.this     // Catch:{ Exception -> 0x0635 }
                                ...
                                stikerwap.appdys.t_video r10 = stikerwap.appdys.t_video.this     // Catch:{ Exception -> 0x0632 }
                                ...
                                stikerwap.appdys.t_video r13 = stikerwap.appdys.t_video.this     // Catch:{ Exception -> 0x0632 }
                            ...
                            L_0x05f7:
                                ...
                                goto L_0x0622
                            L_0x0614:
                                stikerwap.appdys.t_video r4 = stikerwap.appdys.t_video.this     // Catch:{ Exception -> 0x063b }
                            ...
                            L_0x0622:
                                ...
                                stikerwap.appdys.t_video r6 = stikerwap.appdys.t_video.this     // Catch:{ Exception -> 0x063b }
                            ...
                            L_0x0637:
                                ...
                                r21 = r13
                            L_0x063b:
                                stikerwap.appdys.t_video r4 = stikerwap.appdys.t_video.this
                            ...
                            L_0x06c0:
                                ...
                                r4.put(r5, r2)
                                stikerwap.appdys.t_video r2 = stikerwap.appdys.t_video.this
                                stikerwap.appdys.t_video$obtener_foto r2 = r2.o_f
                            ...
                            L_0x06d9:
                                stikerwap.appdys.t_video r2 = stikerwap.appdys.t_video.this
                                stikerwap.appdys.t_video$obtener_foto r4 = new stikerwap.appdys.t_video$obtener_foto
                                stikerwap.appdys.t_video r5 = stikerwap.appdys.t_video.this
                                r6 = 0
                                r4.<init>()
                                r2.o_f = r4
                            ...
                            L_0x072b:
                                ...
                                goto L_0x07fe
                            L_0x0749:
                                stikerwap.appdys.t_video r0 = stikerwap.appdys.t_video.this
                            ...
                            L_0x0817:
                                ...
                                stikerwap.appdys.t_video r2 = stikerwap.appdys.t_video.this     // Catch:{ Exception -> 0x0843 }
                            ...
                            L_0x0960:
                                ...
                                stikerwap.appdys.t_video$7$2 r2 = new stikerwap.appdys.t_video$7$2
                                r2.<init>()
                                r0.post(r2)
                            L_0x0986:
                                return
                            */
                            throw new UnsupportedOperationException("Method not decompiled: stikerwap.appdys.t_video.AnonymousClass7.run():void");
                        }
                    });
                }
            }
    ...
    private class enviar extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... strArr) {
            Iterator<String> it = t_video.this.spool.iterator();
            while (it.hasNext()) {
                try {
                    it.remove();
                    ...
                    multipartEntity.addPart("idusu", new StringBody(t_video.this.idusu + ""));
                    multipartEntity.addPart("c", new StringBody(t_video.this.codigo));
                    multipartEntity.addPart("idtema", new StringBody(t_video.this.idtema + ""));
        ...
        public void onPostExecute(String str) {
            if (str.equals("OK") && t_video.this.spool.size() > 0) {
                t_video t_video = t_video.this;
                t_video.env = new enviar();
                t_video.this.env.execute(new String[0]);
            }
        }
    }
    ...
    private class obtener_foto extends AsyncTask<String, Void, String> {
        ...
        public void onPreExecute() {
            if (t_video.this.acargar_m.equals("")) {
                cancel(false);
                return;
            }
            try {
                this.idusu_acargar = (String) t_video.this.acargar_m.keySet().toArray()[0];
            } catch (Exception unused) {
                cancel(false);
            }
            if (this.idusu_acargar != null) {
                this.vfoto_acargar = t_video.this.acargar_m.get(this.idusu_acargar);
                t_video.this.intentados_m.put(this.idusu_acargar, t_video.this.acargar_m.get(this.idusu_acargar));
                t_video.this.acargar_m.remove(this.idusu_acargar);
            }
        }
        ...
        public java.lang.String doInBackground(java.lang.String... r5) {
            ...
            L_0x000d:
                ...
                stikerwap.appdys.t_video r2 = stikerwap.appdys.t_video.this     // Catch:{  }
            ...
            L_0x0088:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: stikerwap.appdys.t_video.obtener_foto.doInBackground(java.lang.String[]):java.lang.String");
        }

        /* access modifiers changed from: protected */
        public void onPostExecute(String str) {
            if (t_video.this.fotos_m != null) {
                if (str == "1") {
                    t_video.this.fotos_m.put(this.idusu_acargar, this.bmImg);
                    SharedPreferences.Editor edit = t_video.this.settings.edit();
                    edit.putString("fperfil_" + this.idusu_acargar, t_video.this.intentados_m.get(this.idusu_acargar));
                    edit.commit();
                }
                int childCount = t_video.this.llchat.getChildCount();
                int i = 0;
                while (i < childCount) {
                    try {
                        String str2 = (String) t_video.this.llchat.getChildAt(i).getTag();
                        if (str2 != null && str2.equals(this.idusu_acargar)) {
                            t_video.this.llchat.getChildAt(i).findViewById(R.id.pb_foto).setVisibility(8);
                            t_video.this.llchat.getChildAt(i).findViewById(R.id.pb_foto_inv).setVisibility(8);
                            if (str == "1") {
                                ((ImageView) t_video.this.llchat.getChildAt(i).findViewById(R.id.iv_avatar_f)).setImageBitmap(config.getCircularBitmapWithWhiteBorder(this.bmImg, 0));
                            }
                        }
                        i++;
                    } catch (Exception unused) {
                ...
                if (!t_video.this.acargar_m.equals("")) {
                    t_video t_video = t_video.this;
                    t_video.o_f = new obtener_foto();
                    t_video.this.o_f.execute(new String[0]);
                }
            }
        }
    }
    ...
    private class cargar_ultimas extends AsyncTask<String, Void, String> {
        ...
        public java.lang.String doInBackground(java.lang.String... r6) {
            /*
                ...
                r0.append(r1)     // Catch:{ Exception -> 0x00b1 }
                stikerwap.appdys.t_video r1 = stikerwap.appdys.t_video.this     // Catch:{ Exception -> 0x00b1 }
            ...
            L_0x00c0:
                goto L_0x00bf
            */
            throw new UnsupportedOperationException("Method not decompiled: stikerwap.appdys.t_video.cargar_ultimas.doInBackground(java.lang.String[]):java.lang.String");
        }
            ...
            if (this.idfrase_masantigua != -1) {
                if (str4.indexOf("ANDROID:OK") != -1 || str4.indexOf("ANDROID:KO") != -1 || str4.indexOf("ANDROID:PERFILKO") != -1) {
                    if (str4.indexOf("ANDROID:PERFILKO") != -1) {
                        final AlertDialog create = new AlertDialog.Builder(t_video.this).setPositiveButton(R.string.aceptar, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialogInterface, int i) {
                            }
                        }).setMessage(R.string.perfil_desactivado).create();
                        if (!t_video.this.cbtn.equals("")) {
                            create.setOnShowListener(new DialogInterface.OnShowListener() {
                                public void onShow(DialogInterface dialogInterface) {
                                    Button button = create.getButton(-1);
                                    button.setTextColor(Color.parseColor("#" + t_video.this.cbtn));
                                    Button button2 = create.getButton(-2);
                                    button2.setTextColor(Color.parseColor("#" + t_video.this.cbtn));
                                }
                            });
                        }
                        create.show();
                        ...
                        for (int i2 = -1; indexOf != i2; i2 = -1) {
                            ...
                            t_video.this.idfrase_masantigua_glob = Integer.parseInt(substring);
                            int i3 = indexOf3 + 1;
                            ...
                            if (str5.equals("") || substring4.equals("") || !str5.equals(substring4) || str6.equals("") || substring2.equals("") || !str6.equals(substring2)) {
                                ...
                                if (z2 || str4.indexOf("ZXRT4@1@") != -1) {
                                    ...
                                    if (substring2.equals(sb.toString())) {
                                        ...
                                        edit.putString("f2_idtema", t_video.this.idtema + "");
                                ...
                                z2 = z;
                                SharedPreferences.Editor edit2 = t_video.this.settings.edit();
                                ...
                                edit2.putString("f2_idtema", t_video.this.idtema + "");
    ...
    public void empezar_video() {
        ...
        boolean z = this.extras.containsKey("desde_chat") && this.extras.getBoolean("desde_chat");
        if (z) {
            this.esStream = false;
            this.videoView.reorganizar(false, false, false);
        } else {
            this.esStream = this.globales.secciones_a[this.ind].stream;
            this.videoView.reorganizar(this.globales.video_cast, this.globales.secciones_a[this.ind].descargar, this.globales.video_pip_icon);
        }
        ...
        try {
            this.videoView.setVideoURI(Uri.parse(this.extras.getString("url")), this.extras.getString("ua"), this.globales.secciones_a[this.ind].headers);
        } catch (Exception e) {
            e.printStackTrace();
        }
        if (!z) {
    ...
    private class cargar_anun extends AsyncTask<String, Void, String> {
        ...
        public java.lang.String doInBackground(java.lang.String... r6) {
            /*
                ...
                stikerwap.appdys.t_video r6 = stikerwap.appdys.t_video.this     // Catch:{ Exception -> 0x007b }
            ...
            L_0x008a:
                goto L_0x0089
            */
            throw new UnsupportedOperationException("Method not decompiled: stikerwap.appdys.t_video.cargar_anun.doInBackground(java.lang.String[]):java.lang.String");
        }
        ...
        public void onPostExecute(java.lang.String r7) {
            /*
                ...
                stikerwap.appdys.t_video r5 = stikerwap.appdys.t_video.this
                stikerwap.appdys.FullscreenVideoLayout r5 = r5.videoView
            ...
            L_0x005b:
                ...
                android.view.View r0 = r0.findViewById(r2)
                stikerwap.appdys.t_video$cargar_anun$1 r2 = new stikerwap.appdys.t_video$cargar_anun$1
                r2.<init>()
                r0.setOnClickListener(r2)
                stikerwap.appdys.t_video r0 = stikerwap.appdys.t_video.this
                stikerwap.appdys.FullscreenVideoLayout r0 = r0.videoView
                r0.esStream = r1
                stikerwap.appdys.t_video r0 = stikerwap.appdys.t_video.this
                stikerwap.appdys.FullscreenVideoLayout r0 = r0.videoView
                r0.hideControls()
                stikerwap.appdys.t_video r0 = stikerwap.appdys.t_video.this     // Catch:{ IOException -> 0x0088 }
                stikerwap.appdys.FullscreenVideoLayout r0 = r0.videoView     // Catch:{ IOException -> 0x0088 }
                r1 = 0
                r0.setVideoURI(r7, r1, r1)     // Catch:{ IOException -> 0x0088 }
                goto L_0x0092
            L_0x0088:
                r7 = move-exception
                r7.printStackTrace()
                goto L_0x0092
            L_0x008d:
                stikerwap.appdys.t_video r7 = stikerwap.appdys.t_video.this
                r7.empezar_video()
            L_0x0092:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: stikerwap.appdys.t_video.cargar_anun.onPostExecute(java.lang.String):void");
        }
    }
    ...
    public void onResume() {
        ...
        if ((castSession == null || !castSession.isConnected()) && (fullscreenVideoLayout = this.videoView) != null && fullscreenVideoLayout.videoIsReady) {
    ...
    private void establec_ralc(final Context context) {
        this.ralc = new RewardedAdLoadCallback() {
            public void onAdFailedToLoad(LoadAdError loadAdError) {
                if (!t_video.this.globales.admob_rew_failed(context, t_video.this.mAd_appnext)) {
                    t_video.this.dialog_cargando.cancel();
                    t_video t_video = t_video.this;
                    t_video.abrir_secc(t_video.v_abrir_secc);
                }
            }
            ...
            public void onAdLoaded(RewardedAd rewardedAd) {
                ...
                rewardedAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                    ...
                    public void onAdFailedToShowFullScreenContent(AdError adError) {
                        t_video.this.abrir_secc(t_video.this.v_abrir_secc);
                    }

                    public void onAdDismissedFullScreenContent() {
                        if (t_video.this.mAd_visto) {
                            t_video.this.abrir_secc(t_video.this.v_abrir_secc);
                        }
                    }
                });
